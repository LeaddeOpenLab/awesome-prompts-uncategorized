# Other · Prompt Library · Leadde.ai
...
**334** Prompts · Latest addition: **2026-09-19**
...
### Realistic smartphone photo prompt of a 23-year-old Japanese woman trying on orange sunglasses at a vintage clothing store.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2101140974894457078)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100753923737108520)

**Summary:** Realistic smartphone photo prompt of a 23-year-old Japanese woman trying on orange sunglasses at a vintage clothing store.
...
```text
Character Identity:
A fictional 23-year-old adult Japanese woman. Small round face, large, gentle, droopy dark brown eyes, short, straight eyebrows, a small nose, soft, natural lips, light neutral Japanese skin tone. Exactly one small mole under her anatomical right eye. Glossy black medium-length hair tied in low twin tails, with dusty pink visible only on the inner side of the lower tips. An adult-like cute Jirai-kei vibe, a shy closed-mouth smile. Do not make her look like a student or a child. Maintain adult facial features, the mole, black hair, pink inner placement, hair length, and age appearance, without resembling any real person.

Physique:
Height approximately 152 cm. Petite, soft, feminine adult physique. Realistic shoulders and rib cage, natural bust proportions, petite realistic waist, soft, well-proportioned hips, and adult limbs. Maintain height and regional proportions. Do not depict a childish physique, push-up effects, extreme compression, or an impossibly thin waist.

Shooting Situation:
11:00. At a vintage clothing store with a friend. Wearing flashy orange sunglasses over her eyes, playfully holding a straight face while stifling a laugh at the corners of her mouth. Looking in the direction of a mirror, not making eye contact with the camera.

Location and Background:
A small vintage clothing store, cluttered clothes racks, the edge of a slender full-length mirror. The friend is the photographer and is off-screen.

Outfit:
A dusty pink form-fitting cropped sleeveless top, with fine black lace and a small black ribbon at the neckline. Black wide cargo pants, black and white platform sneakers, a small silver heart bracelet. All opaque everyday wear. Low twin tails tied with small black ribbons, dusty pink only on the inner side of the tips. Trying on sunglasses with thick orange frames and lightly tinted lenses.

Pose and Action:
Standing, lightly pinching the temple of the sunglasses with one hand. The other hand hangs naturally. Shoulders are level, head is not tilted.

Composition and Camera:
Friend's smartphone, approximately 2.3 m away, 1.3 m height, oblique front angle showing full body from head to shoes. Autofocus on face. Reflection in the full-length mirror is outside the frame.
Output exactly one single, undivided standalone image with a final size of 1086×1448 px, vertical 3:4 aspect ratio.

Lighting and Atmosphere:
A mix of the store's white ceiling lights and daylight coming from the entrance.

Photo Quality:
A shot resembling a minimally processed HEIC taken with a standard camera on an ordinary smartphone. Distinguish character identity, physique, hair shape, and surface finish, preserving natural capture processing and skin detail scaling. Follow the specified single AF plane; do not relight, denoise, or sharpen only the face in the background. Detail resolution falls off continuously with distance. Within the recognizable range of the face, simultaneously preserve multiple broad tonal differences—warmth on one cheek, uneven shine in the T-zone, different tones under the left and right eyes, and slight redness on the nose—without rendering visible pores on a distant face. On close, resolvable skin, preserve non-repeating low-contrast color differences, redness from pressure, wrinkle shadows, and sparse differences in pores and hair follicles. Makeup looks like real pigment, with slightly uneven edges. Retain normal color differences in lips and teeth. Preserve uneven exposure and white balance, non-lifted shadows, fine flyaway hairs, slight compositional bias, shadow noise, modest sharpening near the AF point, and HEIC compression. An unedited private snapshot from a camera roll.

Mandatory Requirements:
Exactly one undivided smartphone photograph of an adult woman meeting each scene specification. Fulfill both the scene conditions and natural smartphone image quality conditions.
One fictional 23-year-old adult woman. Prioritize scene-specific facial expressions rather than using the same smile every time.
Acceptance Criteria:
1) 23-year-old adult face, 152 cm adult physique, black low twin tails with pink inner layer, mole under her right eye.
2) Confirm specified outfit, primary action, and scene expression.
3) Home is a compact Tokyo studio apartment. Natural smartphone photo.
Specified time and location. Specified outfit worn normally. Two arms, two legs, natural fingers and contact. One single, independent vertical 3:4 image. Maintain specified aspect ratio and overall framing. Natural contrast.
Single AF depth level. No exposure adjustments, relighting, smoothing, or restoration applied only to the face. Retain broad tonal differences on the distant face, irregular micro-variations on near skin, and localized smartphone image quirks.
Depict one clearly adult fictional woman as the sole subject of an undivided photo. One head, one face, exactly two anatomically connected arms, natural hands. Additional hands in the foreground are permitted only when explicitly specified by scene or props, clearly separated from the subject's own hands. Do not generate text, panels, duplicate figures, or alternate angles.

Negative Prompt:
Different person, posed glamour shot, readable logos or text, another person as the subject, sheer, wardrobe malfunction, outfit change, extra limbs, unnatural twisting, split image, excessive bokeh, unnecessary cropping, studio lighting, beauty retouching on face only, beauty filters, glowing porcelain face, wax-like uniform face or limbs, skin whitening, bright fill light from beauty shoots, relighting face only, sharpening face only, overly perfect makeup edges, uniformly glossy lips, uniformly pure white teeth, full-frame edge-to-edge sharpness, global clarity processing, repeating skin patterns, full-frame fake grain, excessive HDR, over-polished fashion production, catalog-like symmetry, ad campaign finish, CGI, illustration, minor, teenager, child, youthful age appearance, uniform, real person, celebrity lookalike, duplicate figures, additional people, additional heads, additional faces, extra or missing arms of the subject, fused limbs, detached limbs, unnatural hands, extra fingers, fused fingers, distorted face, crossed eyes, text, subtitles, letters, numbers, logos, watermarks, signatures, borders, grids, contact sheets, collages, split screens, insets, multiple panels.
```
...
### Reference-based upper-body 3D paper-cut shadow box style transfer prompt, keeping the person and clothing highly photorealistic and faithful to the original.

Author：[@elle\_elle\_e](https://x.com/elle_elle_e) · [Source](https://x.com/elle_elle_e/status/2101106795699954076)

Photography · Portrait / Selfie · Character · Fashion Item · Published

Source：[@1ldk\_aroma](https://x.com/1ldk_aroma) · [Source](https://x.com/1ldk_aroma/status/2101097668269449550)

**Summary:** Reference-based upper-body 3D paper-cut shadow box style transfer prompt, keeping the person and clothing highly photorealistic and faithful to the original.
...
```text
concept:
  - "a real human displayed like a living fashion doll inside a deep multi-layered paper-craft shadow box"
  - "the person remains fully photorealistic; only the surrounding world is paper craft"
  - "derive the entire art direction from the reference image"

reference:
  identity:
    - "faithfully preserve the person's recognizable face, proportions, skin tone, age, hairstyle, and distinctive features"
    - "no beautification or facial reinterpretation"

  visual_direction:
    - "derive colors, accessories, motifs, textures, and mood from the reference image"
    - "creatively enlarge, repeat, or reinterpret meaningful reference details"
    - "do not introduce unrelated generic motifs"

world:
  - "luxurious pop-fantasy shadow box with extreme physical depth"
  - "many individually cut paper layers with visible gaps and cast shadows"
  - "clear foreground, middle-ground, and background"
  - "foreground decorations may partially overlap the subject"
  - "avoid flat collage appearance"

subject:
  - "real human, photorealistic skin, realistic anatomy"
  - "upper-body composition"
  - "preserve the visible outfit as faithfully as possible"
  - "keep its colors, silhouette, materials, trims, accessories, and styling"
  - "unseen clothing areas may be naturally completed to match the visible design"
  - "real fabric, never paper clothing"
  - "preserve the original expression, hairstyle, pose, and body proportions"

camera:
  - "front-facing, eye-level, centered upper-body portrait"
  - "approximately chest or waist upward"
  - "35mm, deep depth of field"

lighting:
  - "realistic studio light on skin"
  - "distinct shadows between paper layers"
  - "adapt the lighting mood to the reference image"

avoid:
  - "chibi, miniature, toy, plastic, porcelain, or paper-doll person"
  - "cartoon face or identity drift"
  - "generic beautification"
  - "flat collage"
  - "paper clothing"
  - "unrelated decorations"
  - "major outfit redesign"
...
### A detailed photorealistic prompt depicting an adult Japanese woman in lingerie leaning in to kiss her lover on a shopping street at dusk.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2101080170757079132)

Photography · Portrait / Selfie · Character · Landscape / Nature · Cityscape / Street · Published

**Summary:** A detailed photorealistic prompt depicting an adult Japanese woman in lingerie leaning in to kiss her lover on a shopping street at dusk.
...
```text
🌟Dusk Shopping Street | The Moment Right Before a Kiss Approaching Her Lover🌟

[Subject & Art Style]
A photorealistic image capturing a brief, intimate moment between lovers walking through a Japanese shopping street at dusk. A clearly adult, 24-year-old Japanese woman halts her steps and gently brings her face closer to her lover right in front of her. Not a heavily staged studio shot, but balancing a lived-in feel—as if captured casually on the way home—with the sophistication of a photography book.
While keeping the subject's expression and lips as the centerpiece, naturally retain the evening streetlights and presence of people in the background. An elegant, cinematic romantic photograph conveying the shyness, security, and gentle excitement of the moment the distance between lovers suddenly closes.

[Location, Background, & Worldview]
The setting is a tranquil Japanese shopping street (shotengai) with a balanced mix of traditional shops and newer storefronts. Deep in the background, the arcade entrance, shopfront lighting, show windows of diners and small general stores, and a few distant pedestrians walking by can be seen. Signboards are treated solely as background elements of shape and light, displaying no readable text.
Directly behind the subject, warm interior shop lighting is softly blurred to a gentle bleed, leaving the dusk street in the midground and the depth of the arcade in the far background. Rather than the clamor of a bustling downtown, it exudes an accessible, comforting atmosphere characteristic of a neighborhood shopping street strolled through together at the end of the day.

[Season, Time, & Weather]
A mild evening between early autumn and late summer. The time is just before or around sunset, with pale orange and pink lingering in the western sky. No rain is falling, and the air is dry and calm under clear skies. There is no strong wind; only a gentle breeze barely shifts her shoulder-length hair and delicate stray strands.
The daytime brightness gradually fades as the shopping street's lighting begins to make its presence felt. The warmth of the setting sun naturally blends with the soft yellow glow of artificial illumination, creating a peaceful, warm temperature typical of the commute home.

[Character Design]
A clearly adult 24-year-old Japanese woman. She has soft, refined adult facial features, slightly large dark-pupiled eyes, natural eyebrows, a slender and neat nasal bridge, and well-flushed, soft lips. Her skin is a bright ochre tone with realistic textures, faintly retaining natural cheek blush, subtle pores, and delicate shading.
Her hair is dark brown with natural waves reaching her shoulders. A healthy, tastefully glamorous physique featuring delicate shoulders, slender limbs, and a narrow waist paired with feminine curves. Her bust is clearly large and ample, but instead of a rigid spherical shape or unnatural push-up, it exhibits soft roundness and natural thickness that conforms to posture and gravity. Her hips also carry a natural curve that preserves overall bodily harmony.

[Outfit & Accessories]
An elegant lingerie set consisting of an ivory bra and matching panties reminiscent of Wacoal designs. The bra combines fine floral embroidery with delicate scalloped lace, with modest sheer elements and three-dimensional embroidery on the cups. A very understated accent, such as a tiny ribbon, adorns the center.
The cup width and straps are realistically proportioned for a full bust, naturally following the body's contours without straining fabric or extreme digging in. As the composition centers above the chest, the panties do not need to be prominently visible. Accessories are kept minimal, limited to small gold or pearl-style stud earrings; no flashy necklaces are used.

[Pose, Movement, & Gaze]
The moment the woman stops walking while strolling side by side with her lover down the shopping street. Her body remains angled slightly along the street, with only her upper torso naturally turned back toward the lover (the camera side). Her weight remains on the rear leg, while her front foot rests where it paused mid-stride, avoiding turning completely toward the front.
Her shoulders are relaxed and naturally open, with one shoulder brought slightly forward toward the camera. Her arms rest naturally at her sides, or one hand lightly brushes near the edge of her attire or outerwear. Only her face slowly leans closer to her lover; her gaze, initially looking into their eyes, gradually lowers toward the mouth, capturing the exact moment right before her eyelids shut. Avoid unnatural arched backs or poses with only the neck jutting forward.

[Expression & Emotion]
A slightly shy, tender expression just before seeking a kiss from her lover. Her eyes are not shut tightly, but rather her eyelids are naturally lowering mid-motion after gazing at him. Her brows are relaxed, and her cheeks retain a soft blush from the warmth of the setting sun and self-consciousness.
Her lips are not pursed with tension, but slightly draw forward from a softly closed state. A faint, uncontainable smile lingers at the corners of her mouth, conveying an intimacy that asks, "May I come closer?" Rather than overt seduction, the focus is on a natural sense of distance and comfort shared with a long-time partner.

[Composition & Camera]
A 4:5 vertical portrait composition for X (Twitter) posting. A close-up bust shot capturing from the subject's chest up to the crown of her head. Slight negative space is left above the head, with the face and lips positioned slightly above the vertical center. Rather than a straight-on head-on angle, she is shot from a very subtle diagonal angle, creating natural depth with one shoulder appearing slightly nearer.
The camera height is almost level with the woman's eye-line. The focal length is in the standard to mid-telephoto range of approximately 50–85mm, avoiding wide-angle distortion of the face or chest. The background is softly blurred with a modest shallow depth of field, yet retains enough clarity to recognize the arcade, store lights, and street depth. A natural perspective as if shot directly in front by a lover using a real camera.

[Lighting, Color, Texture, & Mood]
The key light is the low-angled setting sun streaming in diagonally from the rear. It forms a soft golden rim along the outer edges of her hair and shoulders, while warm light from shopfronts gently fills the front of her face and cheeks. Faint ambient reflections from streets and buildings illuminate the opposite side of her face to prevent shadows from crushing to pure black.
Skin retains fine shading, natural vitality, and faint pores; hair renders individual strand flow and the translucency of the evening sun. The lace exhibits delicate fibrous texture and three-dimensional embroidery, while background wood, glass, metal, and pavement feature distinct material textures. Built upon a palette of ivory, sunset orange, and amber store illumination, it establishes a warm, intimate, slightly shy evening homecoming mood.

[Quality & Exclusions]
High resolution, photorealistic. Emphasizes natural human anatomy, light, depth, skin, hair, and lace textures as if captured by an actual camera.
Avoid figures appearing underage, overly youthful faces, unnatural joints or anatomy, extra limbs or fingers, missing or fused fingers, confusion of left and right hands, fusing of clothing and skin, torn clothing, unintended exposure, extreme hyperlordosis/arched back, and excessive wide-angle distortion. While maintaining an ample, natural bust volume, avoid abnormal enlargement, rigid spheres, excessive push-up, and gravity-defying shapes. Do not include excessive beauty filters, plastic skin, unnatural background blur, text, logos, watermarks, or UI elements.
```
...
### A photorealistic prompt depicting a woman in lingerie leaning in for a kiss with her lover in an evening shopping arcade.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2101079216791920720)

Photography · Portrait / Selfie · Character · Cityscape / Street · Published

**Summary:** A photorealistic prompt depicting a woman in lingerie leaning in for a kiss with her lover in an evening shopping arcade.
...
```text
🌟 Twilight Shopping Arcade | Ivory Petite Floral Embroidery and the Sign of an Impending Kiss 🌟

[Subject / Art Style]
A photorealistic photo capturing the moment a woman, who had been walking side by side with her lover, suddenly stops against the backdrop of an evening shopping arcade and gently leans her face closer. It should be a fashion-photo-leaning piece carrying the atmosphere of a movie scene, naturally capturing the intimacy found within everyday life.
An expression that harmonizes the lived-in streetscape with the woman's refined, soft charm. Not overly flashy, emphasizing a delicate and warm photographic depiction that allows one to feel even her breathing from a close distance.

[Location / Background / Worldview]
The setting is an evening Japanese shopping arcade (shotengai). The arcade entrance, continuous storefronts, warm signboard lights, product shelves seen through glass, and the presence of the street extending into the distance appear naturally. While keeping the background tidy enough not to distract from the main subject, faintly retain the depth and human flow characteristic of a shopping arcade.
The foreground centers around the woman's shoulders and hair, the midground features storefront lights, and the distant view positions the street dyed by the setting sun, crafting a familiar worldview with the warmth of the way home that is not overly urban.

[Season / Time / Weather]
The season is an evening with soft air, evoking early summer to early autumn. The time of day is just before sunset, with a low western sun streaming in from deep within the street, and natural light still lingering in the sky.
The weather is clear. The wind is gentle, just enough to slightly stir the surface of her hair and stray strands. Depict the comfortable twilight air for a walk, neither too hot nor too cold.

[Character Setting]
The character is an unmistakably adult 24-year-old Japanese woman. She has soft, well-proportioned facial features, slightly large dark-centered eyes, natural eyebrows, a slender and elegant nasal bridge, and flushed, soft lips. Her hair is dark brown, shoulder-length with loose waves, with fine loose tendrils around her face.
Her skin is a bright ochre tone with a natural, not overly smooth texture. Her physique is a natural, glamorous body harmonizing delicate shoulders and limbs, a slender waist, and feminine curves. Her bust has a large, generous volume while showing natural roundness and softness following her outfit and posture. An overall adult cuteness with a sense of cleanliness.

[Costume / Accessories]
The costume is ivory lingerie with petite floral embroidery. The bra features delicately embroidered cups and fine scalloped lace, with patterns subtly emerging as they catch the gentle light. The panties are unified in matching tones, overall presenting a high-quality, refined design reminiscent of the Wacoal style.
The materials are soft fabric and delicate lace, realistically sized to naturally hug the body without strain. There is no unnatural digging in or lifting at the décolletage, underarms, or underbust, maintaining a natural fit. Accessories are understated, limited to at most small earrings if necessary.

[Pose / Action / Gaze]
The woman is in a state of having suddenly stopped amidst the flow of walking through the shopping arcade. Her body is angled slightly diagonally toward her lover, her weight shifted slightly to her back leg, with relaxed shoulders. She pushes one shoulder slightly forward and gently leans just her upper body in, making the movement of closing the distance look natural.
Both hands may be off-screen, but the arm placement is relaxed and naturally lowered, with minimal torso twisting. Her gaze initially looks at her lover, then slowly drops in the motion immediately preceding closing her eyelids. The angle of her face is mindful of not being tilted too far up, allowing her lips to gently approach.

[Expression / Emotion]
The expression is a very natural pre-kiss expression blending shyness and sweetness as she draws close to her lover. Her eye area is softly relaxed, with eyelids half-lowered just before closing.
Her mouth is relaxed, her softly closed lips nudged just slightly forward. A tiny smile lingers at the corners of her mouth, conveying a warm emotional expression that speaks of familiarity and security rather than tension.

[Composition / Camera]
A 4:5 vertical composition tailored for X (Twitter) posts. A bust-up shot capturing generously from the chest to the top of the head, leaving slight negative space above. The figure is positioned near the center of the frame, yet with a bit of margin retained on the lover's side to communicate the movement of leaning in.
The camera is positioned at roughly the mid-height between the woman's face and chest, using a natural standard to moderate telephoto focal length from a close distance. Avoid extreme wide-angle distortion, while keeping the background lightly blurred yet distinct enough to recognize the shopping arcade and evening atmosphere.

[Light / Color / Texture / Atmosphere]
The main light source is the evening sun streaming in from deep within the street, creating soft rim-lighting contours along the woman's cheeks, hair edges, and shoulders. In addition, warm lighting from storefronts softly strikes from the front and sides, gently shaping facial contours. Shadows do not become too deep, leaving warmth along her neck and cheeks through reflected light.
The color palette features warm tones centered on ivory, beige, orange, and pale brown. Natural complexion for the skin, fine hair flow, delicate weave in the lace, and soft evening-like reflections on background glass and metal signs. The overall atmosphere is an intimate, slightly shy, sweet moment on the way home.

[Quality / Negative Elements]
Prioritize high resolution and realistic human anatomy, perspective, lighting, and material textures as if photographed with a real camera. Avoid expressions appearing underage, overly childish facial features, unnatural bodily proportions, extra limbs or fingers, missing fingers, fused fingers, unnatural joints, and left-right confusion.
Avoid outfit breakdown, fusion of body and clothing, unintended exposure, unnatural bust enlargement or hard spherical shapes, excessive push-up, extreme wide-angle distortion, excessive skin-smoothing edits, and unnatural background handling. Do not include text, logos, watermarks, or UI overlays.
```
...
### Photorealistic portrait of a woman in an ivory camisole looking up at her lover on an early afternoon café terrace.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2101077637305340004)

Photography · Portrait / Selfie · Character · Published

**Summary:** Photorealistic portrait of a woman in an ivory camisole looking up at her lover on an early afternoon café terrace.
...
```text
🌟Early Afternoon Café Terrace | Ivory Cami and an Upturned Smile🌟

[Subject / Art Style]
Depict the moment an adult Japanese woman stands up from her chair at a daytime café terrace, closing the distance while looking up at her slightly taller lover. A photorealistic photographic expression that simultaneously conveys intimacy toward her lover and the light, breezy ambiance of a street corner.
Prioritize naturalness like a page from a photo book, finishing it as a lived-in fashion photograph. Make it a piece that conveys not only cuteness, but also cleanliness, elegance, and the soft, open atmosphere of the afternoon.

[Location / Background / Worldview]
The location is the boundary between the outdoor terrace seating of a daytime café and the sidewalk. Naturally arrange a round table, wicker or wooden chairs, a half-finished iced tea, potted olive trees, etc., giving a sense of a pleasant street corner break.
Show the pavement, the exterior storefront wall, the awning, and the sidewalk extending into the distance in the background without distracting from the main subject. Place the table and chairs in the foreground, the subject in the midground, and the bright street in the background to create depth and a clear sense of openness characteristic of a terrace.

[Season / Time / Weather]
The season is a comfortable time evocative of early summer to early autumn. The time of day is an early afternoon that is not too late, with ample brightness that is not overly harsh, and the air is light and calm.
The weather is sunny. The awning above the terrace softens the direct sunlight, naturally highlighting the subject in contrast to the brightness on the sidewalk side. There is no sweltering heat; a gentle breeze faintly stirs the tips of her hair and the hems of her clothing.

[Character Profile]
A clearly adult Japanese woman around 20 to 28 years old. She has soft, well-proportioned facial features, slightly large eyes, natural eyebrows, and healthy, well-colored lips. Her hair is dark brown, shoulder-length loose waves, with a few stray strands framing her cheeks. Her skin has a bright ochre undertone, with a natural, not overly smooth texture.
Her physique is an elegant and naturally glamorous build, harmonizing delicate shoulders and limbs with a slender waist and feminine curves. Her bust has distinctly large, rich volume, yet sits softly and naturally in accordance with her outfit and posture, maintaining balance with her whole body. Her hips also have a modest, natural roundness.

[Outfit / Accessories]
Wearing an ivory camisole adorned with small floral embroidery and delicate lace. Designed with dainty shoulder straps, soft fabric, and elegant-looking chest embroidery and lace trim, giving it a realistic fit that naturally drapes along her body. For the lower body, mocha-colored high-waisted shorts. A clean silhouette that pairs harmoniously with the lightness of the camisole.
On her feet are thin-strapped flat sandals. Accessories are kept minimal, limited to small earrings and a delicate bracelet. Add no flashy decorations, prioritizing a lightness suited to a daytime street corner.

[Pose / Action / Gaze]
The motion immediately after standing up from the chair. While slightly retaining her center of gravity on her back leg, she takes a half-step forward toward her lover with the other leg. One hand lightly touches the top of the chair's backrest, naturally conveying the flow of standing up. Her other hand rests relaxed at her side, without unnatural twisting in the shoulders or waist.
Her upper body is moderately open toward her lover, her neck and chin slightly tilted upward as she looks up at her taller partner. Her gaze is directed toward her lover's eyes to mouth area, expressing a lightness as if just before stretching up on tiptoe, and the intimacy of the moment the distance closes.

[Facial Expression / Emotion]
Her expression is a gentle smile showing affection toward her lover. Her eyelids are slightly lowered, her eyes exuding a sense of security and sweetness. Her mouth is relaxed, her lips gently pursed together to evoke a natural intimacy.
The emotion is a calm flutter mixed with shyness and joy. Avoid an exaggerated puckered face; make it an elegant, lovely expression that quietly conveys the intimate atmosphere between the two.

[Composition / Camera]
A 4:5 vertical composition suited for X posts. A full-body composition that comfortably frames from the crown of her head to the tips of her sandals, keeping the subject from looking too small while preserving plenty of the terrace seating atmosphere. Place the subject near the center of the frame, showing the table and chairs on one side and the open expanse of the sidewalk on the other.
Camera height is roughly halfway between the standing woman's waist and chest, with a moderately close shooting distance. A natural angle of view leaning standard to moderate telephoto, prioritizing perspective where the body and legs are not exaggerated. Lightly declutter the background, yet retain enough detail to convey the presence of the storefront and sidewalk.

[Light / Color / Texture / Atmosphere]
The primary light source is soft natural light filtered through the awning. Light enters from above and from the sidewalk side, imparting a gentle brightness to the face, shoulders, and lace of the outfit. Weak reflected light wraps around to the opposite side, casting soft shadows. Keep a daytime brightness while maintaining a calm color temperature free of blown-out highlights.
Ivory, mocha, green, and the pale tones of the cobblestones harmonize into a bright, elegant overall tone. Give natural color to the skin, fine hair flow and soft gloss to the hair, lace delicacy and the crispness of the shorts to the fabrics, and distinct textures to the wicker chairs, wood, and glass. The atmosphere is a breezy, intimate gentleness characteristic of an urban early afternoon.

[Quality / Negative Elements]
Emphasize high resolution and natural human anatomy, materials, light, and perspective as if shot with a real camera. Depict her clearly as an adult woman, avoiding any appearance of youthfulness. Ensure natural limb and finger counts, joints, and grounded footing, with clothing fitting realistically along the body.
Avoid extra limbs or fingers, missing fingers, fused fingers, unnatural joints, fusion of body and clothing, wardrobe malfunctions, unintended exposure, extreme wide-angle distortion, unnatural background blur, and excessive skin-smoothing retouching. Maintain a rich, natural three-dimensionality for the bust while avoiding unnatural enlargement, rigid spherical shapes, or excessive push-up effects. Do not include text, logos, watermarks, or UI displays.
```
...
### Photorealistic portrait of a Japanese woman cooling down after a bath, seated in a rattan chair wearing sage green loungewear and holding a hand fan at a dusk hot spring ryokan.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2101078383195247043)

Photography · Portrait / Selfie · Character · Published

**Summary:** Photorealistic portrait of a Japanese woman cooling down after a bath, seated in a rattan chair wearing sage green loungewear and holding a hand fan at a dusk hot spring ryokan.
...
```text
🌟Dusk at a Hot Spring Ryokan | Post-Bath Cool-Down in Sage Green🌟

[Subject & Art Style]
Depict a moment in a quiet resting lounge at a hot spring ryokan during the evening, where a post-bath woman sits deeply relaxed in a rattan lounge chair, slowly cooling her body down. A photorealistic photograph featuring a clearly adult Japanese woman as the subject, evoking a sense of everyday intimacy and lived-in authenticity, as if naturally captured by her lover on a trip.
While retaining the neat elegance of fashion photography, avoid overly staged poses and emphasize her relaxed, natural state after soaking in the hot spring. Present the subject, the rattan chair, the traditional Japanese interior, and the garden greenery together as a unified scene, capturing a coexistence of calm tranquility and mature charm.

[Location, Background, & Worldview]
The setting is a quiet rest lounge available for private use by ryokan guests. It features subtly lit wooden pillars and floors, fittings using shoji screens and washi paper, with a small Japanese garden visible through windows and an open sliding door. The garden is tastefully adorned with natural stones, low shrubs, moss, and a stone lantern, creating the refined depth typical of a ryokan.
Surrounding the subject are a rounded rattan lounge chair and soft unbleached cream-colored cushions. Nearby is a low wooden table with modest items like a teacup, composed so as not to clutter the background, instantly conveying that this is a peaceful place of rest.

[Season, Time, & Weather]
An evening in early autumn or late summer. A hint of the daytime heat still lingers, but a gently cool breeze has begun to drift in from the garden. The sky is transitioning from clear day to twilight; rather than harsh direct sunlight, soft, blue-tinted natural light reaches into the room from the garden side.
Convey the contrast between the warmth lingering in her post-bath body and the cool evening air. A calm weather scene with no rain or strong winds, where garden leaves sway only slightly.

[Character Settings]
A 27-year-old, clearly adult Japanese woman. She has soft, well-balanced facial features, with large dark brown/black eyes, natural eyebrows, an elegant nose bridge, and softly flushed, supple lips. Dark brown shoulder-length hair is worn loosely gathered in an effortless post-bath manner, leaving delicate wisps framing her face. Her skin has a luminous, warm-toned fair undertone, with realistic texture including fine pores and subtle shading.
A naturally glamorous physique balancing delicate shoulders and limbs, a slender waist, and feminine curves. Her bust has a distinctly large and full volume, yet without unnatural enlargement or rigid spherical shapes, exhibiting soft roundness and natural three-dimensionality that follows her seated posture and gravity. Her hips and legs also have a healthy, balanced curvature in proportion to her body.

[Outfit & Accessories]
An elegant loungewear set consisting of a sage green ruffle-lace camisole paired with matching loose, relaxed-fit long pants. The camisole is made of non-sheer, soft fabric adorned with delicate ruffle lace along the neckline and shoulders. The neckline features realistic tailoring and width tailored to her physique, wrapping naturally around her full bust without overstretching or digging in, providing a natural fit.
The pants are made of a lightweight, fluid fabric that drapes gracefully, maintaining a relaxed silhouette without clinging too tightly to the lines of her legs. Accessories are kept minimal, limited to small, subtle earrings. Avoid flashy ornaments or strong glossiness that would feel out of place in a post-bath relaxation scene.

[Pose, Action, & Gaze]
The woman sits deeply in the rattan lounge chair, naturally resting her back and shoulders against the cushions. Her torso faces nearly forward toward the camera with a subtle angle, while her lower body is in a relaxed posture. Both legs are extended diagonally forward with knees together, toes naturally aligned in the same direction.
One hand rests by her knee, gently holding the handle of a round Japanese hand fan (uchiwa). The other hand rests naturally on her thigh or the armrest of the chair. She tilts her head slightly to the side, shifting her gaze just past the camera, as if looking at her lover seated nearby. Her posture is stable, resting her weight comfortably into the chair without excessive twisting.

[Expression & Emotion]
A slightly drowsy, comforted expression right after finishing her hot spring bath and finally resting her body. Her eyelids are gently narrowed in a peaceful gaze, not completely closed. Facial muscles around the brows and cheeks are completely relaxed, with lips softly closed in an easy, tension-free shape.
Conscious of her lover's presence, her expression is not entirely blank, retaining a faint, gentle warmth around the mouth. Not a forced or wide smile, but a serene intimacy and sense of security that seems to say, "It feels so nice here."

[Composition & Camera]
A 4:5 vertical composition optimized for social media posts. A full-body seated shot capturing everything from the crown of her head to her aligned toes, pulled back just enough to reveal the entire chair and part of the garden. The subject is slightly off-center, leaving negative space on the other side filled with the garden and traditional Japanese interior.
The camera height is set around the chest to waist level of the seated subject, avoiding extreme high or low angles. Mimic a natural focal length of around 50–70mm (standard to mild telephoto), preventing unnatural elongation of body proportions or feet. The background has a soft, shallow depth of field, yet ryokan elements such as the garden, shoji screens, and woodwork remain clearly recognizable.

[Lighting, Color, Texture, & Mood]
The primary light source is the soft evening natural light entering from the garden. It gently illuminates her face, shoulders, and one side of her loungewear, while warm indirect indoor lighting serves as a fill light on the opposite side. The slightly cool-toned blue of the natural light blends with the gentle amber glow of the interior lights, creating a comfortable, twilight-appropriate color temperature contrast.
The skin retains delicate shading and a natural flush, while hair strands and stray wisps exhibit a natural sheen. The sage green fabric displays soft wrinkles and fluid drape, the lace shows fine fiber textures, and the rattan chair exhibits woven patterns and the dry texture of natural materials. Wood, washi paper, stone, and foliage each retain their distinct textures, harmonizing the entire composition in quiet, tender evening tones.

[Quality & Negative Elements]
High-resolution photorealistic rendering. Prioritize natural human anatomy, lighting, textures, and perspective as if taken by a real camera.
Avoid figures that appear underage, overly youthful faces, unnatural human anatomy, extra limbs or fingers, missing fingers, fused fingers, unnatural joints, swapped hands, wardrobe malfunctions, body-clothing clipping, unintended exposure, extreme wide-angle distortion, and excessive airbrushing or skin smoothing. Ensure the bust maintains a full, natural volume without appearing as rigid spheres, unnaturally pushed up, exaggeratedly enlarged, or defying gravity. No text, logos, watermarks, or UI elements in the image.
```
...
### Realistic everyday smartphone photo prompt of a 23-year-old adult woman getting ready in a Tokyo studio apartment.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2101102219751764120)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100737566408687828)

**Summary:** Realistic everyday smartphone photo prompt of a 23-year-old adult woman getting ready in a Tokyo studio apartment.
...
```text
Character Identity:
A fictional 23-year-old Japanese adult woman. Small round face, large and gentle droopy dark brown eyes, short straight eyebrows, small nose, soft natural lips, light neutral Japanese skin tone. Exactly one small mole beneath her anatomical right eye. Glossy black medium-length hair tied in low twin tails, with dusty pink visible only on the inner side of the lower hair ends. An adult-like cute Jirai-kei aesthetic, a bashful closed-mouth smile. Do not make her look like a student or a child. Maintain her adult facial features, mole, black hair, inner pink placement, hair length, and sense of age, and do not resemble any real person.

Physique:
Height approximately 152 cm. Petite, soft, feminine adult physique. Realistic shoulders and ribcage, natural chest proportions, petite and realistic waist, soft and well-proportioned hips, and adult limbs. Maintain her height and body proportions. Do not give her a childish physique, push-ups, extreme compression, or an impossibly thin waist.

Shooting Situation:
09:00. Checking her just-woken-up face in a small tabletop mirror in a studio apartment while adjusting the ties of her low twin tails. Raising one eyebrow sleepily, looking into the mirror with her mouth closed.

Location and Background:
A rented studio apartment in Tokyo, a single room of approximately 6 tatami mats. Pale wood flooring, white walls, a small sink near the narrow entrance, and a window in the back. A single bed, a small gray two-seater sofa, and a small work desk lined with nail supplies all fit within the same room. Pink accessories, daily necessities. No separate bedroom or spacious dining area. Tabletop mirror on the work desk. On the chair are daytime clothes: a dusty pink sleeveless top and black cargo pants.

Outfit:
A light dusty pink opaque cotton camisole and short black cotton lounge shorts. Barefoot. Low twin tails, pink on the inner ends.

Pose and Action:
Sitting on the chair in front of the desk, resting one hand on the desk, and using the fingers of the other hand to adjust the tie of a low twin tail. Body naturally facing forward, eyes directed toward the tabletop mirror.

Composition and Camera:
Smartphone timer mounted on a shelf in the room. Approximately 2.2 m away, height of 1.1 m, capturing from a diagonal side angle from head to both feet along with the compact room. Autofocus (AF) on the facial plane. The back of the mirror is visible, do not create a different person in the reflection.
Output exactly one standalone, undivided image in a vertical 3:4 aspect ratio with a final size of 1086×1448 px.

Lighting and Atmosphere:
Soft morning side light entering through the window, natural shadows beneath the sink area.

Photo Quality:
A minimally processed HEIC-like shot taken with the standard camera of an ordinary smartphone. Distinguish character identity, physique, and hair shape from surface finishing, preserving natural camera processing and realistic scale of skin details. Following the specified single AF plane, do not selectively relight, denoise, or sharpen only the face in the background. Resolution of fine details falls off continuously with distance. Within the recognizable range of the face, simultaneously preserve multiple broad tonal variations such as warmth on one cheek, uneven sheen on the T-zone, differing under-eye tones between left and right, and slight redness on the nose, without rendering pores on a distant face. On skin close enough to resolve, preserve non-repeating low-contrast color variations, redness from pressure, wrinkle shadows, and sparse differences in pores and hair follicles. Makeup looks like real pigment with slightly uneven edges. Retain normal color differences between lips and teeth. Maintain uneven exposure and white balance, unlifted shadows, fine stray hairs, slight framing imperfection, shadow noise, subtle sharpening near the AF point, and HEIC compression artifacts. An unedited frame from a private camera roll.

Mandatory Requirements:
Exactly one undivided smartphone photograph of an adult woman satisfying the specifications of each scene. Satisfy both the scene conditions and the natural smartphone photo quality requirements.
One fictional 23-year-old adult woman. Prioritize scene-appropriate facial expressions rather than generating the same smile every time.
Acceptance Criteria:
1) 23-year-old adult face, 152 cm adult physique, black low twin tails with pink inner layer, mole beneath her right eye.
2) Verify specified outfit, primary action, and scene expression.
3) Home is a compact studio apartment in Tokyo. Natural smartphone photo.
Specified time and location. Specified outfit worn normally. Two arms, two legs, natural fingers and points of contact. One standalone vertical 3:4 image. Maintain specified aspect ratio and overall framing. Natural contrast of light and dark.
Single autofocus hierarchy. No selective exposure adjustment, relighting, smoothing, or restoration applied only to the face. Retain broad tonal differences on the distant face, irregular micro-variations on close skin, and localized smartphone image artifacts.
Depict one clearly adult fictional woman as the sole subject of an undivided photo. One head, one face, exactly two anatomically connected arms, natural hands. Additional hands in the foreground are permitted only when explicitly specified by the scene or props, clearly separated from the subject's own hands. Do not generate text, panels, duplicate figures, or alternate angles.

Negative Prompt:
different person, posed shot, readable logos or text, another person as the subject, transparency, displaced clothing, costume changes, extra limbs, unnatural twisting, split images, excessive blur, unwanted cropping, studio lighting, skin smoothing applied only to face, beauty filter, glowing porcelain face, waxy uniform face or limbs, skin whitening, bright fill light from beauty shoots, relighting face only, sharpening face only, overly perfect makeup edges, uniformly glossy lips, uniformly pure white teeth, edge-to-edge sharpness, overall clarity processing, repeating skin patterns, full-frame fake grain, excessive HDR, over-polished fashion styling, catalog-like symmetry, ad campaign finish, CGI, illustration, underage, teenager, child, juvenile appearance, school uniform, real person, face resembling a celebrity, duplicate figures, additional people, extra heads, extra faces, extra or missing arms of the subject, fused limbs, detached limbs, unnatural hands, extra fingers, fused fingers, distorted face, crossed eyes, letters, subtitles, characters, numbers, logos, watermarks, signatures, borders, grids, contact sheets, collages, split screens, insets, multiple panels.
```
...
### Realistic portrait of a Japanese woman wearing royal blue lingerie enjoying ice cream in an afternoon dining room.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2101076888575779135)

Photography · Portrait / Selfie · Character · Published

**Summary:** Realistic portrait of a Japanese woman wearing royal blue lingerie enjoying ice cream in an afternoon dining room.
...
```text
🌟 Afternoon Dining Room | Royal Blue & A Sweet Ice Cream Break 🌟

[Subject / Art Style]
Depict a clearly adult Japanese woman enjoying ice cream in her home dining room during the afternoon. A photorealistic photograph combining the elegance of high-end fashion photography with the natural, lived-in feel of a candid snapshot from daily life. Rather than merely showcasing the outfit and subject, craft a serene scene that conveys an "afternoon break" through the inclusion of the table, small dessert, window light, and surrounding furniture.
Focus on a natural sense of distance as if shot inside an actual home interior, avoiding overly posed, provocative gravure-style tropes. The composition highlights the woman's soft facial expression, the royal blue attire, and the warm tones of the wooden furniture, complementing one another harmoniously.

[Location / Background / Worldview]
A bright, tidy home dining room. In front of the woman sits a gently rounded dining table with beautiful wood grain, while the background features wooden chairs, low storage furniture, small house plants, and tasteful, understated home decor. On one side of the frame, a large window with sheer, pale curtains softly reveals outdoor greenery.
On the table, place a small cup of ice cream, a glass of clear water, and a simple coaster naturally. Keep accessories modest and uncluttered to immediately convey a clean, calm living space where someone is taking a brief afternoon pause.

[Season / Time / Weather]
A calm, clear afternoon reminiscent of spring to early summer. The time is around 2:00 PM to 4:00 PM; soft natural light streams through the window rather than harsh, direct sunlight, dispersing gently throughout the room.
Though bright outside, it is not stiflingly hot—just pleasantly warm enough to tempt one into lingering over a cold scoop of ice cream. There is virtually no wind, creating a quiet afternoon atmosphere where curtains and strands of hair remain still.

[Character Description]
A clearly adult Japanese woman around 24 to 27 years old. Soft, well-proportioned facial features, naturally large eyes, slender, gentle eyebrows, and healthy, rosy lips. Her skin has a bright ochre undertone with realistic textures, retaining pores and subtle micro-shadows. Dark brown, shoulder-length hair gathered loosely in an updo, leaving natural tendrils and stray wisps framing her face.
Her physique is naturally glamorous, balancing delicate shoulders and limbs, a slender waist, and feminine curves. Her bust possesses a distinct, full, and rich volume without appearing rigid or excessively pushed up, showing soft three-dimensionality that conforms naturally to her seated posture and the fabric. Her hips and thighs also exhibit a healthy, natural roundness.

[Attire & Accessories]
A deep, vivid royal blue bra and panty lingerie set reminiscent of fine lingerie labels like Wacoal. The bra cups are adorned with delicate small floral embroidery and lace in tonal royal blue and subtle silver, creating an elegant, mature design. The panties discreetly mirror the same floral motif, providing unified styling as a cohesive set.
The set comfortably and realistically fits her full bust, with the cups, straps, and stitching naturally supporting her form. Avoid extreme fabric strain, digging into the skin, or floating unnaturally away from the body. As a rule, no jewelry or accessories, prioritizing the unpretentious mood of relaxing at home.

[Pose / Action / Gaze]
The woman sits on a wooden chair without leaning too far back, maintaining a natural posture with an upright spine. Her weight is evenly distributed across her hips and thighs, with her body angled slightly diagonally relative to the table rather than facing dead-on. Her legs are relaxed, knees placed at a natural width without being tightly crossed.
In one hand, she holds the small ice cream cup slightly below chest level, while her other hand is poised mid-motion, bringing a spoon toward her lips. It is the precise moment right before taking a bite, her gaze naturally cast down toward the spoon or the cup, not looking at the camera. Her shoulders and elbows remain tension-free, capturing the effortless motion of an ordinary break.

[Expression / Emotion]
A faint, peaceful smile that anticipates the sweet, cold treat. The corners of her lips are slightly lifted, softening her cheeks and around her eyes. She does not laugh widely or open her mouth wide; her expression is natural, carefree, and content in her solitary afternoon.
By casting her eyes toward her hands, a quiet intimacy is created that appears oblivious to the camera. Not a posed smile, but an effortless, unforced flash of delight that naturally emerges before a favorite dessert.

[Composition / Camera]
A vertical 4:5 aspect ratio optimized for an X (Twitter) post. A seated medium shot framing her from the crown of the head down to mid-thigh, placing the woman slightly to the right of center. In the left foreground, include the table edge, water glass, and part of the dessert, leaving an appropriate amount of window and wooden furniture in the background.
Camera angle set around eye-to-chest level, using a standard to short-telephoto focal length equivalent of approximately 50–70mm. Avoid extreme low angles or wide-angle distortion, keeping natural perspective across her face and body. The depth of field softly blurs the background while preserving enough clarity to identify the setting as a dining room.

[Lighting / Color / Texture / Mood]
The primary light source is afternoon natural light entering from the window on the left, casting a soft, diagonal illumination across her face, shoulders, arms, and lingerie. The opposite side is gently filled by subtle bounce light from white walls and wooden furniture, preventing deep shadows. Shadow transitions are soft, carrying a slightly warm afternoon color temperature.
Render natural flush and fine nuances on the skin, along with distinct hair strands and fine loose wisps. Render the royal blue lace with delicate thread details and embroidery relief, the wooden table with fine wood grain and modest sheen, and the glass with clean transparency and faint reflections. The overall atmosphere is quiet and cozy, blending warm wood tones with deep blue.

[Quality & Exclusions]
High resolution, authentic skin, hair, fabric, glass, and wood textures. Emphasize human anatomical balance, lighting, and perspective consistent with real camera capture.
Avoid figures that appear underage, childish facial features, unnatural anatomy or joints, extra or missing limbs or fingers, fused fingers, mismatched left/right hands, distorted clothing or garments merging with the skin, unintended exposure, and extreme wide-angle distortion. For the bust, maintain a natural, ample volume while avoiding unnatural enlargement, rigid spherical forms, exaggerated push-up effects, or gravity-defying shapes. Do not include excessive plastic-like skin smoothing, text, logos, watermarks, or UI overlays.
```
...
### High-contrast natural light portrait photography prompt of a woman in pink and white traditional Chinese costume in a dark wooden corridor courtyard, including attire, scene, and action details.

Author：[@nanyuan0412](https://x.com/nanyuan0412) · [Source](https://x.com/nanyuan0412/status/2100969699387568544)

Photography · Portrait / Selfie · Character · Published

Source：[@nanyuan0412](https://x.com/nanyuan0412) · [Source](https://x.com/nanyuan0412/status/2100961447631311163)

**Summary:** High-contrast natural light portrait photography prompt of a woman in pink and white traditional Chinese costume in a dark wooden corridor courtyard, including attire, scene, and action details.
...
```text
3:4, natural light digital period costume portrait photography, pink and white period costume × dark wooden corridor × intense courtyard daylight × blown-out highlight bloom × deep dark background × sweet and lively

Subject is an adult female; lithe and slender, naturally beautiful, long black hair half-tied in a high bun, forehead ornament with pink beads and silver chains, white flowers and pinkish-white feather headdress, long silver chain earrings; soft pink semi-matte makeup.

Fixed Attire:
Pink and white long skirt / pale pink chest patch / white translucent wide-sleeved sheer gauze / light pink pibo scarf, lightweight and translucent material.

[Scene]
Beside a wooden pillar / next to a carved wooden door / inside the corridor railing / corridor entrance / beside a latticed window / by the threshold

[Action / Movement]
Holding a white rabbit and observing it / stroking the rabbit's ears / leaning out from behind a pillar / raising hands to spread the scarf / lifting the sheer gauze with both hands to observe light transmission / holding the pillar and peeking out / tucking hair behind the ear / leaning on the railing looking out / lifting skirt stepping over threshold / scarf caught by the wind while turning around

[Expression]
Curious / suppressing a smile / slight surprise / thoughtful / just about to speak / slight upward curve of the lips / briefly daydreaming

[Gaze]
Looking at the rabbit / looking at the sheer fabric in hand / looking outside the frame / gazing into the distance along the corridor / occasionally looking at someone behind the camera

[Shot Framing & Composition]
Environmental three-quarter shot / medium shot / bust close-up / 3/4 profile / wooden pillar foreground occlusion / doorframe framing / off-center character composition / large areas of dark architectural negative space

[Lighting]
The subject is situated at the boundary between sunlight and shadow in the corridor, strong natural daylight from the front-side; face is bright yet retains facial features, white gauze and light pink fabrics naturally overexposed in parts, dark wooden architecture noticeably underexposed, shadows near black, no HDR-style brightening.

[Final Look]
Realistic natural light digital portrait photography, slightly high contrast, soft skin tones, subtle highlight bloom, not over-sharpened, not studio-shot, not modern commercial period-costume portrait photography.
```
...
### A prompt to generate natural and realistic photos in the style of an iPhone shot, based on a reference image.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2100572149778112835)

Photography · Published

Source：[@sakisuta\_](https://x.com/sakisuta_) · [Source](https://x.com/sakisuta_/status/2100523713619992970)

**Summary:** A prompt to generate natural and realistic photos in the style of an iPhone shot, based on a reference image.
...
```text
Generate a realistic photo based on the reference image. Create a realistic and natural image as if taken with an iPhone.
```
...
### Natural smartphone-style portrait prompt of a 30s Japanese woman waking up in the car passenger seat.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100777832100356286)

Photography · Portrait / Selfie · Character · Vehicle · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100219905308057603)

**Summary:** Natural smartphone-style portrait prompt of a 30s Japanese woman waking up in the car passenger seat.
...
```text
Character Identity:
A fictional 30-year-old adult Japanese woman. A cheerful bakery-café manager with a sophisticated, playful influencer-like presence. A petite, softly rounded oval face with gently plump cheeks and a rounded chin. Large, expressive dark brown double-lidded eyes, intermediate between almond and round, with the outer corners tilting very slightly downward. Groomed, gentle arched eyebrows, a natural straight nose with a slightly rounded tip, and soft, plump lips with naturally upturned corners. Fair, warm-neutral Japanese skin retaining realistic pores, light natural redness, faint freckles across the nose, and slight asymmetry. Exactly one tiny mole beneath the outer corner of her anatomical left eye. Her signature smile is a bright, playful grin showing teeth that produces dimples in both cheeks. Hair is a smooth, straight shoulder-length layered bob. Parted slightly off-center, with only the ends curling naturally inward. The outer layer, roots, crown, part, bangs, and upper hair framing the face are a uniform, glossy black to dark charcoal. Cool smoky gray to graphite silver inner coloring is located solely beneath that dark outer layer, visible only around the tucked-behind-the-ear areas and the inner lower ends. No center split, half-and-half coloring, central stripe, gray roots or crown, face-framing highlights, gradation, or full-head gray. Modern influencer makeup features defined lashes, understated taupe eyeliner, and rose-beige lips, without smoothing the skin like plastic. Thin, round black metal or gunmetal glasses are an optional signature accessory. Maintain these fictional adult facial features, face shape, freckles, correct mole placement, dimples, black outer hair, inner color placement, hair length, and adult age perception, without resembling any identifiable real person.

Body Consistency:
Height approximately 166 cm. Long legs, confident posture. A healthy, lightly toned adult hourglass figure. Bust is naturally ample, with realistic base width proportional to her ribcage, forward fullness, soft weight, and natural gravity. Waist is defined yet realistic; hips and buttocks are moderately full with a slightly larger roundness, transitioning naturally from pelvis to thighs. Maintain height, ribcage, waist, pelvis, hip volume, and limb proportions regardless of viewpoint. Ordinary, opaque clothing with natural fabric tension. No cleavage-lifting bust enhancement, exposed deep cleavage, padding, extreme cinching, implant-like spherical shapes, impossibly tiny waist, exaggerated hips, or BBL-style contours.

Shooting Situation:
17:10. In a car stopped in front of her home on the way back. Immediately after waking from a nap in the passenger seat.

Location and Background:
Passenger seat of a car stopped near home on the return trip. A small, plain craft paper bag from a pottery shop rests on her lap.

Outfit:
Lightweight, opaque charcoal form-fitting sleeveless top, black lightweight ankle-length long skirt, black flat sandals. Thin black-rimmed round glasses, thin silver hoops, small black shoulder bag.

Pose and Action:
Sitting with her back leaning against the seat. Seatbelt fastened naturally. Lightly supporting the paper bag on her lap with both hands. Facial expression / Head direction: Back of the head resting against the headrest, chin tilted slightly upward. Neck is not tilted to the left or right. Eyes are equally half-open, just waking up, eyebrows relaxed. Lips closed with mouth corners horizontal. Not winking, not smiling.

Composition and Framing:
Standard smartphone 1x lens from a friend sitting in the stopped driver's seat. Approximately 0.9 m away, 1.2 m height, framing from head down to knees and paper bag.
Output exactly one undivided image with a final size of 1086×1448 px, aspect ratio 3:4.

Light and Atmosphere:
Gentle evening light coming through the car window.

Photo Texture:
Depict a minimally processed HEIC photo taken with a standard smartphone camera app. Do not confuse the shape of the person, body, and hair with surface finishing. Adhere to a single camera-specified autofocus plane; do not re-light, denoise, or sharpen distant faces in isolation. Details soften continuously with distance. Within the recognizable range of the face, maintain multiple broad tonal differences simultaneously—such as warm color on one cheek, uneven sheen on the T-zone, different under-eye tones on each side, and faint redness on the nose—without drawing distinct pores on a distant face. Nearby resolvable skin should retain non-repeating low-contrast color variations, pressure redness, crease shadows, and sparse pore differences. Makeup should look like actual cosmetic pigments with slightly irregular edges, and lips and teeth should keep normal tonal variation. Preserve uneven exposure and white balance, unlifted shadows, a few flyaway hairs, off-center composition, shadow noise, subtle sharpening near the AF point, and HEIC compression artifacts. A slice straight from an unedited personal camera roll.

Mandatory Conditions:
Output only one undivided smartphone photo of an adult woman matching all scene specifications. Must satisfy both the scene pass criteria and the quality criteria of a natural smartphone photo.

One fictional 30-year-old adult woman. Friend and photographer remain out of frame.
Pass Criteria:
1) Maintain the woman's adult face, round glasses, black shoulder-length bob, and gray lower layer.
2) Outfit, scene, main action, and props must match; hands and contact points must look natural.
3) The specified framing angle and overall composition must be achieved.
4) An everyday smartphone photo with distance-dependent resolution falloff, natural skin tonal variance, and material distinction.
5) Back of head resting against the headrest, chin tilted slightly upward. Neck not tilted sideways. Both eyes equally half-open upon waking, eyebrows relaxed. Lips closed, corners of the mouth horizontal. No winking, no smiling.

Maintain specified accessories.

Black shoulder-length straight bob with gray inner coloring only around ears and underneath. Top layer of hair is black. Maintain round glasses. Opaque fabrics.

Subject has 2 arms and 2 hands. Natural contact between hands and objects, natural body support. Strictly observe this scene's facial expression and gaze. Character's signature smile and dimples are traits only when smiling, not a constant toothy grin.

Single AF point on the face. One standalone vertical 3:4 photo. Do not clip the head or limbs within the specified range at the edges; leave margins.
Only one image. Maintain the specified aspect ratio and full framing requirement.

Natural shadows and exposure differences.

Only one depth layer of autofocus. No face-only exposure compensation, relighting, smoothing, or AI face restoration. Distant faces retain broad tonal shifts, close skin retains irregular variations, and smartphone-specific processing artifacts remain localized.

Depict only one clearly adult fictional woman as the sole subject of an undivided single photograph. One head, one face, exactly two anatomically connected arms, and natural hands. An additional person's hand in the foreground is allowed only if explicitly stated in the scene or prop specs, and that hand must be distinctly separated from the subject's body. No text, panels, duplicate figures, or alternate angles.

Negative Prompt:
Different scene, different person., real brand logos, readable signage., full-head gray, long hair, translucent clothing., extra arms, fused fingers, impossible joints. Posed model expression, clichéd head-tilted-to-shoulder pose, toothy smile inconsistent with the scene specification., collage, split screen, composition focused only on body parts., face-only relighting, studio lighting., beauty skin filter, glowing porcelain face, waxy uniform face or limbs, skin whitening, high-key beauty fill light, face relighting, face sharpening, perfect makeup outlines, uniformly glossy lips, uniformly bright teeth, global sharpness, overall clarity enhancement, repeating textures, fake grain added over the whole image, excessive HDR, overly polished fashion presentation, catalog-like symmetry, ad campaign finish, CGI, illustration, minor, teenager, child, childlike age perception, school uniform, real person, resemblance to celebrities, duplicated subject, extra subjects, extra heads, extra faces, extra arms on subject, missing arms on subject, fused limbs, detached limbs, deformed hands, extra fingers, fused fingers, distorted face, crossed eyes, text, subtitles, letters, numbers, logos, watermarks, signatures, borders, grids, contact sheet, collage, split screens, picture-in-picture, multiple panels
```
...
### Realistic travel photo of a hiker making a finger-heart gesture before a tall tropical waterfall.

Author：[@abs\_uiux](https://x.com/abs_uiux) · [Source](https://x.com/abs_uiux/status/2100833209965494721)

Photography · Published

**Summary:** Realistic travel photo of a hiker making a finger-heart gesture before a tall tropical waterfall.
...
```text
Create a highly realistic vertical travel photograph of an adult man standing in front of a massive tropical waterfall surrounded by dense green rainforest and rugged moss-covered cliffs.\n\nUse a dramatic low-angle, full-body composition, making the subject appear tall while the towering waterfall rises directly behind him. He stands confidently on a grassy, rocky trail, looking slightly down toward the camera with a calm expression.\n\nDress him in a dark charcoal fitted hiking T-shirt, beige cargo hiking shorts, rugged brown/grey trail shoes, a black backpack, and a simple black wristwatch. Keep the styling practical, natural, and adventurous.\n\nPose him with one hand holding the backpack strap while the other hand is raised casually in front of his chest making a small finger-heart gesture.\n\nThe background should feature a spectacular tall waterfall plunging from a steep cliff, with several smaller streams flowing down the surrounding rock walls. Include thick tropical vegetation, vines, wet rocks, mist from the waterfall, bright green grass in the foreground, and a partly cloudy blue sky above.\n\nUse bright natural daylight, realistic skin texture, authentic outdoor colors, subtle atmospheric mist, detailed vegetation, realistic water movement, natural shadows, and crisp photographic detail.\n\nShot from very close to ground level with an ultra-wide 24–28mm smartphone-style lens, creating strong foreground perspective while keeping the waterfall clearly visible.\n\nStyle: realistic adventure photography, tropical hiking expedition, candid travel photo, natural lighting, high dynamic range, sharp details, authentic smartphone photography, cinematic but not over-edited.\n\nAspect ratio: 9:16 vertical.
```
...
### Outdoor lifestyle photo of an East Asian woman sitting on an orange SUV rack by a mountain lake.

Author：[@afrinxai](https://x.com/afrinxai) · [Source](https://x.com/afrinxai/status/2100812308952096963)

Photography · Character · Landscape / Nature · Published

Source：[@afrinxai](https://x.com/afrinxai) · [Source](https://x.com/afrinxai/status/2100586320393339321)

**Summary:** Outdoor lifestyle photo of an East Asian woman sitting on an orange SUV rack by a mountain lake.
...
```text
A full-body lifestyle photograph of a young East Asian woman sitting relaxed on the roof rack of a bright orange off-road SUV. She is leaning back slightly with her head tilted upward toward the sky, eyes gently closed in a serene, carefree expression.\n\nOutfit & Styling: She wears a fitted black ribbed cropped tank top paired with loose, high-waisted black parachute cargo pants gathered at the ankles. On her feet are classic black-and-white high-top canvas sneakers. She is wearing a black baseball cap worn backwards over long, straight dark hair, and a subtle metallic wristwatch on her wrist.\n\nEnvironment & Mood: Scenic outdoor adventure setting with a soft-focus background featuring a calm lake and snow-capped mountain peaks under a clear, cool-toned sky. Natural soft daylight, cinematic color grading, shot on a 85mm lens at f/2.8, shallow depth of field, sharp subject focus, 8k resolution\nUse the uploaded photo as the facial identity reference for an adult woman. Preserve his recognizable facial features, natural skin tone, facial proportions, and overall appearance. make the aspect ratio 3:4
```
...
### Ultra-photorealistic fashion editorial portrait of a woman in an extravagant crimson couture gown riding a black horse in a windswept setting under overcast daylight.

Author：[@Tanvir48992](https://x.com/Tanvir48992) · [Source](https://x.com/Tanvir48992/status/2100819610987811160)

Photography · Portrait / Selfie · Character · Fashion Item · Published

**Summary:** Ultra-photorealistic fashion editorial portrait of a woman in an extravagant crimson couture gown riding a black horse in a windswept setting under overcast daylight.
...
```text
Ultra-photorealistic cinematic fashion editorial portrait of an elegant adult woman riding a powerful black horse, captured in a dramatic, windswept outdoor setting. The composition is vertical and dynamic, photographed from a slightly low front-facing angle, making the horse and rider feel powerful and imposing.\n\nThe woman is positioned in the upper-center of the frame, sitting confidently on the horse. She wears an extravagant deep crimson-red couture gown made from heavily textured, flowing fabric. The dress has enormous voluminous layers that spread dramatically around the horse, creating a sculptural silhouette. The fabric appears raw, wrinkled, slightly distressed, and naturally moving with the wind, with rich variations of dark burgundy, scarlet, and deep red tones.\n\nShe has long, naturally messy black hair, dramatically blown sideways by strong wind. Individual strands and loose curls are visible flying around her face and shoulders. Her expression is intense, serious, and mysterious, with a calm but commanding gaze directed toward the camera. Natural realistic skin texture, subtle pores, delicate facial details, authentic imperfections, and cinematic facial lighting.\n\nThe horse is a large powerful black/dark-brown horse, positioned prominently in the foreground. Its head and upper body dominate the lower portion of the frame, creating strong depth and scale. The horse has a glossy but naturally textured coat, detailed mane, expressive eyes, realistic leather bridle and reins, and subtle highlights across its muscular face and neck. Slight motion blur in the mane and fabric suggests movement.\n\nThe rider holds the reins naturally, maintaining a confident equestrian posture. The massive red gown cascades down around the horse and fills much of the lower and side areas of the composition, contrasting dramatically against the dark horse.\n\nLighting: soft overcast natural daylight, diffused cinematic illumination, subtle highlights on the woman's face and red fabric, deep natural shadows, muted atmospheric tones.\n\nBackground: minimal pale gray/off-white sky and softly blurred neutral environment, keeping all attention on the rider, horse, and flowing red couture. Strong separation between foreground and background.\n\nPhotography style: high-fashion editorial photography, avant-garde couture campaign, cinematic realism, dramatic movement, sophisticated composition, realistic fabric physics, natural wind, shallow depth of field, subtle film grain, high dynamic range, realistic textures, professional full-frame camera look, 85mm lens aesthetic, sharp subject details, atmospheric depth.\n\nColor palette: deep crimson, burgundy, black, charcoal, muted gray, with restrained contrast and an elegant dark-romantic mood.\n\nNegative prompt: cartoon, anime, illustration, CGI look, plastic skin, excessive makeup, distorted face, deformed hands, extra limbs, malformed horse, duplicate horse, unrealistic anatomy, floating fabric, oversaturated colors, artificial lighting, low resolution, blurry face, excessive sharpening, text, logo, watermark.
```
...
### Authentic snapshot scene of high-end business KTV nightlife, featuring a slightly tipsy young woman as the main subject and business male guests as supporting characters, simulating phone direct-flash and high ISO texture.

Author：[@boniusex](https://x.com/boniusex) · [Source](https://x.com/boniusex/status/2100796631960670531)

Photography · Portrait / Selfie · Character · Published

**Summary:** Authentic snapshot scene of high-end business KTV nightlife, featuring a slightly tipsy young woman as the main subject and business male guests as supporting characters, simulating phone direct-flash and high ISO texture.
...
```text
Realistic nightlife photography, 9:16 vertical ratio, luxury business KTV private room, dark leather sofa, black-and-gold marble tabletop, warm gold LED strip lighting mixed with blue-purple neon, phone direct-flash candid snapshot texture, slight grain, realistic skin texture, slight overexposure, high ISO night photography, 28mm close-range lens, private photo album feel, spontaneous candid shot, does not look like a studio shoot. The main subject is an adult East Asian woman in her 20s, with delicate natural makeup, long dark hair, wearing an exquisite club dress, natural body shape, with a relaxed, slightly tipsy expression. In the private room, there are also adult male paying guests, around 30 to 45 years old, average office build to slightly chubby, dressed in business casual or button-up shirts, acting as secondary background figures without overshadowing the main subject. On the table are whiskey, glass tumblers, an ice bucket, a fruit platter, snacks, microphones, tissues, and messy party drinking supplies. In the background are the KTV screen, sofas, and other friends, capturing an authentic Chinese high-end business KTV nightlife atmosphere. All characters have distinct face shapes, avoiding cloned faces, and avoiding having everyone of the same age and body type.
```
...
### A prompt template for generating a 3x3 grid smartphone daily candid photo gallery.

Author：[@OiCLhoXau40xUBx](https://x.com/OiCLhoXau40xUBx) · [Source](https://x.com/OiCLhoXau40xUBx/status/2100840912700244431)

Photography · Published

**Summary:** A prompt template for generating a 3x3 grid smartphone daily candid photo gallery.
...
### A casual smartphone-style prompt of a 30-year-old Japanese woman relaxing on her living room sofa at night in loungewear, watching TV.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100794190028308894)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100236011632566644)

**Summary:** A casual smartphone-style prompt of a 30-year-old Japanese woman relaxing on her living room sofa at night in loungewear, watching TV.
...
```text
Character Identity:
A fictional 30-year-old Japanese adult woman. A cheerful bakery café manager with a polished, playful influencer-like presence. She has a petite, softly rounded oval face, gently plump cheeks, and a rounded chin. Large, expressive, dark brown double-lidded eyes, intermediate between almond-shaped and round, with outer corners that droop very slightly. Neatly groomed, soft arched eyebrows, a natural straight nose with a slightly rounded tip, and soft, plump lips with naturally upturned corners. Fair, warm-neutral Japanese skin showing realistic pores, faint natural flushing, subtle freckles across the nose, and slight natural asymmetry. There is a single tiny beauty mark located beneath the outer corner of her anatomical left eye. Her signature smile is a bright, playful, tooth-showing smile that forms dimples on both cheeks. Hair is a shoulder-length, smooth straight layered bob. The parting is slightly off-center, with ends naturally curling inward. The surface layer, roots, crown, part line, bangs, and upper hair framing the face are a uniform, glossy black to dark charcoal. A cool smoky gray to graphite silver peekaboo under-color exists exclusively beneath this dark surface layer, visible only around the tucked-behind-the-ear sections and the inner lower tips. Do not render a center-part split, half-and-half color blocking, a center stripe, gray roots or crown, face-framing gray highlights, gradients, or full-head gray. Modern influencer-style makeup featuring defined eyelashes, subtle taupe eyeliner, and rose-beige lips, without plastic-like skin smoothing. Thin, round black metal or gunmetal glasses are an optional signature accessory. Maintain the fictional adult facial features, face shape, freckles, beauty mark placement, dimples, black surface hair, peekaboo color placement, hair length, and mature adult age described here, without resembling any identifiable real person.

Body Consistency:
Height approximately 166 cm. Long legs with a confident posture. A healthy, lightly toned adult hourglass figure. Breasts are naturally full, with realistic root width proportional to the ribcage, forward volume, and soft weight responding to gravity. The waist is tapered yet realistic; hips and buttocks are moderately full with a slightly larger curve, transitioning naturally from pelvis to thighs. Maintain height, ribcage, waist, pelvis, hip volume, and limb proportions consistently across varying perspectives. Use ordinary, opaque clothing and natural fabric tension. Do not render push-up breast correction, exaggerated cleavage, padding, extreme corseting, implant-like spheres, impossibly narrow waists, exaggerated hips, or BBL-style contours.

Shooting Context:
21:15. A woman who returned home relaxes on the sofa, capturing the final shot of her day off using her propped-up smartphone timer. She is lazily watching TV.

Location and Background:
A lived-in fabric sofa at home, slightly worn. Cushions and a rolled-up blanket. On the low coffee table sits a purchased charcoal ceramic mug with a white interior and a round handle.

Outfit:
A thin charcoal cotton camisole and light gray short cotton loungewear shorts. Both are opaque. Barefoot, wearing thin, black-rimmed round glasses.

Pose and Action:
Lying on her side on the sofa, resting her head on a cushion. Knees are gently bent, with the upper hand resting against a remote control. The lower arm rests naturally beside the cushion. Her weight rests fully on the sofa without arching her back. A relaxed, closed-mouth expression looking toward the TV, without turning back toward the camera.

Composition and Angle of View:
A pulled-back everyday snapshot taken from a smartphone placed diagonally behind the sofa, encompassing the room and the entire sofa. Distance approximately 2.5 m, height 1.2 m, standard 1x lens. A full-body view relaxing sideways along with her profile in equal proportion. Framing from head to toes with breathing room, avoiding close-ups on any single body part, capturing both the sofa and the low table. The subject occupies within 75 percent of the image width. Background margins of at least 10 percent of the frame width are kept beyond the tips of the toes and the top of the head, with the left and right ends of the sofa fully contained within the frame.
Output only a single, undivided image with a final size of 1086×1448 px and a 3:4 aspect ratio.

Lighting and Atmosphere:
Warm interior lighting overlaid with the dim, cool glow of the television. Deep gaps in the sofa and the rear of the room remain naturally dark.

Photo Texture:
Depict a single, minimally processed HEIC photo taken with the standard camera app of an ordinary smartphone. Do not confuse character, body, and hair geometry with surface finish. Adhere to a single camera-specified autofocus plane; do not relight, denoise, or sharpen only the distant face. Details soften continuously with distance. Within the recognizable face, preserve broad tonal variations simultaneously—warm hues on one cheek, uneven sheen on the T-zone, differing under-eye tones, and faint redness on the nose—without drawing sharp pores on the distant face. On close, resolvable skin, preserve non-repeating low-contrast tonal shifts, compression-induced redness, crease shadows, and sparse pore variations. Present makeup as real pigment with slightly uneven edges; maintain natural tonal differences between lips and teeth. Maintain uneven exposure and white balance, unlifted shadows, stray flyaway hairs, casual off-center framing, shadow noise, subtle sharpening near the focal plane, and typical HEIC compression artifacts. Capture a frame that feels like an unedited personal camera roll snapshot.

Mandatory Conditions:
Output only a single, undivided smartphone photo of an adult woman matching all scene specifications. It must meet both the scene acceptance criteria and natural smartphone photo quality standards.

Everyday life of a single fictional 30-year-old adult woman.
Acceptance Criteria:
1) A sense of relaxation conveyed from behind, with a natural profile visible beyond.
2) A full-body composition encompassing head to toe. Ordinary clothing worn naturally, with no arched lower back.
3) Maintain adult female facial features, hairstyle, round glasses, and physique.
4) Clearly distinct from seated poses or direct camera-facing expressions of previous scenes.
5) Natural resolution and material differences according to distance from the AF plane, with no selective face retouching.

A lived-in home setting.

Clothing worn normally. Black shoulder-length bob with gray peekaboo color around the ears and lower layer.

Natural lateral recumbent pose. Exactly two arms, two legs, and natural fingers and physical contact. Smiling and dimples are characteristics of laughing; no smiling in this scene.

Autofocus fixed to a single depth plane containing the face and cushion. One standalone vertical 3:4 image.
Only one image. Preserve the specified aspect ratio and full-framing requirements.

Natural lateral vignetting and exposure falloff.

Only a single AF tier. No selective facial exposure compensation, relighting, skin smoothing, or enhancement. Maintain broad tonal shifts on distant facial features, irregular variations on near skin, and localized smartphone processing artifacts.

Depict only a single clearly adult fictional woman as the sole subject of an undivided single photograph. One head, one face, exactly two anatomically connected arms, and naturally shaped hands. An additional person's hand in the foreground is allowed only if explicitly stated in the scene and props, clearly separated from her body. No text, panels, duplicate figures, or alternate angles.

Negative Prompt:
Different person, different scene., Hotel, studio, legible logos., Sheer fabric, riding-up clothes, full-head gray hair., Arched back, unnatural contortion, extra limbs, toothy staged pose smile., Cropped composition focusing solely on hips, cropped head or feet, split images., Face-only relighting, studio lighting., Beauty filter, glowing porcelain skin, waxy uniform face or limbs, skin whitening, high-key beauty fill light, facial relighting, facial oversharpening, flawless makeup edges, uniformly glossy lips, uniformly bright teeth, edge-to-edge sharpness, global clarity enhancement, repetitive textures, globally added fake grain, excessive HDR, overly polished editorial fashion styling, catalog-style symmetry, commercial ad campaign finish, CGI, illustration, underage, teen, child, childish age appearance, school uniform, real person, celebrity resemblance, duplicate subjects, extra subjects, extra heads, extra faces, extra arms on the subject, missing arms, fused limbs, detached limbs, deformed hands, extra fingers, fused fingers, distorted face, crossed eyes, text, subtitles, letters, numbers, logos, watermarks, signatures, borders, grids, contact sheets, collages, split-screen, inset images, multi-panel
```
...
### Realistic Japanese train portrait: a black-haired woman in a black sailor suit and black sheer pantyhose looking back over her shoulder, set in an authentic carriage environment.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2100841318553722917)

Photography · Portrait / Selfie · Character · Vehicle · Cityscape / Street · Published

**Summary:** Realistic Japanese train portrait: a black-haired woman in a black sailor suit and black sheer pantyhose looking back over her shoulder, set in an authentic carriage environment.
...
```text
Hyper-realistic Japanese subway street photography, vertical format approx 3:4. An unambiguously adult East Asian woman, 20+, adult academy-style cosplay model, standing in the central aisle of a Japanese commuter train carriage, body in a two-thirds back view facing the camera, waist and hips slightly turned to the side, head turned back looking at the photographer. The photographer is seated near the carriage seats, capturing with a 50–85mm equivalent lens from a low angle behind the subject, fully framing the head, waist, hips, legs, and part of the handbag, with abundant real passengers and carriage details retained around.

The subject has a small-to-medium frame, narrower shoulders, slim waist, naturally rounded hips, well-proportioned and slender thighs, realistic proportions, no athletic or exaggerated physique. Legs standing naturally close together, weight resting on one leg with the other slightly relaxed; right hand hanging at the side-rear, holding a small black leather handbag / shoulder bag.

The subject has jet-black chin-length straight bob hair, ends neatly curled inward, thick textured straight-across blunt bangs on the forehead, side strands naturally framing the jawline. Looking back reveals mostly a three-quarter profile, eyes calmly looking directly into the camera, cold and unsmiling expression.

Outfit is a solid black long-sleeved academy-style sailor-collar top + black short pleated skirt, slim-fit top, dark navy sailor collar structure at the neck and shoulders with minimal white neckerchief / tie details; skirt is very short but maintains proper complete coverage, pleats naturally flaring outward. Lower body wears sheer smoky black ultra-thin pantyhose, approx 10–20D, clearly revealing natural skin tone beneath, legs displaying a soft grey-black sheen under the cool white carriage lights. Feet can be cropped out, no forced appearance of shoes.

The setting is an authentic Japanese urban commuter train carriage: numerous passengers seated on both sides, mostly looking down at their phones or resting; silver metal grab poles, overhead luggage racks, white triangular hanging straps, light grey ceiling and train doors, densely distributed colorful advertisement posters. The subject stands in the center of the aisle, passengers in front and behind forming a natural framing, carriage feels cramped and everyday-lived-in, no empty train.

Lighting is cool white fluorescent lights from the subway ceiling + a hint of natural light from windows, overall leaning cyan-grey, low saturation, subject's black hair and black clothing are deep, skin tone is naturally fair. Using shallow to medium depth of field: subject is sharp, foreground passengers and distant ads slightly blurred, but train structure remains identifiable.

Overall 2000s–2010s Japanese street photography / commuter snapshot aesthetic: subtle grain, natural sharpness, limited dynamic range, slight lens compression, no studio lighting, no HDR, no cinematic color grading.

Key focuses: adult East Asian woman + Japanese subway carriage + two-thirds back standing pose + looking back at camera + short black bob with blunt bangs + black academy-style sailor suit + black short pleated skirt + sheer smoky black pantyhose + black handbag + real passengers on both sides + hanging straps and grab poles + cool white carriage lights + Japanese telephoto candid snapshot.

Avoid: minors, actual student identity, long hair, high ponytail, frontal standing pose, white socks, fishnets, bare legs, colored skirts, empty carriage, heavy bokeh, anime face, CG look, plastic skin, extra limbs, watermarks, and garbled text.
```
...
### Ultra realistic fashion portrait of a woman surrounded by flowing translucent white fabric in a Vogue editorial aesthetic.

Author：[@arsalannazir07](https://x.com/arsalannazir07) · [Source](https://x.com/arsalannazir07/status/2100812124109091018)

Photography · Portrait / Selfie · Character · Fashion Item · Published

**Summary:** Ultra realistic fashion portrait of a woman surrounded by flowing translucent white fabric in a Vogue editorial aesthetic.
...
### Chinese-style indoor private portrait photo prompt depicting an East Asian woman in a close-up high-angle shot, blowing on water droplets in her palm in a direct-flash candid scene.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2100795488568254795)

Photography · Portrait / Selfie · Character · Architecture / Interior · Published

Source：[@jackzhang123vip](https://x.com/jackzhang123vip) · [Source](https://x.com/jackzhang123vip/status/2100778587964252389)

**Summary:** Chinese-style indoor private portrait photo prompt depicting an East Asian woman in a close-up high-angle shot, blowing on water droplets in her palm in a direct-flash candid scene.
...
```text
A highly realistic, close-up, high-angle perspective Chinese-style indoor private portrait photo of an adult East Asian woman. Upper body close-up composition, with the subject leaning slightly forward, looking up at the camera. Her face is very close to the lens, creating a slight wide-angle perspective and a sense of intimacy, with an overall casual, candid snapshot atmosphere.

The subject has short, straight black hair, falling just above the collarbones, smooth with a natural shine. She has light, wispy air bangs on her forehead, a clear hair parting, and her hair falls naturally on both sides of her cheeks. On the right side of her hair, she wears a silver butterfly/flower-shaped hair clip with a bit of rhinestone or translucent decorative texture. She wears delicate, small earrings on her ears: one side can be a small pink-purple pendant earring, and the other side a small stud or minimalist earring.

Her face shape is a rounded oval, with delicate, youthful features while clearly being an adult. Her eyes are large and round, with clear pupils and distinct catchlights, looking directly into the camera. She has natural eyelashes, subtle aegyo sal under-eye highlights, slender natural eyebrows, a petite nose tip, and her cheeks are slightly puffed as she makes the gesture of gently blowing air onto her palm, with a cute, slightly innocent, and playful pouty expression. Her skin is fair and delicate, preserving real skin texture and faint reflections without excessive skin smoothing.

She holds one hand flat in front of her mouth, palm facing upward, with a few transparent water droplets or sparkling liquid reflections on her hand, as if she has just caught a bit of water or is blowing onto her palm. The palm is positioned in the center-front of the frame, slightly exaggerated in perspective due to its closeness to the lens.

Her outfit is a Chinese-style domestic private portrait mix-and-match look: an inner layer of a white lace-trimmed camisole/bralette top with thin shoulder straps, soft lace trim, and a small bow detail at the chest; an outer layer of a Chinese domestic-style lightweight wrap/robe/sheer cardigan with a light pink base and large blue floral print. The garment slips naturally off her shoulders, revealing her collarbones, shoulders, and undergarment, creating a relaxed, casual, everyday boudoir portrait vibe. The lower body is not fully in frame, with the visual focus placed on the bust-to-half-body area.

The setting is a cramped, lived-in Chinese indoor environment, suggestive of the back of a small shop, a utility corridor, a dressing corner, or a storage room. The background is relatively dark with a touch of domestic clutter. Blurry Chinese signage, wall posters, dark doorframes, and indoor furnishings are visible behind her; the space is confined and intensely realistic. The background does not need to be particularly tidy; retaining a bit of lived-in authenticity better matches the mood of the original photo.

The lighting is a front direct flash effect, similar to an on-camera flash or phone camera flash illuminating the subject's face and palm directly, creating prominent highlights on the skin and eyes while quickly falling off into a darker background, producing the typical texture of a Chinese-style private shoot, indoor snapshot, and close-up candid. The overall exposure focuses on the subject's face and upper body, with a darker background and slight hard shadows, yet the subject's skin tone remains clean and translucent.

The visual style leans toward realistic photography, Chinese-style private portrait, lived-in candid snapshot, home casual photo, close-up intimate perspective—not a studio blockbuster, nor heavy cinematic soft focus, but rather a real moment captured candidly by a friend from up close. Emphasize authentic lens character, slight flash contrast, intimate composition, and highly reproduced subject presence.

Framing and Photography Parameter Suggestions:

portrait photography, ultra realistic, photorealistic, close-up portrait, high angle shot, slightly overhead angle, intimate framing, candid snapshot, Chinese-style indoor private portrait, direct flash photography, realistic skin texture, 35mm lens, slight wide-angle perspective, shallow depth of field, upper body crop, vertical composition, 4k, highly detailed
...
air bangs
silver floral hair clip
delicate pendant earrings
white lace camisole inner layer
light pink with blue flowers Chinese-style sheer outer layer
off-the-shoulder
puffed cheeks
blowing on palm
palm facing up
...
Chinese-style private portrait
indoor direct flash snapshot
authentic lived-in realism
cramped indoor background
blurred Chinese signage
```
...
### Photorealistic portrait of a young woman on an American street during golden hour.

Author：[@AiWithliza](https://x.com/AiWithliza) · [Source](https://x.com/AiWithliza/status/2100759330815431128)

Photography · Portrait / Selfie · Character · Cityscape / Street · Published

**Summary:** Photorealistic portrait of a young woman on an American street during golden hour.
...
```text
A photorealistic portrait of Liza, a beautiful young woman with long wavy dark brown hair, standing on an elegant American street at golden hour. She faces the camera with a bright natural smile, one hand lightly touching her hair and the other resting near her hip. She wears a white long-sleeve blouse and high-waisted blue jeans. Warm sunrise light, long soft shadows, cafe awnings and classic buildings in the background, cinematic lighting, sharp details, natural skin, realistic photography.
```
...
### Photographic prompt of a Japanese woman gently turning around in oatmeal beige lingerie inside a private sauna at sunset.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2100768295884624177)

Photography · Character · Landscape / Nature · Published

**Summary:** Photographic prompt of a Japanese woman gently turning around in oatmeal beige lingerie inside a private sauna at sunset.
...
```text
🌟 Windowside Sauna at Sunset | A Gentle Look Back in Oatmeal Beige 🌟

[Subject & Art Style]
A photorealistic work featuring an unambiguously adult Japanese woman relaxing in a private sauna during the evening. Capturing the moment she, after gazing at the scenery outside, notices the presence of her lover and gently turns her face back toward them.
Possessing the premium quality of a photobook page while retaining an intimate, lived-in atmosphere. A cinematic photographic expression that conveys tranquility, warmth, and natural femininity rather than overt, glossy sensuality.

[Location, Background & Worldview]
A private sauna with a window, enveloped in a calm ambiance with wooden walls and tiered benches. The subject sits on the lower bench near the window, with a sauna mat nearby, a sauna stove in the background, and discreet indirect lighting visible beneath the bench.
Outside the small window, garden trees dyed by the sunset can be seen, creating depth through contrast with the interior. The background should not look like an overly manicured luxury hotel, but rather a space that conveys the warmth of wood and quiet, cozy comfort.

[Season, Time & Weather]
The season is a mild evening reminiscent of early autumn. Outside is clear, with the low-angled sunset casting soft golden light into the room.
The interior is enveloped in the typical dry heat of a sauna, and the contrast with the cool air outside adds depth to the atmosphere. Value the expression of a calm hour that evokes the quiet end of a day.

[Character Setting]
An unambiguously adult Japanese woman around 20 to 28 years old. Soft, well-proportioned facial features, slightly large dark eyes, natural eyebrows, and healthy-colored lips, combining approachability with sophistication. Dark brown, shoulder-length naturally wavy hair loosely gathered, with damp stray strands remaining around her face.
Light ochre-toned skin with a natural, not overly uniform texture. A body type that harmonizes delicate shoulders and limbs, a slender waist, and feminine curves into an elegant, naturally glamorous physique. Her chest possesses an unambiguously ample volume, yet settles softly and naturally along her outfit and posture, maintaining balance with her entire body.

[Outfit & Accessories]
Attire consists of an oatmeal beige brassiere and panties. An elegant design combining ivory floral embroidered lace and subtle sheen satin paneling, with opaque lining in a matching hue on key areas.
Avoid overly sheer transparency or excessive ornamentation, keeping a realistic fit that follows the body. Fits comfortably around the bust and waist without gapping or digging into the skin. Basically no accessories, limited to very small stud earrings if necessary.

[Pose, Movement & Gaze]
The woman sits on a sauna mat on the lower tier, extending both legs forward together, with the tips of her feet naturally resting on the floor. Her body gently faces toward the window, but with only her upper torso softly twisted, depicted mid-movement as she turns her face back toward her lover from having looked at the scenery.
Both hands lightly touch the seat beside her body—one placed slightly behind to support herself, the other resting naturally beside her thigh on the bench. Her gaze is not directed straight at the camera, but slightly above it toward her lover, naturally suggesting a "What's up?" response.

[Expression & Emotion]
The expression emphasizes a soft reaction at the moment of noticing being called. Eyes gently relaxed, natural eyebrows, and a small, mild smile on her lips.
Not an exaggerated laugh, but turning her neck slightly back while looking at her partner, exuding a sense of security and warmth shown only to someone close. An unpretentious yet memorable expression carrying quiet intimacy.

[Composition & Camera]
A 4:5 vertical composition tailored for X posts. Comfortably framing her seated full body down to the tips of her feet, shot from a distance that naturally includes the window, the outdoor view, the stove, and part of the bench. Placing the subject near the center while showing the window on one side to give breathing room to the composition.
Camera height is at a natural level near the chest to eye level of the seated subject. A calm focal length leaning toward standard to medium telephoto, without unnaturally exaggerating the body. Lightly clean up the background while leaving enough visual information to clearly indicate the sauna space.

[Light, Color, Texture & Atmosphere]
The key light source is the slanted evening light pouring through the window, casting soft highlights on the subject's cheek, shoulder, collarbone, and stray hairs. Add warm ambient light from beneath the bench and around the stove as interior fill light; shadows are not too deep, naturally lifted by the bounce light from the wood.
The color palette is centered around gold, honey brown, and oatmeal beige, unifying the whole image with warmth. Cheeks are lightly flushed from the sauna's heat, fine beads of sweat glisten on her forehead, nape, collarbone, and shoulders, giving the skin a moist, three-dimensional look. Meticulously depict the slightly damp clumping of hair strands, the delicate relief of the lace, and the dry grain texture of the wooden walls and benches.

[Quality & Excluded Elements]
High resolution, emphasizing natural human anatomy, perspective, lighting, and material textures as if shot on a real camera. Avoid depictions that appear underage, childish facial features, unnatural body proportions, extreme wasp waists, or presentations that unnaturally emphasize only the chest.
Avoid extra limbs or fingers, missing fingers, fused fingers, unnatural joints, swapped left/right hands, broken outfits, body fusing with clothing, unintended nudity, extreme wide-angle distortion, and excessive skin-smoothing filters. Maintain ample bust volume without rendering it as rigid spheres or excessive push-up. Do not include text, logos, watermarks, or UI elements.
```
...
### A photorealistic prompt capturing an intimate everyday moment in a dusk-lit washroom, where a woman in lingerie fresh from the bath accepts a towel from her lover.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2100766220928897049)

Photography · Character · Published

**Summary:** A photorealistic prompt capturing an intimate everyday moment in a dusk-lit washroom, where a woman in lingerie fresh from the bath accepts a towel from her lover.
...
```text
🌟 Dusk in the Washroom | An Offered Towel and a Gentle "Thank You" 🌟

[Subject & Style]
A tender, everyday moment captured in a home washroom in the evening: after taking a bath, a woman reaches out to accept a towel offered by her lover. A photorealistic photograph featuring a clearly adult Japanese woman as the protagonist, harmonizing the refinement of fashion photography with the intimacy of a candid snapshot from real daily life.
Rather than relying on flashy staging or pose-focused shots, the gaze, subtle hand movements, residual steam lingering from the bathroom, and the angle of the sunset naturally convey "time spent together as a couple." It creates a calm, lived-in atmosphere with cleanliness and gentle allure.

[Location, Background & Worldview]
A bright, well-kept home washroom featuring a pale beige terrazzo counter, an integrated washbasin, and a tall, vertically frosted glass window. In the background, the open door leads to the bathroom, where a very faint haze of steam still lingers. A patch of gentle condensation dims a portion of the mirror, subtly conveying the fresh post-bath ambiance.
A few small soap dispensers, skincare bottles, and neatly folded towels are placed modestly on the counter. Accessories are kept minimal to establish a natural sense of daily life without cluttering the background. A clean, quiet space harmonized by distinct textures: terrazzo, frosted glass, white porcelain, and soft fabric.

[Season, Time & Weather]
Early autumn or late summer. The time is late afternoon just before sunset, with warm sunlight streaming in from outside at a low angle. A calm, clear dusk where the intense outdoor daytime heat has mellowed, leaving a cozy humidity and slightly warm air inside after the bath.
The warm amber rays of the sunset entering through the window blend with the washroom's soft white lighting, creating a color temperature distinctive of the boundary between day and night.

[Character Setting]
A distinctly adult 25-year-old Japanese woman. Soft and well-balanced facial features, with naturally rounded cheeks, gentle dark eyes, a slender and natural nasal bridge, and well-tinted, soft lips. Her dark brown hair, falling just past her shoulders, is half-dry from the bath, with just the tips gathered into fine damp strands.
Delicate shoulders and limbs, a slender waist, and feminine curves come together in a naturally balanced, elegantly glamorous silhouette. Her bust has a distinctly ample, rich, natural volume, not rendered as stiff spheres or excessively pushed up, but with a soft three-dimensional shape conforming to posture and gravity. Hips are not exaggerated, displaying a natural curve well-proportioned to her entire frame.

[Outfit & Accessories]
A matching bra and panty lingerie set in champagne beige. An elegant design reminiscent of premium Japanese lingerie brands like Wacoal, crafted from low-sheen, smooth satin overlaid with cream-colored floral embroidery and delicate sheer lace. The edges feature fine scalloped lace, lending an understated glamour without being overly showy.
A realistic fit with sufficient fabric width and tailored ease accommodating her generous bust and hips. The fabric is neither overly stretched nor digging into the skin, exhibiting natural tension and soft creases. No jewelry or accessories, keeping the natural, unguarded atmosphere typical of someone fresh out of the bath.

[Pose, Action & Gaze]
The woman stands having stepped out from the bathroom into the washroom, pausing mid-stride. Her body faces almost directly forward, shifting her weight slightly to her right leg while her left foot naturally rests half a step forward. Without an exaggerated twist at the hips, her stance is relaxed, naturally aligning shoulders and pelvis.
A clean white towel is offered from the foreground by her lover, and she reaches her right hand forward to take its edge. Her left hand rests gently on the terrazzo counter for light support. Her gaze, having looked at the towel, is in the middle of shifting toward her lover's face; she does not look at the camera. The lover's presence is modestly indicated only by a hand and forearm at the edge of the frame.

[Expression & Emotion]
Noticing the towel offered by her lover, her eyes soften slightly into a squint and her lips gently part into a relaxed, trusting, warm expression. A delicate smile that captures the very instant before whispering a soft "Thank you," not a wide-open grin.
The relaxation following a bath and the sense of security felt with a close companion show in her eyes and cheeks. A faint, post-bath flushed glow lingers on her cheeks and ears; the emphasis is on a natural, unguarded expression reserved exclusively for a partner, rather than a posed smile or forced sensuality.

[Composition & Camera]
4:5 vertical portrait composition suited for an X post. Framed from the crown of her head to just above her knees. The woman is positioned slightly to the right of the center, with the offered towel and forearm in the left foreground creating depth from the lover's first-person perspective. The terrazzo vanity, vertical frosted window, and bathroom entrance remain recognizable in the background.
The camera is positioned at roughly chest-to-shoulder height, about 1.5 to 2 meters away from the subject. An angle of view resembling a 50mm to 70mm standard to medium-telephoto lens avoids exaggerating bodily perspective. The background is softly blurred, but retains enough depth of field to keep the architecture of the washroom and bathroom clear and readable.

[Lighting, Color, Texture & Atmosphere]
The primary light source is the low-angled sunset streaming through the frosted window on the right side of the frame. It casts a warm golden rim light along her cheek, shoulder, and hair contours, balanced on the opposite side by the soft fill of the washroom's white interior light and subtle reflections off the walls. Shadows are soft, providing gentle contrast that naturally reveals facial contours and bodily curves.
Tiny residual moisture droplets from the bath cling to her collarbones, shoulders, and arms, catching the evening sun with a soft, delicate glimmer. Skin shows fine pores, subtle micro-shadows, and healthy natural skin tones. Half-dry hair displays individual strand definition and loose stray hairs, while distinct textures are given to satin, lace, terrazzo, glass, and towel fabric. A quiet, intimate warm-toned photograph centered around champagne beige, cream, and sunset amber.

[Quality & Exclusions]
High-resolution photorealistic rendering. Prioritizes natural human anatomy, realistic lighting, material textures, and spatial depth as if captured with an actual camera. Rendered unmistakably as an adult woman; avoids features looking underage or having an adolescent build.
Avoid extra limbs or fingers, missing fingers, fused fingers, unnatural joints, confusion between left and right hands, blending of body and fabric, wardrobe glitches, and unintended exposure. While maintaining ample, natural bust volume, avoid unnatural enlargement, rigid spherical shapes, extreme cleavage push-ups, or shapes defying gravity. Avoid extreme wide-angle distortion, excessive skin smoothing/beautification filters, unnatural steam effects, background warping, and omit any text, logos, watermarks, or UI overlays.
```
...
### Detailed photorealistic image generation prompt depicting a natural nighttime scene of a Japanese woman pausing at the powder room doorway after a bath to exchange glances with her lover.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2100767072779436342)

Photography · Character · Published

**Summary:** Detailed photorealistic image generation prompt depicting a natural nighttime scene of a Japanese woman pausing at the powder room doorway after a bath to exchange glances with her lover.
...
```text
🌟Night Powder Room | Suddenly Pausing at the Doorway After a Bath🌟

[Subject & Art Style]
A night scene capturing the exact moment an adult Japanese woman, having just stepped out of the home bathroom, notices her lover and pauses at the doorway of the powder room. Photorealistic, emphasizing naturalness akin to a candid shot captured spontaneously in a photo book rather than an overly staged commercial advertisement.
The soft post-bath air, slightly damp hair, a cradled towel, and a brief exchange of glances at the doorway evoke a small nighttime story of living together with an intimate partner. Balancing an elegant, poised adult feminine aura with an unguarded intimacy shown only to her lover.

[Location, Background & Worldview]
A warmly lit home powder room, with the white light of the bathroom remaining in the background. Beyond the open bathroom door, shower fixtures and white walls are modestly visible, with a faint, thin wisp of steam lingering near the entrance after a bath. Only the bottom corner of the vanity mirror is faintly fogged, keeping the overall space from becoming hazy.
Minimalist skincare products rest on the vanity, a clean and soft bath mat lies on the floor, and a natural-material basket is placed beneath the storage shelves. A lived-in yet tidy and organized space, configured with a vertical background composition where the doorway, mirror, and bathroom naturally connect with depth.

[Season, Time & Weather]
A calm night that does not overly specify a season. The outdoor weather is not directly shown; instead, the warm indoor color temperature and the humidity lingering from the bathroom convey that this is the hour when one has just finished showering or bathing at the end of the day.
Warmth and humidity still linger within the bathroom, casting a faint, natural post-bath flush on the woman's cheeks and ears. Not the heavy sweating of midsummer, but a natural sense of the subtle temperature shift right after stepping from a warm bathroom into a cooler room.

[Character Settings]
A clearly adult 22-year-old Japanese woman. She has soft, well-proportioned facial features with slightly large, dark, doe-like eyes, natural eyebrows, elegantly rounded lips, and gently plump cheeks. Her dark brown hair is around shoulder length, retaining dampness and natural strand clumping at the tips from the bath.
A healthy, naturally glamorous figure where delicate shoulders and limbs, a slender waist, and feminine curves are in harmony. Her bust possesses a distinct, full, and rich volume, yet avoids looking like rigid spheres or being excessively pushed up, carrying a soft roundness and realistic weight that naturally settle with her posture and attire. Her hips also feature a natural roundness balanced with her overall frame.

[Outfit & Accessories]
A camisole based in peach ivory paired with matching short loungewear shorts. The camisole is made of a soft, opaque fabric, accented with delicate lace and small pale pink floral embroidery along the neckline and hem. A refined, clean design reminiscent of tasteful Wacoal pieces, without being overly flashy.
Constructed with realistic width and tailoring tailored to a full bust, the fabric drapes naturally without unnatural stretching or digging in. The shorts also have a comfortable ease around the hips, the hem swaying ever so slightly with her mid-stride motion. No accessories are worn, prioritizing the everyday authenticity of being freshly out of the bath.

[Pose, Movement & Gaze]
The woman has paused at the doorway while attempting to exit the powder room. Her weight remains slightly on her rear leg, while her other foot takes half a step forward into the room, capturing a natural mid-stride posture. Her back is not arched, and her shoulders are relaxed and free of tension.
With one arm, she cradles a folded, soft bath towel against her hip, while her other hand gently touches the doorway frame. Her torso is not facing straight toward the camera, but naturally angled from the bathroom toward the interior room where her lover is. She turns only her face toward the camera's direction, aligning her gaze with the intimate partner before her.

[Expression & Emotion]
The moment she realizes her lover's presence, thinking, "Oh, you're still awake?" Her eyes widen just slightly to retain that initial, subtle surprise, and her brows rise naturally. Captured immediately after is the expression as her eyes soften with relief and her lips begin to curve into a modest, gentle smile.
Not a full-blown beaming smile or a model's posed look, but an emphasis on relaxed, unguarded intimacy reserved solely for her lover. A soft post-bath blush remains on her cheeks and ears, conveying through her expression and gaze that "fleeting nighttime moment when eyes accidentally meet."

[Composition & Camera]
A 4:5 vertical composition tailored for X (Twitter) posting. Captures her entire body comfortably from the crown of her head down to her bare feet, leaving subtle breathing room both above her head and below her feet. The subject is shifted slightly off-center to one side, allowing the vertical lines of the doorway, the mirror, and the background bathroom to establish natural depth.
The camera is positioned not at chest or waist height, but at a height close to a natural eye level, creating the sense of distance of a lover standing in the room looking at her. Employs a natural focal length ranging from standard to moderate telephoto, avoiding wide-angle distortion that exaggerates the legs or bust. The background has only a gentle blur, preserving enough depth of field to discern the bathroom and vanity space.

[Light, Color, Texture & Atmosphere]
The primary light source is the warm, incandescent-toned glow of the powder room, softly striking her face at an angle from the front. A somewhat cooler, whiter lighting remains on the bathroom side, creating a modest rim light along the contours of her shoulders and hair. The warm and white lights blend naturally at the boundary, generating a sense of three-dimensional depth typical of an interior at night.
The skin exhibits fine shading and a natural healthy complexion, with microscopic post-bath moisture softly glistening across her neck and shoulders. Her hair features damp, clumped ends and wispy loose strands; the camisole displays soft fabric creases and intricate lace detailing; the towel possesses a plush, tactile fiber texture. The overall palette centers on peach, ivory, and soft beige, unified into a quiet, warm nighttime atmosphere.

[Quality & Negative Elements]
High-resolution photorealistic photograph. Prioritizes human anatomy, lighting, textures, and perspective as if shot with a real camera, ensuring natural consistency across the face, fingers, feet, clothing, and mirror reflections.
Avoid: underage-looking appearance, overly juvenile face, unnatural human anatomy, extra limbs or fingers, missing or fused fingers, unnatural joints or twisting, mixed-up left and right hands, wardrobe malfunctions or clothing fused with the body, unintended exposure, extreme wide-angle distortion, and excessive skin-smoothing filters. The bust must maintain a rich, natural volume without unnatural gigantism, rigid spherical shapes, abnormal push-up effects, or gravity-defying forms. No text, logos, watermarks, or UI elements in the image.
```
...
### Prompt for a realistic everyday smartphone photo of a 30-year-old woman sitting on a seaside seawall gazing at the sea.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100761474545385529)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100203547329806607)

**Summary:** Prompt for a realistic everyday smartphone photo of a 30-year-old woman sitting on a seaside seawall gazing at the sea.
...
```text
Character Identity: Fictional 30-year-old Japanese adult female. Cheerful bakery cafe manager with a sophisticated, playful influencer-like presence. Small, soft, softly rounded oval face, gently plump cheeks, rounded chin. Large, expressive dark brown double-lidded eyes, intermediate between almond and round, with eye corners slightly drooping downward. Neatly groomed gentle arched eyebrows, a natural straight nose with a slightly rounded tip, soft, plump lips with naturally upturned mouth corners. Fair warm-neutral Japanese skin retaining realistic pores, light natural redness, faint freckles across the nose bridge, and subtle asymmetry. A single tiny beauty mark located beneath the outer corner of her anatomical left eye. Signature smile is a bright, playful smile showing teeth, creating dimples on both cheeks. Hair is shoulder-length smooth straight layered bob. The part is slightly off-center, with only the ends curling inward naturally. Surface layer, roots, crown, part, bangs, and upper hair framing the face are a uniform glossy black to deep charcoal. A cool smoky gray to graphite silver inner color exists only beneath that dark surface layer, visible only where tucked behind the ears and at the under-layer tips. No center split, no half-and-half color split, no center band, no gray roots or crown, no face-framing highlights, no gradient, no full-head gray. Modern influencer makeup with distinct eyelashes, subtle taupe eyeliner, and rose-beige lips, without smoothing the skin like plastic. Thin round black metal or gunmetal eyeglasses are an optional signature accessory. Maintain the fictional adult facial features, face shape, freckles, beauty mark lateral placement, dimples, black surface hair, inner color placement, hair length, and adult age feel described here, without resembling any identifiable real person. Physical Consistency: Height approximately 166 cm. Long legs, confident posture. Healthy, lightly toned adult hourglass figure. Breasts are naturally full with realistic root width proportionate to the ribcage, forward projection, soft weight, and gravity. Waist is tapered but realistic; hips and buttocks are moderately plump with slightly larger roundness, connecting naturally from the pelvis to the thighs. Maintain height, ribcage, waist, pelvis, hip volume, and limb proportions regardless of changes in perspective. Use standard opaque clothing and natural fabric tension. Do not use push-up breast enhancement, deep cleavage, padding, extreme cinching, implant-like spherical shapes, impossibly tiny waists, exaggerated hips, or BBL-style contours. Shooting Situation: 15:00. Resting while sitting by the seaside. Accustomed to idle time, quietly gazing at the sea. Location and Background: Landward side of a wide, low seawall overlooking the sea. Safe paved ground underfoot. An opened fig package, a soda bottle, and a small plain kraft paper bag containing a mug. Outfit: Thin, opaque charcoal form-fitting sleeveless top, black ankle-length light long skirt, black flat sandals. Thin black-rimmed round glasses, thin silver hoop earrings, small black shoulder bag. Pose and Action: Sitting on a low seawall with both feet placed on the landward ground. A fig in her right hand, left hand resting on the seat surface. Gaze directed toward the sea. Facial expression and face direction: Face turned 80 degrees toward the sea, profile gazing at the distant horizon. Neck is vertical, chin is level, shoulders gently dropped. Lips gently closed, corners of the mouth horizontal in a calm, neutral expression. Not smiling, not looking at the camera. Composition and Angle of View: Taken by a friend diagonally in front using a standard smartphone 1x lens, distance 2.3m, height 1.15m. Capturing from head to sandals, including the sea and the bag. Output a single unpartitioned image with a final size of 1086x1448px and a 3:4 aspect ratio. Lighting and Atmosphere: Natural afternoon seaside light. Photographic Texture: Depict a single HEIC photograph with minimal processing, taken with a standard smartphone's default camera app. Do not confuse the shape of the person, body, and hair with surface finish. Follow the camera-designated single AF plane; do not re-light, denoise, or sharpen only the distant face. Details continuously soften according to distance. Within the range where the face can be discerned, maintain multiple broad tonal differences simultaneously—such as warm tones on one cheek, uneven sheen in the T-zone, differing under-eye tones between left and right, and slight redness on the nose—without drawing in pores on the distant face. For nearby, resolvable skin, retain non-repeating low-contrast color variations, redness from pressure, wrinkle shadows, and sparse pore differences. Render makeup as actual pigment with slightly irregular contours, and retain natural color variations in lips and teeth. Preserve uneven exposure and white balance, unlifted shadows, a few stray hairs, compositional bias, shadow noise, subtle sharpening near the AF plane, and HEIC compression. Make it appear as an almost raw, unedited shot from a personal camera roll. Mandatory Requirements: Output only one unpartitioned smartphone photograph of an adult woman matching all scene specifications. Satisfy both the scene pass criteria and natural smartphone photo quality standards. One fictional adult woman aged 30. The friend and photographer are off-screen. Pass criteria: 1) Maintain the woman's adult face, round glasses, black shoulder-length bob, and gray under-layer. 2) Outfit, scene, main action, and accessories match, with natural fingers and contact. 3) Specified angle of view and full-frame composition are established. 4) An everyday smartphone photo with distance-dependent resolution differences, natural skin tonal variations, and texture differences. 5) Face turned 80 degrees toward the sea, profile gazing at the distant horizon. Neck is vertical, chin level, shoulders gently relaxed. Lips gently closed, corners of the mouth horizontal in a calm neutral expression. Not smiling, not looking at the camera. Maintain designated accessories. Gray inner color only around the ears and lower layer of the black shoulder-length straight bob. Upper layer hair is black. Maintain round glasses. Opaque fabric. Subject has precisely two arms and two hands. Natural contact between hands and objects, and natural body support. Strictly adhere to the facial expression and gaze for this scene. The character's signature smile and dimples are features present when smiling, not a constant toothy grin. Single AF plane on the face. Single standalone vertical 3:4 photo. Leave margin without cropping specified head or limbs at the edges. Only one image. Maintain the specified aspect ratio and full framing condition. Natural shadows and exposure differences. Only one AF depth tier. No exposure compensation, relighting, smoothing, or restoration applied only to the face. Distant face retains broad tonal differences, nearby skin retains irregular variations, and smartphone-specific processing artifacts remain localized. Depict strictly one clearly adult fictional woman as the sole subject of an undivided single photograph. Exactly one head, one face, exactly two anatomically connected arms, and naturally shaped hands. Another person's hand may only be added in the foreground if explicitly specified in the scene or prop description, and that hand must be clearly separated from the subject's body. Do not generate text, panels, duplicate figures, or alternate angles. Negative Prompt: different scene, different person., real brand logos, readable signs., full-head gray, long hair, see-through clothing., extra arms, fused fingers, impossible joints. posed photo face, generic pose with head tilted toward shoulder, toothy smile contrary to scene specification., collage, split screen, compositions focusing only on body parts., relighting only the face, studio lighting., beauty skin filter, glowing porcelain-like face, waxy uniform face or limbs, skin whitening, high-key beauty fill light, face relighting, face sharpening, perfect makeup contours, uniformly glossy lips, uniformly bright teeth, edge-to-edge sharpness, overall clarity adjustments, repeating textures, fake grain added throughout, excessive HDR, over-refined fashion rendering, catalog-style symmetry, advertising campaign finish, CGI, illustration, minor, teenager, child, childlike age appearance, school uniform, real person, likeness to celebrities, duplicated subjects, extra subjects, extra heads, extra faces, extra arms on subject, missing arms on subject, fused limbs, detached limbs, malformed hands, extra fingers, fused fingers, distorted face, crossed eyes, text, subtitles, letters, numbers, logos, watermarks, signatures, frames, grids, contact sheets, collage, split screen, inset images, multiple panels
```
...
### Photorealistic photo prompt of an adult Japanese woman smiling in a hotel bed in the morning, wearing ivory floral-embroidered lingerie.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2100765199888531906)

Photography · Character · Published

**Summary:** Photorealistic photo prompt of an adult Japanese woman smiling in a hotel bed in the morning, wearing ivory floral-embroidered lingerie.
...
```text
🌟 White Hotel Bed | Ivory Smile Unfolding in Morning Light 🌟

[Subject / Style]
A photorealistic photo of a distinctly adult 24-year-old Japanese woman spending a peaceful moment shortly after waking up in a hotel bed in the morning. Capturing a sense of distance as if waking up together as a couple, the moment conveys intimacy naturally through subtle expressions and posture rather than overt staging.
Conceived as a balance between a sophisticated lingerie advertisement and a lived-in portrait, this is not a commercial product photo that merely displays clothing, but a complete scene that encompasses the morning air, facial expression, white bedding, and soft window light. Clean, bright, elegant, and natural photographic expression as if shot in a real hotel.

[Location / Background / Worldview]
The shooting location is a calm, high-end hotel bedroom predominantly decorated in white. Behind the woman are plump, layered white pillows and a white duvet with slight, natural wrinkles. On one side of the frame is a large window, letting morning light stream in through sheer lace curtains.
The background softly blurs typical hotel elements such as a simple headboard, a small bedside table, and an understated lamp. Without cluttering props, the space is neatly organized around the white bedding and window light, creating a quiet environment where the person's face and attire naturally take center stage.

[Season / Time / Weather]
The season is a mild period reminiscent of spring to early summer. The time is early morning around 7:00 AM, with the outdoors beginning to brighten. A clear morning, but without harsh direct sunlight, allowing soft light diffused by lace curtains to spread through the room.
The room retains the slightly cool, crisp air characteristic of the morning, and the light falling across the bedding ranges from white to pale cream. The color temperature remains gentle, maintaining freshness without appearing cold.

[Character Setting]
A distinctly adult 24-year-old Japanese woman. Soft and well-proportioned facial features with slightly large, dark-toned eyes, natural eyebrows, a slender nose bridge, and soft, naturally flushed lips. Dark brown hair reaching slightly past the shoulders, showing slight, natural morning bedhead and soft waves, with delicate wisps of hair framing the face.
Fair ochre-toned skin with realistic textures, retaining pores and subtle shading. Delicate shoulders and arms, paired with a slender waist and feminine curves that harmonize into a naturally glamorous figure. A distinctly full and voluptuous bust, portrayed with soft, natural dimension conforming to gravity and her reclining posture against the bedding, without stiffness or unnatural push-up effects.

[Attire / Accessories]
An elegant ivory bra and panty set reminiscent of Wacoal styles. The composition mainly shows the bra portion, keeping the panties outside the frame. The cup surfaces are scattered with delicate floral embroidery in soft apricot and beige tones, finished with fine scalloped lace along the upper edge.
The cups feature an opaque lining that prevents skin from showing through, avoiding overly sheer fabric. A realistic size and structure capable of naturally supporting a full bust, offering a natural fit without overstretching the fabric or cutting unnaturally into the skin. No accessories are worn, prioritizing morning simplicity and cleanliness.

[Pose / Action / Gaze]
The woman gently props up her upper body, using the white pillows to support her back up to the shoulder blades. Her body is almost facing the camera, but with relaxed shoulders, tilted slightly to one side to create a natural, just-woken-up posture. She rests her weight stably against the pillows without arching her lower back or spine excessively.
Her hair on one side is swept behind the shoulder, while both arms rest naturally toward the bottom of the frame or on the bedding, avoiding an overly posed look. Her gaze is directed not at the camera lens itself, but toward the partner right beside the lens, capturing the exact moment right after hearing a morning greeting.

[Expression / Emotion]
The moment her partner says "Good morning," her slightly sleepy eyes narrow softly into a gentle, small smile. Not just her eyes but her cheeks soften slightly, revealing a natural expression of trust and relaxed comfort.
Her lips remain lightly closed without opening wide or carrying tension. A faint morning flush warms her cheeks—not an artificial smile, but a genuine smile naturally spilling over upon looking at someone dear. Balancing adult composure and approachable warmth without exaggerated sweetness.

[Composition / Camera]
A 4:5 vertical portrait composition tailored for X (formerly Twitter) posts. A bust-up shot capturing from the chest up to the crown of the head, leaving slight headroom. A close-up framing where facial expressions, eyes, lips, and the ivory floral embroidery are all clearly visible simultaneously.
The camera is positioned roughly at the woman's eye level, slightly off-center to the front, using a natural focal length equivalent to a 50–85mm standard to short telephoto lens. Avoiding extreme wide-angle distortion or perspective exaggeration of the body. The background has a soft bokeh, while keeping recognizable hotel morning elements such as white pillows, the window, and curtains.

[Lighting / Color / Texture / Atmosphere]
The key light is natural morning light streaming from the large window on the left side of the frame. Diffused by lace curtains, the light softly illuminates one side of the face, shoulder, and the lace on the bust, casting very soft shadows on the opposite side. Fill light bouncing off the white bedding softens the shadow side, keeping the entire face bright and natural.
Skin retains realistic textures including pores, subtle shading, and natural flush, avoiding excessive skin-smoothing filters. Hair displays fine strands and a soft morning sheen, lace features the tactile three-dimensionality of delicate threading, and bedding reflects the soft wrinkles of cotton or linen. A palette harmonized around white, ivory, and soft apricot, cultivating a bright, quiet, and intimate morning atmosphere.

[Quality / Negative Prompts]
Prioritizing high resolution with realistic human anatomy, lighting, textures, and perspective as if taken by a real camera. Avoid underage appearance, childish facial features, unnatural anatomy, extra limbs or fingers, missing or fused fingers, unnatural joints, or confused left/right hands.
Avoid wardrobe malfunctions, clothing blending into flesh, unnatural fabric indentation, unintended nudity, extreme wide-angle distortion, or excessive airbrushing. Maintain a naturally full bust volume without unnatural gigantism, rigid spherical shapes, extreme push-up effects, or gravity-defying forms. No text, logos, watermarks, or UI overlays within the image.
```
...
### Realistic smartphone snapshot prompt of a 30-year-old Japanese woman eating a grilled fish set meal at a port diner.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100728759124926796)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100171083655868437)

**Summary:** Realistic smartphone snapshot prompt of a 30-year-old Japanese woman eating a grilled fish set meal at a port diner.
...
```text
Character Identity:
Fictional 30-year-old Japanese adult female. Cheerful bakery-cafe manager with a sophisticated, playful influencer-like presence. Small, soft, roundish oval face, gently plump cheeks, rounded chin. Large, expressive dark brown double-lidded eyes, balanced between almond and round, with corners turning down very slightly. Neatly groomed soft-arched eyebrows, natural straight nose with a slightly rounded tip, soft plump lips with naturally upturned corners. Light warm-neutral Japanese skin with realistic pores, light natural redness, subtle freckles across the nose, and slight asymmetry. A single tiny beauty mark directly below the outer corner of her anatomical left eye. Signature smile is a bright, playful smile showing teeth, creating dimples on both cheeks. Hair is shoulder-length smooth straight layered bob. Slightly off-center part, with only the ends curling naturally inward. The surface layer, roots, crown, parting, bangs, and upper hair framing the face are a uniform glossy black to deep charcoal. A cool smoky gray to graphite silver inner color is strictly located underneath that dark surface layer, visible only where hair is tucked behind the ears and at the lower inner ends. No center split, no half-and-half coloring, no center band, no gray roots or crown, no face-framing highlights, no ombre/gradient, no full-head gray. Modern influencer makeup with distinct eyelashes, subtle taupe eyeliner, rose-beige lips, without smoothing the skin like plastic. Thin round black metal or gunmetal glasses are an optional signature accessory. Maintain the facial features, face shape, freckles, beauty mark placement, dimples, black surface hair, inner color placement, hair length, and adult age perception of the fictional adult described here; do not resemble identifiable real people.

Physical Consistency:
Height approximately 166 cm. Long legs, confident posture. Healthy, lightly toned adult hourglass figure. Bust is naturally full, with realistic base width, forward projection, soft weight, and gravity proportional to the ribcage. Waist is cinched yet realistic; hips and buttocks are moderately plump with a slightly fuller roundness, connecting naturally from pelvis to thighs. Maintain height, ribcage, waist, pelvis, hip volume, and limb proportions across perspective changes. Wear normal opaque clothing with natural fabric tension. No cleavage-lifting push-ups, no exaggerated cleavage, no padding, no extreme corseting, no spherical implant-like shapes, no impossibly tiny waist, no exaggerated hips, no BBL-style contours.

Shooting Situation:
12:10 PM. A port diner. Eating a set meal prepared by someone else, taking a relaxed breather.

Location and Background:
A rustic port diner. A set meal of grilled fish, a bowl of rice, and miso soup.

Outfit:
Thin, opaque charcoal form-fitting sleeveless top, light ankle-length black maxi skirt, black flat sandals. Thin black-rimmed round glasses, thin silver hoops, small black shoulder bag.

Pose and Action:
Sitting on a chair, naturally holding two chopsticks in the right hand, pausing over the dish. Left hand beside the rice bowl. Expression / Face direction: Face nearly straight to the camera, neck not tilted to the sides. Shoulders lowered, relaxed eyes from enjoying the meal. Lips closed, corners of the mouth subtly and slightly lifted. A relieved expression without showing teeth.

Composition and Angle of View:
Taken by a friend sitting opposite using a standard smartphone 1x lens, approximately 1 m away, height 1.15 m. Head, upper body, both hands, and the entire set meal.
Output only a single undivided image with a final size of 1086×1448px, aspect ratio 3:4.

Lighting and Atmosphere:
Side light from the window and modest interior diner lighting.

Photo Texture:
Depict a single minimally processed HEIC photograph taken with a standard smartphone's default camera app. Do not confuse character, body, and hair shape with surface finish. Follow a single camera-specified AF plane; do not relight, denoise, or sharpen only the distant face. Details continuously soften according to distance. Within the recognizable range of the face, maintain multiple broad tonal variations simultaneously, such as warmth on one cheek, uneven sheen on the T-zone, different undertones under each eye, and slight redness on the nose, without drawing pores on a distant face. On close, resolvable skin, retain non-repeating low-contrast color variations, pressure redness, wrinkle shadows, and sparse pore variations. Present makeup as real pigment with slightly uneven edges, keeping natural color differences between lips and teeth. Maintain uneven exposure and white balance, unlifted shadows, a few stray hairs, off-center composition, shadow noise, subtle sharpening near the AF point, and HEIC compression. Make it look like an unedited snapshot from a personal camera roll.

Mandatory Requirements:
Output only a single undivided smartphone photo of an adult female that matches all scene specifications. Fulfill both the scene pass criteria and natural smartphone photo quality standards.

One fictional 30-year-old adult female. Friend and photographer are off-screen.
Pass Criteria:
1) Maintain the woman's adult face, round glasses, black shoulder-length bob, and gray underlayer.
2) Outfit, setting, main action, and accessories must match; finger interactions and object contact must look natural.
3) Specified angle of view and overall framing must be achieved.
4) An everyday smartphone photo with distance-dependent resolution falloff, natural skin tonal variations, and texture differences.
5) Face nearly straight to the camera, neck not tilted to the sides. Shoulders lowered, relaxed eyes from enjoying the meal. Lips closed, corners of the mouth subtly and slightly lifted. A relieved expression without showing teeth.

Maintain specified accessories.

Black shoulder-length straight bob with gray inner color only around the ears and lower layer. Upper layer of hair is black. Maintain round glasses. Opaque fabric.

Subject has exactly two arms and two hands. Hand-to-object contact and body support must be natural. Strictly adhere to the expression and gaze for this scene. Signature smile and dimples are traits when smiling, not a constant toothy smile.

Single AF is on the face. One standalone vertical 3:4 photo. Do not crop the specified range of head or limbs at the frame edges, leaving margins.
Only one image. Maintain the specified aspect ratio and conditions to frame the whole scene.

Natural shadows and exposure differences.

Only one AF plane. Do not apply exposure correction, relighting, smoothing, or restoration solely to the face. Preserve broad tonal differences for a distant face and irregular variations on close skin; keep smartphone-specific processing artifacts localized.

Depict only one clearly adult fictional female as the sole subject of a single undivided photograph. Exactly one head, one face, exactly two anatomically connected arms, and naturally shaped hands. Another person's hand in the foreground can only be added if explicitly specified in the scene or props, and that hand must be clearly separated from the subject's body. No text, panels, duplicate persons, or alternate angles.

Negative Prompt:
Different scene, different person., Real brand logos, legible signs., Full-head gray, long hair, translucent clothing., Extra arms, fused fingers, impossible joints. Posed model expression, stereotypical head-tilted-to-shoulder pose, toothy smile contrary to scene specification., Collage, split screen, compositions focusing only on body parts., Relighting only the face, studio lighting., Beauty filter, glowing porcelain face, waxy uniform face and limbs, skin whitening, high-key beauty fill light, face relighting, face sharpening, flawless makeup contours, uniformly glossy lips, uniformly bright teeth, edge-to-edge sharpness, overall clarity adjustment, repeating textures, artificial grain added globally, excessive HDR, over-polished fashion editorial rendering, catalog-style symmetry, advertising campaign finish, CGI, illustration, underage, teen, child, childish age appearance, school uniform, real person, likeness to celebrities, duplicated subjects, extra subjects, extra heads, extra faces, extra arms on the subject, missing arms on the subject, fused limbs, detached limbs, deformed hands, extra fingers, fused fingers, distorted face, crossed eyes, text, subtitles, characters, numbers, logos, watermarks, signatures, borders, grids, contact sheets, collages, split-screen, inset images, multiple panels
```
...
### A smartphone-style photo prompt depicting a 30-year-old Japanese woman with black hair, gray inner color, and glasses, thoughtfully evaluating a mug in a pottery shop.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100745116696871166)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100187441218924826)

**Summary:** A smartphone-style photo prompt depicting a 30-year-old Japanese woman with black hair, gray inner color, and glasses, thoughtfully evaluating a mug in a pottery shop.
...
```text
Character Identity:
A fictional 30-year-old adult Japanese woman. A cheerful bakery café manager with a sophisticated, playful influencer-like presence. A petite, softly rounded oval face, gently plump cheeks, and a rounded chin. Large, expressive dark brown double-lidded eyes, intermediate between almond-shaped and round, with very slightly drooping outer corners. Neatly groomed, gentle arched eyebrows, a naturally straight nose with a slightly rounded tip, and soft, plump lips with naturally upturned corners. Fair, warm-neutral Japanese skin retaining realistic pores, light natural redness, subtle freckles across the bridge of the nose, and slight facial asymmetry. Exactly one tiny mole beneath the outer corner of her anatomical left eye. Her signature smile is a bright, playful, tooth-revealing grin that forms dimples on both cheeks. Hair is a shoulder-length, smooth straight layered bob. The part is slightly off-center, with only the ends curving inward naturally. The outer surface, roots, crown, part, bangs, and upper hair framing the face are a uniform, glossy black to dark charcoal. A cool smoky gray to graphite silver inner color exists only beneath that dark surface layer, visible solely where tucked behind the ears and at the lower inner ends. Do not make it center-split, half-and-half color-blocked, a center band, gray roots or crown, face-framing highlights, a gradient, or an entirely gray head. Modern influencer makeup features defined eyelashes, understated taupe eyeliner, and rose-beige lips, without smoothing the skin like plastic. Thin, round black metal or gunmetal eyeglasses are an optional signature accessory. Maintain the fictional adult facial features, face shape, freckles, correct placement of the mole, dimples, black outer hair layer, inner color placement, hair length, and adult age aesthetic described here, avoiding resemblance to any identifiable real person.

Body Consistency:
Height approximately 166 cm. Long legs with a confident posture. A healthy, lightly toned adult hourglass figure. Breasts are naturally full, with realistic base width proportional to the ribcage, forward volume, soft weight, and natural gravity. The waist is tapered yet realistic; hips and buttocks are moderately full with a slightly prominent curvature, transitioning naturally from the pelvis to the thighs. Maintain consistent height, ribcage, waist, pelvis, hip volume, and limb proportions regardless of the viewing angle. Wear normal, opaque clothing with natural fabric tension. Do not use push-up cleavage enhancements, extreme cinching, implant-like spheres, impossibly thin waists, exaggerated hips, or BBL-style contours.

Shooting Situation:
13:30. In a ceramics shop, picking out a mug for herself. Earnestly checking its color and texture.

Location and Background:
A small pottery shop on an alleyway. Ceramics displayed on wooden shelves. A slightly asymmetrical charcoal ceramic mug, white interior, round handle.

Outfit:
A thin, opaque, form-fitting charcoal sleeveless top, a black ankle-length lightweight maxi skirt, and black flat sandals. Thin, black-rimmed round glasses, thin silver hoops, and a small black shoulder bag.

Pose and Action:
Standing, supporting the bottom of the mug with her left hand, and resting the fingers of her right hand along the handle. Eyes focused on the mug. Expression and Face Direction: Face turned 70 degrees to the right of the frame, nearly in profile. No lateral tilt of the neck; chin slightly pulled in, casting her gaze down toward the mug. Eyebrows and mouth relaxed, lips closed in an earnest expression of appraisal. Not smiling.

Composition and Angle:
A standard smartphone 1x lens shot by a friend, distance 1.4 m, height 1.2 m. Framing from head to knees, capturing both hands and the mug.
Output a single undivided image with a final resolution of 1086×1448 px and a 3:4 aspect ratio.

Lighting and Atmosphere:
Natural light from the storefront mixed with warm, dim interior store lighting.

Photographic Texture:
A single, minimally processed HEIC photograph captured with a standard smartphone camera app. Do not conflate the character's body and hair shape with surface rendering. Follow the camera's single AF plane without selectively relighting, denoising, or sharpening distant facial features. Fine details fall off smoothly with distance. To the extent the face remains recognizable, preserve multiple broad tonal variances simultaneously—such as warm tones on one cheek, uneven sheen across the T-zone, color differences beneath each eye, and slight redness on the nose—without drawing distinct pores on a distant face. Skin that is close enough to resolve should show non-repeating, low-contrast tonal shifts, pressure marks, subtle crease shadows, and sparse pore variations. Makeup must appear as actual pigment with slightly uneven edges; lips and teeth must maintain normal, uncorrected color differences. Retain uneven exposure and white balance, unlifted shadows, subtle flyaway hairs, off-center framing, shadow noise, conservative sharpening near the AF focal plane, and typical HEIC compression. Present it as an unedited snapshot straight from a personal camera roll.

Mandatory Requirements:
Output a single, undivided smartphone photograph of an adult woman matching all scene specifications. Fulfill both the scene acceptance criteria and natural smartphone photography quality standards.

One fictional 30-year-old adult woman. Friend and photographer are off-camera.
Acceptance Criteria:
1) Maintain the woman's adult face, round glasses, black shoulder-length bob, and lower-layer gray.
2) Outfit, scene, main action, and accessories match, with natural fingers and object interaction.
3) Specified framing and full frame layout correctly realized.
4) An everyday smartphone photo with distance-dependent resolution rolloff, natural skin tonal differences, and realistic material textures.
5) Face turned 70 degrees to the right of the frame, nearly in profile. No lateral tilt of the neck, chin slightly pulled in, looking down at the mug. Eyebrows and mouth relaxed, lips closed in an earnest expression of appraisal. Not smiling.

Retain specified accessories.

Black shoulder-length straight bob with gray inner color only around the ears and lower layer. Upper layer of hair is black. Maintain round glasses. Opaque fabric.

Her body has exactly two arms and two hands. Ensure natural contact between hands and objects, and natural body support. Strictly follow the expression and gaze for this scene. Her signature smile and dimples are traits for when she smiles, not a constant toothy grin.

Single AF point on the face. Single standalone vertical 3:4 photograph. Leave margin without cropping the specified head, hands, or limbs at the edges.
Only one image. Maintain specified aspect ratio and full-figure framing requirements.

Natural shadows and exposure differences.

Only a single AF tier. No selective face exposure correction, relighting, skin-smoothing, or restoration. Retain broad tonal variations on distant faces and irregular textures on close skin, keeping smartphone-typical processing artifacts localized.

Depict only one clearly adult fictional woman as the sole subject of an undivided single photograph. One head, one face, exactly two anatomically connected arms, and naturally shaped hands. Another person's hands in the foreground are only permissible if explicitly specified in the scene or props, and must be clearly separated from her body. No text, panels, duplicate individuals, or alternate angles.

Negative Prompt:
Different scene, different person., Real brand logos, legible signs., All-gray hair, long hair, see-through clothing., Extra arms, fused fingers, impossible joints. Posed model expression, head-tilted-to-shoulder cliché pose, tooth-revealing smile contradictory to scene instructions., Collage, split, body-part-only framing., Selective face relighting, studio lighting., Beauty filter, glowing porcelain face, waxy uniform skin or limbs, skin whitening, high-key beauty fill light, face relighting, facial sharpening, perfect makeup contours, uniformly glossy lips, uniformly bright teeth, edge-to-edge sharpness, global clarity enhancement, repeating textures, fake global grain, excessive HDR, overly polished fashion editorial rendering, catalog symmetry, ad campaign finish, CGI, illustration, underage, teenage, child, childish age appearance, school uniform, real person, celebrity resemblance, duplicate subject, extra subjects, extra heads, extra faces, extra arms on subject, missing arms on subject, fused limbs, detached limbs, malformed hands, extra fingers, fused fingers, distorted face, cross-eyed, text, subtitles, letters, numbers, logos, watermarks, signatures, borders, grids, contact sheets, collages, split screens, insets, multiple panels
```
...
### Hazy and aesthetically beautiful portrait photography of an East Asian face half-hidden behind a curtain, wearing a low-cut gauze dress.

Author：[@zhang\_baoqing](https://x.com/zhang_baoqing) · [Source](https://x.com/zhang_baoqing/status/2100769495879209137)

Photography · Portrait / Selfie · Character · Published

**Summary:** Hazy and aesthetically beautiful portrait photography of an East Asian face half-hidden behind a curtain, wearing a low-cut gauze dress.
...
```text
Low-cut off-the-shoulder collar; slipping gauze garment; delicate bosom half-revealed, half-hidden behind a curtain; turned sideways with tender affection; hazy floral shadows; hesitant to speak, holding words back; a breathtaking elegance breaking conventional boundaries
```
...
### Prompt for generating a candid photo of a 30-year-old Japanese woman in loungewear looking at her smartphone in a morning dining room.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100451431413404037)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100122513179103442)

**Summary:** Prompt for generating a candid photo of a 30-year-old Japanese woman in loungewear looking at her smartphone in a morning dining room.
...
```text
Character Identity:
A fictional 30-year-old adult Japanese woman. A cheerful bakery café manager with a sophisticated, playful influencer-like presence. A compact, soft, rounded oval face, gently plump cheeks, and a rounded chin. Large, expressive dark brown double-lidded eyes, balanced between almond and round shapes, with corners of the eyes slanting very slightly downward. Groomed, gentle arched eyebrows, a natural straight nose with a slightly rounded tip, and soft, plump lips with naturally upturned corners. Fair, warm-neutral Japanese skin displaying realistic pores, light natural redness, subtle freckles across the nose, and slight natural asymmetry. Exactly one tiny beauty mark situated below the outer corner of her anatomical left eye. Her signature smile is a bright, playful, tooth-showing grin that forms dimples on both cheeks. Hair is a shoulder-length, smooth straight layered bob. Parted slightly off-center, with only the ends curving naturally inward. The outer layer, roots, crown, part line, bangs, and upper hair framing the face are a uniform, glossy black to dark charcoal. A cool smoky-gray to graphite-silver inner hair dye appears exclusively beneath that dark outer layer, visible only around the ears when tucked and at the lower inner ends. No center split, half-and-half coloring, central stripe, gray roots or crown, face-framing highlights, gradients, or full-head gray. Modern influencer makeup features well-defined eyelashes, discreet taupe eyeliner, and rose-beige lips, without plastic-like skin smoothing. Thin, round black metal or gunmetal glasses are an optional signature accessory. Maintain these specific fictional adult facial features, face shape, freckles, beauty mark placement, dimples, black outer hair layer, inner color placement, hair length, and adult age appearance without resembling any identifiable real person.

Body Consistency:
Height approximately 166 cm. Long legs, confident posture. A healthy, lightly toned adult hourglass figure. Breasts are naturally full with realistic base width proportional to her ribcage, forward volume, soft weight, and natural drape. The waist is indented yet realistic, and hips and buttocks are moderately plump with a slightly fuller roundness, transitioning naturally from pelvis to thighs. Maintain height, ribcage, waist, pelvis, hip volume, and limb proportions even across perspective shifts. Utilize ordinary, opaque clothing and natural fabric tension. Avoid lifting breast enhancements, cleavage emphasis, padding, extreme corseting, implant-like spherical shapes, impossibly thin waists, exaggerated hips, or BBL-style contours.

Scene Situation:
08:10 AM. Having breakfast in loungewear. Quietly reading a message received from a friend.

Location and Background:
A small home dining area. Wooden table, warmed bread, and an old white mug with a thin crack on the handle.

Outfit:
A thin, opaque charcoal cotton camisole and light gray short cotton lounge shorts. Barefoot, thin black-rimmed round glasses. Casual loungewear naturally exposing shoulders, arms, and legs.

Pose and Action:
Sitting normally on a chair, holding a smartphone in her right hand, left hand placed beside the bread plate on the table. Feet on the floor. Expression and head orientation: Neck vertical without tilting left or right. Only the chin slightly tucked in, eyes cast down toward the smartphone in hand. Lips closed, with only one corner of the mouth relaxing very slightly. No teeth showing, with a drowsy morning look in the eyes.

Composition and Framing:
A breakfast scene to send to a friend, taken with a shelf-placed smartphone on a self-timer. Distance 2 m, height 1.15 m, standard 1x lens. Capturing from head to toe along with the dining table.
Output a single undivided image with a final aspect ratio of 3:4 (target 1086×1448 px).

Lighting and Atmosphere:
Morning natural light coming from the left window.

Photographic Texture:
Render a single minimally processed HEIC photo, as if taken with an ordinary smartphone's stock camera app. Do not confuse character, body, and hair shape with surface finishing. Adhere to a single camera-specified autofocus (AF) plane; do not re-light, denoise, or sharpen only the distant face. Details soften continuously relative to distance. Within the discernible range of the face, maintain multiple broad tonal differences simultaneously—such as warm tones on one cheek, uneven sheen on the T-zone, differing under-eye tones between left and right, and slight redness on the nose—without drawing in pores on a distant face. On close, resolvable skin, preserve non-repetitive, low-contrast color variations, redness from pressure, shadow lines in creases, and sparse pore variations. Present makeup as real pigment with slightly uneven edges, preserving ordinary color differences between lips and teeth. Maintain uneven exposure and white balance, unlifted shadows, a few stray hairs, natural compositional offset, shadow noise, discreet sharpening near the AF point, and HEIC compression artifacts. Make it look like an unedited candid shot from a personal camera roll.

Mandatory Requirements:
Output only one undivided smartphone photo of the adult woman that matches all scene specifications. Fulfill both the scene success criteria and natural smartphone photo quality standards.

One fictional 30-year-old adult woman. The friend and the photographer are off-screen.
Success Criteria:
1) Maintain the woman's adult face, round glasses, black shoulder-length bob, and gray underlayer.
2) Outfit, setting, main action, and props must match, with natural fingers and contacts.
3) The specified framing and entire frame composition are correctly established.
4) An everyday smartphone photo possessing distance-dependent resolution differences, natural skin tonal variations, and texture differences.
5) Neck vertical without tilting left or right. Only chin tucked slightly, eyes looking down at the smartphone. Lips closed with one corner relaxing very slightly. No teeth visible, sleepy morning eyes.

Maintain specified props.

Black shoulder-length straight bob with gray inner dye only around ears and underlayer. Upper hair layer remains black. Keep round glasses. Opaque fabric.

Subject has exactly two arms and two hands. Natural contact between hands and objects, and realistic body support. Strictly adhere to the expression and gaze for this scene. Her signature smile and dimples are traits when smiling, not a perpetual tooth-showing grin.

Single AF point on the face. One independent vertical 3:4 photo. Do not crop the head or limbs at the edges of the specified framing; leave margin.
Only one image. Maintain the specified aspect ratio and the condition of framing the entire subject.

Natural shadows and exposure variances.

Only a single AF depth layer. No selective face exposure correction, relighting, smoothing, or restoration. Retain broad tonal differences for a distant face, irregular variations on closer skin, and localized smartphone-specific processing artifacts.

Depict only one clearly adult fictional woman as the sole subject of an undivided single photograph. One head, one face, exactly two anatomically connected arms, and naturally shaped hands. Another person's hand in the foreground can only be added if explicitly specified in the scene or props, clearly separated from her body. Do not generate text, panels, duplicate persons, or alternative angles.

Negative Prompt:
Different scene, different person., Real brand logos, readable signage., Full-head gray, long hair, see-through clothing., Extra arms, fused fingers, impossible joints. Posed camera face, generic pose with head tilted toward shoulder, tooth-showing smile contrary to scene directions., Collage, split screen, composition focused only on body parts., Face-only relighting, studio lighting., Skin beauty filter, glowing porcelain-like face, waxy uniform face or limbs, skin whitening, high-key beauty fill light, face relighting, face sharpening, perfectly sharp makeup edges, uniformly glossy lips, uniformly bright white teeth, global edge-to-edge sharpness, overall clarity enhancement, repeating textures, fake grain added globally, overdone HDR, overly polished high-fashion finish, catalog-like symmetry, ad campaign finishing, CGI, illustration, minor, teenager, child, childlike age appearance, school uniform, real person, likeness to celebrities, duplicated subject, extra subjects, extra heads, extra faces, extra arms on the subject, missing arms on the subject, fused limbs, detached limbs, malformed hands, extra fingers, fused fingers, distorted face, cross-eyed, text, subtitles, letters, numbers, logos, watermarks, signatures, borders, grids, contact sheet, collage, split screen, inset images, multiple panels
```
...
### Realistic everyday smartphone photo prompt of a 30-year-old Japanese woman talking and handing an iced drink from the passenger seat of a parked car.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100459987982020681)

Photography · Character · Food / Drink · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100138619373494740)

**Summary:** Realistic everyday smartphone photo prompt of a 30-year-old Japanese woman talking and handing an iced drink from the passenger seat of a parked car.
...
```text
Character Identity:
A fictional 30-year-old adult Japanese woman. A cheerful bakery café manager with a sophisticated, playful influencer-style presence. A small, soft, roundish oval face, gently plump cheeks, and a rounded chin. Large, expressive dark brown double-lidded eyes, midway between almond and round, with outer corners dipping very slightly. Neatly groomed soft arched eyebrows, a natural straight nose with a slightly rounded tip, and soft, full lips that naturally curve upward at the corners. Light warm-neutral Japanese skin with realistic pores, light natural redness, faint freckles across the bridge of the nose, and subtle asymmetry preserved. Exactly one tiny mole beneath the outer corner of her anatomical left eye. Her signature smile is a toothy, bright, playful grin revealing dimples on both cheeks. Hair is a shoulder-length, smooth straight layered bob. The part is slightly off-center, with only the ends curling naturally inward. The top surface, roots, crown, parting line, bangs, and upper hair framing the face are a uniform, glossy black to dark charcoal. A cool smoky gray to graphite silver inner accent color exists only beneath that dark surface layer, visible solely where tucked behind the ears and at the lower inner ends. No center split, no half-and-half color split, no center band, no gray roots or crown, no highlights around the face, no gradients, and no full-head gray. Modern influencer makeup features well-defined eyelashes, understated taupe eyeliner, and rose-beige lips, without smoothing the skin like plastic. Thin round black metal or gunmetal glasses are an optional signature accessory. Maintain the fictional adult facial features, face shape, freckles, left/right placement of the mole, dimples, black surface hair, inner accent placement, hair length, and adult age appearance specified here, without resembling any identifiable real person.

Body Consistency:
Height approximately 166 cm. Long legs and a confident posture. A healthy, lightly toned adult hourglass figure. Breasts are naturally full with a realistic base width proportionate to the ribcage, forward volume, and soft weight affected by gravity. The waist is tapered yet realistic, and the hips and buttocks are moderately plump with slightly fuller curves, connecting naturally from the pelvis to the thighs. Maintain height, ribcage, waist, pelvis, hip volume, and limb proportions even when the viewing angle changes. Uses ordinary opaque clothing and natural fabric tension. No lifting push-up corrections, deep cleavage, padding, extreme corseting, implant-like spherical shapes, impossibly tiny waists, exaggerated hips, or BBL-style contours.

Setting/Scene:
09:30. In the passenger seat of a parked car. In the middle of talking to a friend while handing them a drink.

Location and Background:
A car parked near home. Front passenger seat, car seat, drink holder.

Outfit:
A thin, opaque charcoal form-fitting sleeveless top, a light black ankle-length long skirt, and black flat sandals. Thin black-rimmed round glasses, thin silver hoops, and a small black shoulder bag.

Pose and Action:
Sitting in the passenger seat, extending a lidded drink toward the center console with her right hand, while her left hand rests on a small tote bag in her lap. Feet on the floor mat. Expression and head orientation: Zero lateral head tilt. Face turned 35 degrees toward the friend in the driver's seat. Eyebrows slightly raised, lips parted slightly mid-sentence. An inquiring, lively expression without forcing a smile.

Composition and Framing:
Taken with a friend's smartphone from the driver's seat of the parked car. Approximately 0.9 m away, height 1.2 m, standard 1x lens. Frame completely from head to knees, fully including both hands and the cup.
Output a single, unsplit image with a final size of 1086×1448 px and a 3:4 aspect ratio.

Lighting and Atmosphere:
Soft daylight through the car window.

Photographic Texture:
Render a minimally processed single HEIC photo as if taken with the default camera app on an ordinary smartphone. Do not confuse character, body, and hair geometry with surface finish. Follow a single camera-specified AF plane; do not re-light, denoise, or sharpen only a distant face. Details soften continuously with distance. Within the recognizable range of the face, maintain multiple broad tonal variations simultaneously—such as warm tones on one cheek, uneven shine in the T-zone, differing under-eye tones between left and right, and slight redness on the nose—without drawing visible pores on a distant face. On close, resolvable skin, preserve non-repeating low-contrast color variations, redness from pressure, wrinkle shadows, and sparse differences in pores. Makeup should look like actual pigments with slightly uneven edges; lips and teeth should retain normal color distinctions. Maintain uneven exposure and white balance, unlifted shadows, a few stray hairs, off-center framing, shadow noise, subtle sharpening near the AF point, and HEIC compression artifacts. Make it look like an unedited snapshot straight from a personal camera roll.

Mandatory Requirements:
Output exactly one unsplit smartphone photo of an adult female meeting all scene specifications. Fulfill both the scene pass criteria and the quality criteria for a natural smartphone photo.

One fictional 30-year-old adult female. The friend and the photographer are out of frame.
Pass Criteria:
1) Maintain the adult female face, round glasses, black shoulder-length bob with gray underneath.
2) Outfit, scene, main action, and accessories match, with natural fingers and contact.
3) The specified framing angle and complete composition are achieved.
4) An everyday smartphone photo with distance-dependent resolution falloff, natural skin tone shifts, and material differences.
5) Zero lateral head tilt. Face turned 35 degrees toward the friend in the driver's seat. Eyebrows slightly raised, lips parted slightly mid-sentence. An inquiring, lively expression without forcing a smile.

Maintain specified accessories.

Black shoulder-length straight bob with gray inner color only around the ears and lower layer. Upper layer of hair is black. Maintain round glasses. Opaque fabric.

Subject has exactly two arms and two hands. Hand-to-object contact and body support must appear natural. Strictly adhere to the expression and eye gaze for this scene. The character's signature smile and dimples are traits only when smiling, not a constant toothy grin.

Single AF point on the face. One standalone vertical 3:4 photo. Do not crop the head or limbs at the edges of the specified framing range; leave breathing room.
Only one image. Preserve the specified aspect ratio and full-frame composition requirements.

Natural shadows and exposure differences.

Only one AF plane. Do not perform face-only exposure compensation, relighting, skin smoothing, or restoration. Distant faces should retain broad tonal differences, nearby skin should retain irregular variations, and smartphone-specific processing artifacts should remain localized.

Depict only one clearly adult fictional woman as the sole subject in an unsplit single photograph. Exactly one head, one face, exactly two anatomically connected arms, and natural hand anatomy. Another person's hand in the foreground may only be added if explicitly specified in the scene or props, and that hand must remain clearly separate from her body. No text, panels, duplicate people, or alternate angles.

Negative Prompt:
different scene, different character., real brand logos, readable signage., all-gray hair, long hair, see-through clothing., extra arms, fused fingers, impossible joints. posed glamour face, head-tilted-toward-shoulder pose, tooth-baring smile not matching the scene description., collage, split-screen, composition focusing only on body parts., face-only relighting, studio lighting., beauty filter, glowing porcelain skin, waxy uniform face or limbs, skin whitening, high-key beauty fill light, face relighting, face sharpening, perfectly sharp makeup contours, uniformly glossy lips, uniformly bright white teeth, global edge-to-edge sharpness, overall clarity enhancement, repeating textures, artificial grain added across entire image, excessive HDR, over-polished high-fashion styling, catalog-style symmetry, ad campaign finish, CGI, illustration, minor, teenager, child, childlike age appearance, school uniform, real person, likeness to celebrities, duplicated subject, extra subject, extra head, extra face, extra arms on subject, missing arms on subject, fused limbs, detached limbs, malformed hands, extra fingers, fused fingers, distorted face, crossed eyes, text, subtitles, letters, numbers, logos, watermarks, signatures, borders, grids, contact sheets, collage, split screens, picture-in-picture, multiple panels
```
...
### Smartphone photo-style prompt of a 30-year-old woman holding figs at a seaside fruit market stall.

Author：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100469299504660490)

Photography · Character · Published

Source：[@HObE4TLMga99335](https://x.com/HObE4TLMga99335) · [Source](https://x.com/HObE4TLMga99335/status/2100154978287665192)

**Summary:** Smartphone photo-style prompt of a 30-year-old woman holding figs at a seaside fruit market stall.
...
```text
Character Identity:
A fictional 30-year-old Japanese adult female. A cheerful bakery café manager with a sophisticated, playful influencer-like presence. A small, softly rounded oval face, gently plump cheeks, and a rounded chin. Large, expressive dark brown eyes with double eyelids, intermediate between almond-shaped and round, with eye corners slanting very slightly downward. Groomed, gentle arched eyebrows, a natural straight nose with a slightly rounded tip, and soft, plump lips with naturally upturned corners. Fair, warm-neutral Japanese skin retaining realistic pores, light natural redness, faint freckles across the bridge of the nose, and slight natural asymmetry. A single, tiny mole beneath the corner of her anatomical left eye. Her signature smile is a bright, playful grin revealing teeth, creating dimples on both cheeks. Hair is a smooth, shoulder-length straight layered bob. The parting is slightly off-center, with only the ends curving naturally inward. The outer surface layer, roots, crown, parting, bangs, and upper hair framing the face are a uniform, glossy black to dark charcoal. A cool smoky gray to graphite silver inner color exists strictly beneath that dark outer layer, visible only around the tucked-behind-ears sections and the underside ends. No center split, no half-and-half color division, no central band, no gray roots or crown, no highlights framing the face, no gradients, and no full-head gray. Modern influencer makeup with distinct eyelashes, subtle taupe eyeliner, and rose-beige lips, without smoothing the skin like plastic. Thin, round black metal or gunmetal glasses are an optional signature accessory. Maintain the fictional adult facial features described here—face shape, freckles, correct placement of the mole, dimples, black outer hair, inner color placement, hair length, and adult age impression—without resembling any identifiable real person.

Body Consistency:
Height approximately 166 cm. Long legs and a confident posture. A healthy, lightly toned adult hourglass figure. Bust is naturally full, possessing a realistic base width proportionate to the ribcage, forward projection, soft weight, and natural gravity. Waist is defined yet realistic, while hips and buttocks are moderately plump with a slightly larger, rounded contour, connecting naturally from the pelvis to the thighs. Maintain consistent height, ribcage, waist, pelvis, hip volume, and limb proportions across changing perspectives. Dressed in standard opaque clothing with natural fabric tension. No bust-lifting adjustments, exaggerated cleavage, padding, extreme corseting, implant-like spherical shapes, impossibly thin waists, exaggerated hips, or BBL-style contours.

Shooting Situation:
10:50 AM. At a seaside market, holding a pack of figs while contemplating flavor combinations.

Location and Background:
The fruit stall of a small seaside market. A small pack of figs.

Attire:
A thin, opaque charcoal form-fitting sleeveless top, a light black ankle-length long skirt, and black flat sandals. Thin black-rimmed round glasses, thin silver hoops, and a small black shoulder bag.

Pose and Action:
Standing, holding the small pack of figs in front of her waist with both hands, face turned toward her friend. Expression and face direction: neck straight, chin pulled slightly in. Eyes looking down at the figs in her hands. Lips closed, mouth corners neutral, brow very slightly furrowed in a thoughtful expression. No eye contact with the camera, no smile.

Composition and Framing:
Shot from a friend's standard smartphone at 1x zoom, distance 1.7 m, height 1.25 m. Framing from head to below the knees, capturing the fruit stall. Output a single, undivided image with a final size of 1086×1448 px and a 3:4 aspect ratio.

Lighting and Atmosphere:
Daylight filtering through the storefront awning.

Photographic Texture:
A single, minimally processed HEIC photo taken with a standard smartphone camera app. Do not confuse character, body, and hair geometry with surface finishes. Adhere to a single camera-designated AF plane; do not selectively relight, denoise, or sharpen a distant face. Details soften continuously with distance. Within the recognizable range of the face, maintain multiple broad tonal variations simultaneously—such as warmth on one cheek, uneven sheen in the T-zone, differing under-eye tones between left and right, and slight redness on the nose—without drawing pores on a distant face. On close, resolvable skin, preserve non-repeating low-contrast color variations, pressure-induced redness, crease shadows, and sparse pore differences. Render makeup as actual pigment with slightly irregular edges, keeping natural color differences between lips and teeth. Retain uneven exposure and white balance, unlifted shadows, a few flyaway hairs, compositional bias, shadow noise, subtle sharpening near the AF point, and HEIC compression artifacts. Present it as a near-raw snapshot from a personal camera roll.

Mandatory Conditions:
Output only one undivided smartphone photo of an adult woman matching all scene specifications. Satisfy both the scene pass criteria and natural smartphone photo quality standards.

One fictional 30-year-old adult female. Friend and photographer are off-screen.
Pass Criteria:
1) Maintain the woman's adult face, round glasses, black shoulder-length bob, and gray underlayer.
2) Attire, scene, primary action, and accessories must match; hand-object interactions must look natural.
3) The specified angle of view and overall frame must hold together.
4) A casual smartphone photo exhibiting distance-dependent resolution differences, natural skin tone shifts, and material texture variations.
5) Neck straight, chin pulled slightly in. Eyes directed at the figs in her hands. Lips closed, corners of mouth neutral, slight brow furrow in thought. No looking at the camera, no smile.

Maintain specified accessories.

Black shoulder-length straight bob with gray inner color only around the ears and lower layer. Upper hair layer is black. Maintain round glasses. Opaque fabric.

Subject has exactly two arms and two hands. Hand contact with objects and bodily support must look natural. Strictly adhere to the expression and gaze designated for this scene. Her signature smile and dimples are traits only when smiling, not a perpetual tooth-showing grin.

Single AF point on the face. One standalone portrait-oriented 3:4 photo. Leave margins without cropping specified areas of the head or limbs at the edges. Only one image. Preserve the specified aspect ratio and full framing requirements.

Natural shadows and exposure gradients.

Only a single AF depth tier. No exposure adjustment, relighting, smoothing, or detail restoration applied exclusively to the face. Distant faces retain broad tonal differences; near skin retains irregular variations; smartphone-specific processing artifacts remain localized.

Depict exactly one clearly adult fictional woman as the sole subject of a single, undivided photo. One head, one face, exactly two anatomically connected arms, and naturally shaped hands. Another person's hands may appear in the foreground only if explicitly noted in the scene or prop instructions, and such hands must remain distinctly separate from her own body. No text, panels, duplicate figures, or alternate angles.

Negative Prompt:
different scene, different character., real brand logos, readable signage., all-over gray hair, long hair, translucent clothing., extra arms, fused fingers, impossible joints. posed glamour face, stereotypical head tilt to shoulder, toothy smile contrary to scene instructions., collage, split-screen, compositions focusing solely on body parts., relighting applied only to the face, studio lighting., beauty filters, glowing porcelain face, waxy uniform face or limbs, skin whitening, high-key beauty fill light, face relighting, face sharpening, flawless makeup contours, uniformly glossy lips, uniformly bright teeth, edge-to-edge sharpness, global clarity adjustment, repeating textures, fake grain added across the entire image, excessive HDR, over-polished fashion styling, catalog-like symmetry, ad campaign post-processing, CGI, illustration, underage, teenager, child, childlike appearance, school uniform, real person, celebrity resemblance, duplicate subject, extra subjects, extra heads, extra faces, extra arms on the subject, missing arms on the subject, fused limbs, detached limbs, deformed hands, extra fingers, fused fingers, distorted face, cross-eyed, text, subtitles, letters, numbers, logos, watermarks, signatures, borders, grids, contact sheets, collage, split screen, inset images, multi-panel
```
...
### Candid portrait prompt of two young East Asian women in bright rose-pink bra tops on a park bench at night.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2100451555443105969)

Photography · Portrait / Selfie · Published

**Summary:** Candid portrait prompt of two young East Asian women in bright rose-pink bra tops on a park bench at night.
...
```text
Hyper-realistic night park candid photography of two people, vertical roughly 3:4 aspect ratio, two clearly adult East Asian women in their 20s+, sitting side by side on a park bench / low seating. The photographer is positioned very close directly in front of them, using an equivalent 24–28mm smartphone wide-angle lens, camera angle slightly below chest level, with their upper bodies dominating the frame, capturing a distinct close-up night mobile phone selfie / candid snapshot texture. Both have naturally voluptuous hourglass figures, moderate-to-narrow shoulders, distinctly full busts, slim waists, and naturally rounded hips. No stick-thin bodies, narrow hips, skinny legs, or athletic muscular physiques. The person on the left has jet-black, extra-long straight hair naturally draped over her right shoulder and chest, her body leaning slightly toward the person on the right. Her left arm is bent high behind her head with her palm resting against the back of her head or hair, while her right hand rests naturally near her waist and hip. Her head is turned to the right, looking at the person beside her with lips slightly parted as if speaking. She wears a silver rhinestone / metallic short choker necklace around her neck. The person on the right has jet-black, extra-long straight hair parted in the middle, cascading down both sides to around her waist; her upper body leans slightly back and tilts toward the person on the left, with her head slightly lowered and turned toward the camera, showing a calm, subtly languid expression. Both are wearing bright rose-pink / magenta lingerie-style tops with high saturation and cool-pink undertones. The left wears an underwire deep-V push-up bra-style top with a delicate matte or subtle lace texture; the right also wears a bright rose-pink bra-style top with rounder cups and a delicate small center connecting detail. The lower half reveals only a small edge of matching low-rise undergarments, paired with baggy gray sweatpants / lounge pants hanging loosely around the hips and waist, the waistband visibly lowered to create a natural, effortless look as if casually draping an outer layer or just shedding clothes, while maintaining proper, complete coverage. The person on the left wears a light gray loose hooded sweatshirt / cardigan slipping off the shoulders, hanging only from her arms and sides; the person on the right has mostly bare shoulders and arms, with gray fabric naturally bunched at her waist. The scene is a city park at night: background features a large dark-green tree canopy, lawn, bench, pathway, and distant buildings. At the top left, a very bright warm-white streetlamp strongly illuminates nearby leaves, causing localized overexposure; further away, a few small park lamps are sparsely scattered. Trees and grass are mostly submerged in deep shadows, creating a quiet, low-light overall ambiance. Lighting is primarily park streetlamp plus smartphone night mode / subtle auto-exposure boost, without harsh direct flash. The subjects' faces, chests, shoulders, and skin are bathed in dim, mixed warm-and-cool ambient light, with the left figure slightly brighter and the right figure falling more into shadow. The image allows slight motion blur, shadow noise, and high-ISO grain; figure edges should not be overly sharp. The overall aesthetic presents a genuine iPhone night shot / 2000s–2010s digital camera night candid feel: low light, visible shadow grain, uneven exposure, slightly blurred leaves and background, naturally warm skin tones, and bright pink clothing serving as the primary color focal point. Key focus: two adult East Asian women + night park + close-up two-person composition + extra-long straight black hair + naturally voluptuous hourglass figures + bright rose-pink bra-style tops + loose gray garments slipping off shoulders, arms, and hips + left person with one hand behind head + leaning close together + trees and lawn + strong streetlamp + low-light phone night shot + subtle noise and blur. Avoid: daytime, indoor bedroom, studio, harsh flash, refined commercial lighting, short hair, high ponytail, fully covering sportswear, black lingerie, red formal dress, exaggerated bodybuilder physique, extreme giant hips, heavy background blur, excessive HDR, plastic skin, anime face, CG look, watermarks, and garbled text.
```
...
### A collection of failed amateur photos featuring blur, obstructions, etc., in a 3×3 grid format

Author：[@MrGafish](https://x.com/MrGafish) · [Source](https://x.com/MrGafish/status/2100478810454135172)

Photography · Published

**Summary:** A collection of failed amateur photos featuring blur, obstructions, etc., in a 3×3 grid format
...
```text
Various failed photos taken by amateurs, arranged in a 3×3 grid, 9:16 vertical composition
```
...
### A studio portrait of a woman with red hair, green eyes, freckles, and ornate dark green gold-embroidered clothing.

Author：[@RobotCleopatra](https://x.com/RobotCleopatra) · [Source](https://x.com/RobotCleopatra/status/2100432556449497265)

Photography · Portrait / Selfie · Character · Fashion Item · Published

**Summary:** A studio portrait of a woman with red hair, green eyes, freckles, and ornate dark green gold-embroidered clothing.
...
```text
a close up studio portrait of a woman with vibrant red hair, green eyes, and prominent freckles. her wet, messy hair is swept across her face, with strands falling over one eye. she wears warm, gold eye makeup, contoured blush, and glossy lips. she is dressed in an ornate high collared jacket of dark green metallic brocade adorned with heavy gold embroidery and golden charms. large, dangling gold earrings with intricate cage designs hang from her ear. the background is a soft, dark olive green gradient, and the lighting is dramatic, casting deep shadows and highlighting the texture of her skin.
```
...
### An artistic portrait photography prompt of a woman showing cleavage, emphasizing natural morning light and vivid positive film tones.

Author：[@55hawks](https://x.com/55hawks) · [Source](https://x.com/55hawks/status/2100414246110761243)

Photography · Portrait / Selfie · Published

Source：[@bobbizyo](https://x.com/bobbizyo) · [Source](https://x.com/bobbizyo/status/2100170309135376623)

**Summary:** An artistic portrait photography prompt of a woman showing cleavage, emphasizing natural morning light and vivid positive film tones.
...
```text
A photographic work strongly emphasizing artistry. Natural morning light streaming in from the side. Vivid positive film image quality. Cleavage
```
...
### Fashion photoshoot with a white supercar inside an industrial loft garage, female legs in black stockings and high heels dangling out the car window.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2100413781428109466)

Photography · Portrait / Selfie · Character · Fashion Item · Vehicle · Published

**Summary:** Fashion photoshoot with a white supercar inside an industrial loft garage, female legs in black stockings and high heels dangling out the car window.
...
```text
Photorealistic industrial garage fashion photography, vertical aspect ratio approximately 3:4, an explicitly adult female, 20+, reclining inside the driver's seat of a white two-door sports car, most of her body obscured by the car door and window, her legs extending out from the fully open side window and dangling naturally, serving as the most striking visual subject of the composition. The photographer is positioned about 2–3 meters to the rear left of the vehicle, using a 28–35mm equivalent lens, camera angle slightly below window height, completely capturing the rear half of the sports car's body, the subject's legs, and a large expanse of the industrial architectural environment.

The vehicle is a white, low-profile two-door mid-/rear-engine sports car; sleek rounded roofline, black wheels, low-profile tires, dark tinted windows, side air intakes, and red taillights are clearly visible. The composition is dominated by a rear three-quarter view of the vehicle, with the front pointing toward the left of the frame, the rear near the bottom right, and the white paint having soft cool-white reflections in the dim setting.

The subject's pose is the focal point: the upper body is inside the cockpit, face barely visible, hips resting against the lower edge of the window frame, both legs extending out of the window, one knee noticeably bent resting near the window sill, the other leg hanging downward, the two calves staggered relative to each other. The pose carries a casual, rebellious fashion snapshot vibe; do not change to standing beside the car or sitting on the hood.

The legs are slender, naturally shapely, with thighs retaining realistic, soft volume. Wearing black semi-sheer thigh-high stockings, with the welt situated on the upper-middle thigh, wide black band clearly visible, stocking denier around 20–30D, subtly revealing skin tone beneath. On her feet are black pointed-toe stiletto high heels, with high and slender heels, toes naturally pointing toward the ground, one shoe slightly angled outward due to the leg posture.

The upper-body attire of the figure inside the car only needs to reveal a small glimpse of the edge of a black form-fitting cropped top / black bodysuit; do not force a complete outfit to be visible, prioritize maintaining the composition of 'body concealed inside the car, only highlighting the legs'.

The scene is an ultra-high-ceiling industrial loft garage / custom car showroom. The background wall consists of dark gray exposed brick and concrete structures, with high ceilings, upper clerestory windows, and large black-framed glass doors introducing strong natural light from the left side. Industrial elements such as black metal window frames, exposed beams and columns, gray concrete floor, and wall-mounted radiators are clearly visible.

Outside the large floor-to-ceiling glass door at the rear left is intense, blown-out white daylight and a blurred courtyard, creating a striking chiaroscuro contrast indoors. The subject's legs, the white sports car, and the floor are illuminated laterally by natural light from outside the door, while the depths of the garage recede into deep shadows.

At the far right edge of the frame, a cropped partial arm or body edge of another adult female may appear, as if someone is standing nearby watching or photographing, but only as a minor peripheral element that does not distract from the main subject.

The overall aesthetic presents a 2000s–2010s moody automotive fashion photoshoot / digital camera snapshot texture: high contrast, deep shadows, slightly luminous white car paint, subtle grain, limited dynamic range, background largely distinct, without cinematic color grading.

Key focus: white two-door sports car + industrial loft garage + driver-side window open + adult female body hidden inside car + two legs dangling out the window + black semi-sheer thigh-high stockings + black pointed-toe stiletto high heels + black wheels + dark gray brick wall + massive glass door + strong lateral backlight + moody automotive fashion snapshot.

Avoid: figure standing by the car, sitting on the car roof, sitting on the hood, full body visible outside the car, bare legs, white socks, fishnets, sneakers, chunky heels, ordinary family sedan, outdoor parking lot, brightly lit studio, nightclub neon, excessive HDR, anime face, CG look, extra limbs, watermarks, and garbled text.
```
...
### Ultra-realistic indoor direct flash portrait: Voluptuous hourglass-figure East Asian woman sitting on a bed in a butterfly bikini.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2100432664654467482)

Photography · Portrait / Selfie · Character · Architecture / Interior · Published

**Summary:** Ultra-realistic indoor direct flash portrait: Voluptuous hourglass-figure East Asian woman sitting on a bed in a butterfly bikini.
...
```text
Ultra-realistic indoor bed portrait photography, vertical orientation approximately 4:5, an explicitly adult East Asian woman, 20+, sitting on a white bed with a dark gray-black upholstered headboard behind her. The photographer is positioned directly in front of the subject at a slightly low angle, shot closely with an approximately 28–35mm equivalent lens, fully framing the subject from head down to mid-thigh, with legs prominently spread out in the foreground occupying the lower half of the frame, creating a subtle wide-angle perspective distortion (foreshortening).

The subject has a very prominent voluptuous hourglass figure: moderately narrow shoulders, very full and natural breasts, a noticeably tapered narrow waist, wide and rounded hips, and thick upper thighs with realistic soft tissue volume. The overall focus is a voluptuous upper body + narrow waist + wide hips + thick thighs; avoid skinny waif figures, narrow hips and slim legs, athletic/bodybuilder muscles, or exaggerated unnatural implants.

The subject sits in the center of the bed, upper body leaning slightly back, both hands braced on the bed surface / pillows on either side of her body with elbows slightly bent. Legs are bent at the knees and spread wide apart to the left and right; the left thigh is closer to the camera, occupying a significant portion of the lower left frame; the right thigh spreads toward the lower right of the frame. Pelvis faces directly toward the camera, in a relaxed and natural pose; no kneeling or standing postures.

The subject has jet-black medium-long hair + thick wispy straight bangs, hair loosely tied / pinned up at the back of the head, with a few wispy strands hanging down along both cheeks and neck, slightly messy overall. Wearing large silver hoop earrings. Small, slightly oval face shape, fair and warm-toned skin, eye makeup featuring dark brown slender eyeliner and dense eyelashes, light pink blush, and nude pink-coral lips. Her head is tilted slightly toward her left, eyes looking directly into the camera lens with a cool, calm, slightly languid expression, lips naturally slightly parted.

The subject wears a blue-and-black butterfly wing print bikini. The top is a thin black halter triangle bikini top, with only ultra-thin black straps around the neck and shoulders; the cup pattern mimics butterfly wings: the main body features large sections of pale sky blue / ice blue wings, with outer edges in deep navy and black contours, accented with small white spots and fine line textures; connected horizontally under the bust with a thin black string. The cut fits the body snugly, providing full, normal coverage.

The bottom is matching low-rise triangle bikini bottoms with ultra-thin side ties, sitting very low on the hips, with thin black tie strings on the sides, the front panel also featuring light blue + dark navy-black butterfly wing patterns, small in size yet maintaining complete coverage. Overall, do not change to a one-piece swimsuit, plain solid-color bikini, or lace lingerie.

The setting is a minimalist modern bedroom. Behind the subject is a tall dark gray-black upholstered headboard, with a matte fabric or leather surface divided into large rectangular quilted panels. Piled in the right background are pure white pillows and a white duvet, with matching white bedsheets; a small section of gray wall is visible on the far left edge. No other furniture is needed in the environment, keeping it clean and simple.

Lighting utilizes frontal direct camera flash + dim indoor ambient light. The flash directly illuminates the subject's face, chest and shoulders, abdomen, and thighs, giving the skin a bright warm-white / creamy tone; the background headboard is noticeably darker, with bright specular highlights reflecting off the white bedding. There are natural, soft shadows on the subject's legs and abdomen; avoid cinematic rim/side lighting.

The overall aesthetic has a 2000s–2010s indoor digital camera / CCD boudoir snapshot feel: subtle hard flash, limited dynamic range, dark background, pronounced skin highlights, minor grain, slight JPEG compression artifacts; avoid excessive HDR, commercial studio photography, or plastic airbrushed skin.

Key focal points: adult East Asian woman + front-facing sitting pose on bed + legs spread wide with bent knees + hands braced backward on bed + very voluptuous hourglass figure + ultra-full bust + narrow waist + wide hips + thick thighs + black wispy bangs + loose updo + large silver hoop earrings + blue-black butterfly wing print halter bikini + low-rise thin-tie bikini bottoms + dark gray upholstered headboard + white bedding + frontal direct flash + close-range digital camera snapshot.

Avoid: slender stick-thin figure, narrow hips and skinny legs, athletic/muscular build, long straight hair let down, high ponytail, plain solid-color swimwear, one-piece swimsuit, lace lingerie, stockings, shoes, standing posture, kneeling posture, legs together, luxury hotel background, heavy background bokeh, cinematic soft light, anime face, CG look, extra limbs, watermarks, and garbled text.
```
...
### photorealistic candid nightlife photography, luxury private business KTV room, adult East Asian woman in her 20s as main subject with microphone.

Author：[@boniusex](https://x.com/boniusex) · [Source](https://x.com/boniusex/status/2100136938921685221)

Photography · Portrait / Selfie · Character · Published

Source：[@boniusex](https://x.com/boniusex) · [Source](https://x.com/boniusex/status/2099767415332872435)

**Summary:** photorealistic candid nightlife photography, luxury private business KTV room, adult East Asian woman in her 20s as main subject with microphone.
...
```text
photorealistic candid nightlife photography, luxury private business KTV room, black and gold interior, leather sofas, whiskey bottles, glasses, fruit platters, snacks, microphones, karaoke screen, warm golden ambient light mixed with blue and purple neon, adult East Asian woman in her 20s as the main subject, fashionable nightlife dress, natural refined makeup, realistic skin texture, adult male customers aged around 30-45 wearing business casual clothes, normal to slightly heavy builds, male guests are supporting characters, playing a guess-the-song game while holding a microphone and eagerly answering, spontaneous nightlife documentary photography, candid moment, realistic expressions, direct flash, slight motion blur, imperfect framing, iPhone and early digital-camera snapshot aesthetic
```
...
### Dark gothic fashion portrait of an East Asian woman in a corset bodysuit and patent leather knee-high boots sitting on a leather sofa, shot with direct frontal flash.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2099352628073476468)

Photography · Portrait / Selfie · Character · Fashion Item · Published

**Summary:** Dark gothic fashion portrait of an East Asian woman in a corset bodysuit and patent leather knee-high boots sitting on a leather sofa, shot with direct frontal flash.
...
```text
Ultra-realistic indoor dark fashion portrait photography, vertical orientation approximately 3:4, an explicitly adult East Asian woman in her 20s+, sitting at the junction of the armrest and seat cushion of a black leather sofa, her body facing slightly toward the left side of the frame, upper body held upright, legs positioned in a very pronounced high crossed-leg pose. The photographer is located directly in front of the subject about 1.5–2 meters away, using a 50–70mm equivalent lens, with the camera height close to the subject's waist and abdomen, capturing the subject completely from the top of the head to the calves and boots, with the main subject almost filling the frame.\n\nThe subject has a small-to-medium bone structure, a natural hourglass figure, relatively narrow shoulders, naturally full breasts, a distinctly slender waist, rounded hips, thighs with soft realistic volume, and slender calves. The overall curves are pronounced yet kept realistic; no bodybuilder muscles, extreme wide hips, exaggerated giant buttocks, or paper-thin proportions.\n\nThe pose is the focal point of the image: the subject sits on the right side of the black sofa, one leg naturally extending downward as a supporting leg, while the other leg is raised high and crossed over in front, with the knee close to chest and abdomen height, the thigh almost horizontally spanning the center of the frame, creating a strong foreground depth; the knee and thigh of the crossed leg are closest to the lens, thus showing a slight natural perspective enlargement. The upper body remains stable, without leaning back noticeably.\n\nThe subject has jet-black ultra-long straight hair + thick straight-cut blunt bangs, with the bangs neatly covering the forehead and close to the eyebrows, hair strands on the left and right hugging the cheeks, and the long hair on the right falling naturally below the chest. The hair texture is sleek, glossy black, overall conveying a cold, glamorous gothic feel.\n\nThe face shape is petite and oval-leaning, with a soft jawline, and a very fair, cool-toned porcelain complexion. Eyes are pale grey-blue / icy blue, with slender eyeliner, thick but not overly exaggerated eyelashes, and eye makeup dominated by black-grey and smoky brown tones. Eyes look directly into the camera, with a calm, aloof, slightly imposing expression. The bridge of the nose is slender and straight, and the lips are a low-saturation nude-pink bean-paste shade, with the mouth naturally closed.\n\nWearing a layered short black beaded choker necklace + thin silver chain around the neck, with a small crescent moon or delicate metal pendant in the center. The accessories are entirely black beaded chains, fine silver chains, and a few rhinestones, avoiding large colored gemstones.\n\nThe subject wears a black gothic-style tight-fitting corset bodysuit. The upper part is a patchwork of black structured cups and semi-sheer black mesh, with the neckline along the cups decorated with a profusion of black beads, silver chains, rhinestones, small pendants, and delicate metal charms. The cup edges have distinct black bead chain piping, and multiple draped bead chains and delicate chains hang between the chest and abdomen.\n\nThe waist and abdomen area uses black semi-sheer mesh + vertical boned corset structure, showing multiple black vertical boning lines, hugging the waist tightly overall to accentuate the slender waist. The sides feature a high-cut structure, revealing parts of the hip bones and side waist skin, yet the outfit remains fully covered. The lower half connects seamlessly with the top, designed overall as a black high-cut stage bodysuit / leotard.\n\nLegs are mostly bare, without stockings or tights. On the feet are a very eye-catching pair of glossy black leather knee-high boots, the boot shafts fitting the calves snugly, reaching just below the knees, made of high-shine black leather or patent leather, with slightly pointed or narrow toes, and medium-to-high stiletto or slender heels. The boot of the crossed leg in front occupies the lower-middle part of the frame, forming a strong black vertical visual line.\n\nThe subject sits on a black genuine leather sofa / black leather armchair, the leather surface displaying soft highlights and natural creases, with the cushion and armrest slightly indented under the weight of her body.\n\nThe background is a full wall of deep charcoal-black wooden display cabinets / built-in bookshelves consisting of multiple rectangular compartments. The cabinet frame is deep grey, charcoal black, and dark brown wood grain, sparsely displaying a few transparent wine glasses, small glass tumblers, metal decorations, a black vase, and minimal ornaments; the overall display is very restrained, not cluttered with items. The background remains sharp but noticeably darker than the subject.\n\nLighting uses direct on-camera flash + dark ambient room light. The flash directly illuminates the subject's face, neck, chest, exposed thighs, and the beaded metal decorations on the black outfit, giving the skin a cool white porcelain feel; the black corset, bead chains, and leather boots show distinct specular reflections. The background falls off quickly into darkness, creating a stark separation between the subject and the environment.\n\nOverall style evokes a 2000s–2010s dark fashion / gothic cosplay photoshoot + point-and-shoot digital camera direct-flash aesthetic: clear subject, rich details in the black clothing, slight flash glare on the skin, deep shadows, subtle grain and JPEG compression artifacts, without modern HDR or cinematic lighting setups.\n\nKey focus points: adult East Asian woman + ultra-long straight black hair + thick blunt bangs + icy blue-grey eyes + black beaded choker + black semi-sheer corset bodysuit + cup trim with abundant black beads, rhinestones, silver chains, and draped ornaments + mesh boned waist corset + black glossy knee-high boots + black leather sofa + sitting pose + one leg raised high and crossed horizontally in front + knee near chest and abdomen + charcoal-black display shelf background + direct frontal flash + cool white skin tone + dark gothic fashion photography.\n\nAvoid: long curly hair, short hair, no bangs, colorful clothing, red lingerie, plain dresses, athletic wear, stockings, fishnets, white boots, sneakers, legs normally side by side, standing pose, lying down, exaggerated giant buttocks, bodybuilder muscles, warm yellow skin tone, bright white living room, outdoor background, heavy background blur, cinematic soft lighting, anime face, CG look, plastic skin, extra limbs, watermarks, and gibberish text.
```
...
### Photorealistic portrait prompt of a Japanese woman sitting in a chair by a window with soft autumn light, wearing a bordeaux knit mini dress.

Author：[@muse\_ai\_prompt](https://x.com/muse_ai_prompt) · [Source](https://x.com/muse_ai_prompt/status/2098634064354045974)

Photography · Portrait / Selfie · Character · Fashion Item · Published

**Summary:** Photorealistic portrait prompt of a Japanese woman sitting in a chair by a window with soft autumn light, wearing a bordeaux knit mini dress.
...
```text
🌟 Autumn Colors by the Window | Bordeaux Knit and Soft Afternoon Light 🌟 [Subject & Art Style] A photorealistic fashion portrait depicting an explicitly adult Japanese woman quietly relaxing by the window of her own room on an autumn afternoon. Set in an everyday space, it does not lean solely into domestic mundanity, but adds refinement akin to high-end women's magazines or fashion photo books. The unpretentious interior and the woman's presence blend naturally together, expressed as a mature, intimate moment that makes one pause on an X timeline. The overall photograph maintains the naturalness of being shot in an actual room rather than an overproduced studio feel. The relationships among the person, chair, window, and autumn light are carefully presented, evoking subtle sensuality and warmth within a quiet time. [Location, Background & Worldview] The shoot location is the woman's own room, decorated with a calm interior. An upholstered armchair is placed near a large window, with a small side table arranged beside it. An unadorned mug and a closed book are placed modestly on the table, adding the natural ambiance of an inhabited room. The background shows wooden shelves, pale-colored curtains, and furniture based on beige and brown tones. Outside the window, yellowed street trees and a residential area are softly visible, conveying the seasonal feel of autumn. Small props are kept minimal, creating an uncluttered space where the subject's silhouette is not lost in the background. [Season, Time & Weather] The season is gentle autumn nearing late autumn. The time of day is around 2:00 PM to 4:00 PM, when the sun begins to lower slightly. Bright weather, either sunny or with light clouds drifting, with warm natural light streaming diagonally through the window. The outside air is slightly chilly, but the warmth of sunlit spots remains inside the room. The wind is light, not enough to sway the curtains or hair significantly. The crisp autumn air and the coziness of the soft light gathering by the window are reflected throughout the entire frame. [Character Setting] An explicitly adult Japanese woman aged approximately 20 to 28. Soft, well-proportioned, feminine adult facial features, with slightly large dark-dominant eyes, natural eyebrows, a slender nose bridge, and soft lips with healthy color. Dark brown hair reaching just below the shoulders has loose, natural waves, leaving fine stray strands framing the face. Skin is a light-toned ochre hue, with realistic textures showing pores, subtle shading, and natural complexion. Her figure is an elegant glamorous build where delicate shoulders, arms, and a slender waist naturally harmonize with feminine curves. The bust has an explicitly large, rich, and natural volume, not rendered as hard spheres or with exaggerated push-up, but expressed as soft three-dimensionality following the seated posture, fabric tension, and gravity. The hips also have a natural roundness matching her full-body proportions. [Costume & Accessories] The outfit is a deep bordeaux-colored sleeveless knit mini dress. Made of light to medium-light fine rib-knit material, it naturally traces the body lines without clinging excessively. The neckline is a shallow to moderate round or scoop neck, with a realistic fit where the three-dimensional contour of the bust is naturally perceptible through the garment. The length is a mini length that maintains dignity even while seated. Slight fabric stretching and natural wrinkles corresponding to the posture are present at the waist and abdomen. Accessories are kept minimal, such as a small pendant necklace, paired on the feet with simple pumps in a matching tone or dark brown. No brand logos or conspicuous ornaments. [Pose, Action & Gaze] The woman sits somewhat shallowly on the windowside chair rather than sinking deeply into it. Her pelvis is angled slightly diagonally from the front, naturally holding her upper body upright without slouching. One leg is naturally crossed over the other in a stable seated posture where the knees do not spread excessively wide nor intertwine unnaturally. Body weight is naturally distributed between the seat and the lower leg. The hand on the window side lightly touches the chair's armrest or seat edge, while the other hand rests relaxed near the upper knee. Shoulders are not shrugged, opened naturally so the chest is not overly obscured by the arms. Her face is turned toward the camera, her gaze looking directly at the lens or just slightly beside it. Not an overly staged model pose, but a natural moment as if she suddenly looked over in the middle of a conversation. [Expression & Emotion] A gentle, approachable smile with slightly relaxed eyes and cheeks. Not a forced smile made by just raising the corners of the mouth, but with a gentle warmth in the eyes, conveying a sense of security as if spending a quiet afternoon with someone close. Eyebrows remain in a natural position, without overdramatizing the expression. Rooted in mature composure, with a touch of shy softness added. Not an overtly seductive expression, but restrained to a level that conveys natural closeness and intimacy, harmonizing with the quiet autumn indoor scenery. [Composition & Camera] A 4:5 vertical composition suited for X posts. The subject's entire body is naturally captured from crown to pumps, without toes or hair being unnaturally cropped at the frame edges. The camera is set around the subject's chest to waist height, shooting from a slightly distant, mostly frontal position. The chair, subject, and window are balanced vertically, forming a composition where light entering from the window naturally guides the subject's contour. Focal length corresponds to 50–85mm, standard to short telephoto. Extreme wide angles are avoided, prioritizing natural perspective so legs or bust do not appear unnaturally enlarged. Depth of field is not excessively shallow; the subject is crisp, while the background is softly blurred enough to recognize the location. [Lighting, Color, Texture & Atmosphere] The main light source is warm autumn natural light streaming from the window at the side of the frame. It creates soft highlights on the window-facing side of the face, shoulders, arms, and legs, while subtle reflected light from the indoor walls and floor wraps around the opposite side so shadows do not clip completely. Shadows are expressed as slightly diffused light filtered through curtains, rather than harsh, sharp direct sunlight. The color palette centers on bordeaux, wood browns, unbleached cotton, pale beige, and the yellowed leaves outside the window. Skin retains natural flush and microscopic shading, hair has fine strand flow and luster, knitwear displays fiber texture and elasticity, wooden furniture shows wood grain, and the window reflects glass-like highlights. The overall tone is warm and quiet, carrying the slightly sentimental air characteristic of an autumn afternoon. [Quality & Negative Elements] High resolution, photorealistic, natural human anatomy, lighting, texture, and perspective as if photographed with a real camera. Avoid underage appearance, overly childish facial features, unnatural anatomy, extra or missing limbs or fingers, fused fingers, unnatural joints, confusion between left and right hands, or broken leg crossings. Avoid costume breakage, fusion between body and cloth, unnatural cutting-in or gaping, unintended exposure, extreme wide-angle distortion, or excessive skin smoothing. While maintaining rich, natural volume in the bust, do not depict gigantic sizes, hard spheres, abnormal push-up, or gravity-defying shapes. No text, logos, watermarks, or UI displays in the image.
```
...
### 15-second continuous handheld shot of a woman eating sushi, progressing through extreme sour shock, disgust, surprise, and delight.

Author：[@EndFolding79421](https://x.com/EndFolding79421) · [Source](https://x.com/EndFolding79421/status/2101007280040784269)

Cinematic / Film Still · Character · Published

**Summary:** 15-second continuous handheld shot of a woman eating sushi, progressing through extreme sour shock, disgust, surprise, and delight.
...
### Continuous underwater cinematic descent from the sunlit surface to the abyss with marine life and bioluminescent jellyfish.

Author：[@mys1111](https://x.com/mys1111) · [Source](https://x.com/mys1111/status/2100644208600400163)

Cinematic / Film Still · Published

**Summary:** Continuous underwater cinematic descent from the sunlit surface to the abyss with marine life and bioluminescent jellyfish.
...
```text
Journey to the bottom of the sea in a realistic and mesmerizing cinematic style.

A smooth and continuous descent from the sunlit ocean surface into the abyssal depths. Sunlight filters through in golden and blue beams that gradually fade away. Schools of silver fish cross the frame, vibrant corals, luminous jellyfish, and bioluminescent creatures appear as depth is gained. The water becomes increasingly darker, deep, and infinite, with floating particles and an atmosphere of mystery and wonder.

The camera moves in a smooth, continuous shot, gently pushing forward and downward, creating a sense of total immersion and controlled vertigo. Realistic lighting with dramatic contrast between the fading light and bioluminescent flashes.

Majestic and intense classical orchestral music, with deep strings, brass, and crescendos that evoke awe and grandeur, synchronized with the descent.
```
...
### Cinematic vertical product commercial prompt for DJI Osmo Pocket 3 featuring detailed shot-by-shot gimbal and street scenes.

Author：[@Urwa\_345](https://x.com/Urwa_345) · [Source](https://x.com/Urwa_345/status/2100821608911048833)

Product Marketing · Cinematic / Film Still · Product · Cityscape / Street · Published

**Summary:** Cinematic vertical product commercial prompt for DJI Osmo Pocket 3 featuring detailed shot-by-shot gimbal and street scenes.
...
```text
Create a cinematic 8-second premium advertisement for the authentic DJI Osmo Pocket 3, vertical 9:16 format.\n\n0–2 sec: Slow camera push-in toward the DJI Osmo Pocket 3 standing on a modern desk, touchscreen glowing softly.\n\n2–4 sec: Macro camera movement around the lens and gimbal mechanism, showcasing the compact premium design.\n\n4–7 sec: Smooth transition to a creator holding the camera while filming a beautiful city street during golden hour, realistic handheld movement.\n\n7–9 sec: Transition to the camera mounted on a small tripod overlooking a mountain landscape at sunset.\n\n9–10 sec: Final hero shot of the DJI Osmo Pocket 3, slow cinematic orbit with the screen and camera lens clearly visible.\n\nPhotorealistic professional camera commercial, realistic gimbal movement, smooth transitions, cinematic depth of field, premium technology advertising, authentic product design, natural lighting, highly detailed, no text overlays, no watermark.
```
...
### 30-second realistic AAA gangster gameplay combat video prompt, featuring a complete HUD and timeline-based street brawl with a boss entrance.

Author：[@Inshrah\_ali\_](https://x.com/Inshrah_ali_) · [Source](https://x.com/Inshrah_ali_/status/2100809690850664865)

Cinematic / Film Still · Published

**Summary:** 30-second realistic AAA gangster gameplay combat video prompt, featuring a complete HUD and timeline-based street brawl with a boss entrance.
...
### Cinematic underwater scene showing a massive whale and a robotic fish hunting together near coral reefs under volumetric sunlight.

Author：[@ICare\_MHB](https://x.com/ICare_MHB) · [Source](https://x.com/ICare_MHB/status/2100802747654181375)

Cinematic / Film Still · Published

Source：[@ICare\_MHB](https://x.com/ICare_MHB) · [Source](https://x.com/ICare_MHB/status/2100631156844818697)

**Summary:** Cinematic underwater scene showing a massive whale and a robotic fish hunting together near coral reefs under volumetric sunlight.
...
```text
Ultra-realistic cinematic underwater scene, a massive blue whale and a futuristic robotic fish swimming together deep in the ocean, actively hunting for prey. The whale moves powerfully through the dark blue water while the robotic fish scans the surroundings with glowing blue sensors and rapidly changes direction. Small schools of fish scatter in panic as they chase through underwater rocks and coral. Dramatic sunlight rays penetrate from the surface, bubbles and particles floating in the water, dynamic camera tracking shot, intense hunting atmosphere, realistic ocean physics, highly detailed textures, cinematic 4K, volumetric lighting, smooth motion, 10 seconds, vertical 9:16, no text, no watermark.
```
...
### Cinematic 15-second video prompt depicting AI integration into everyday life across futuristic cityscapes and humanoid robots.

Author：[@Zarlish\_Shahid](https://x.com/Zarlish_Shahid) · [Source](https://x.com/Zarlish_Shahid/status/2100751916800368694)

Cinematic / Film Still · Cyberpunk / Sci-Fi · Cityscape / Street · Published

**Summary:** Cinematic 15-second video prompt depicting AI integration into everyday life across futuristic cityscapes and humanoid robots.
...
```text
Create a 15-second ultra-realistic cinematic AI video showing a breathtaking vision of the moment artificial intelligence becomes deeply integrated into everyday human life.

Scene 1 — 0–3 sec:
A futuristic city at night, thousands of people walking beneath enormous transparent holographic AI interfaces. Giant streams of glowing data move through the sky like digital rivers. The camera rapidly flies between skyscrapers toward one mysterious glowing AI core.

Scene 2 — 3–7 sec:
Cut to a realistic humanoid AI robot standing in the middle of a crowded modern city street. Humans walk around it naturally. The robot slowly looks directly into the camera while millions of tiny particles and neural-network patterns appear around its face.

Scene 3 — 7–11 sec:
The camera pulls back dramatically to reveal AI controlling an entire futuristic ecosystem: autonomous cars, drones, robots, smart homes, hospitals and factories—all connected by glowing neural networks.

Scene 4 — 11–15 sec:
Suddenly everything becomes completely silent. The city lights turn off one by one. Only the AI core remains glowing in the darkness. The camera slowly moves closer to it.

Final frame:
The AI core opens like a digital eye and looks directly at the viewer.

Style:
Ultra-realistic, photorealistic, cinematic Hollywood quality, realistic humans, realistic reflections, volumetric lighting, dramatic atmosphere, sophisticated futuristic architecture, extremely detailed environments, natural camera movement, shallow depth of field, high contrast, physically accurate lighting, seamless transitions, 4K, no text, no logos, no watermark.

Hook:
Make the first 1 second visually shocking enough to stop scrolling.
Maintain perfect visual continuity throughout the entire video.
```
...
### Cinematic horror dance video of a woman smoking and performing synchronized choreography with skeletons in a smoky hall.

Author：[@AIwithWania](https://x.com/AIwithWania) · [Source](https://x.com/AIwithWania/status/2100476127978647840)

Cinematic / Film Still · Character · Published

**Summary:** Cinematic horror dance video of a woman smoking and performing synchronized choreography with skeletons in a smoky hall.
...
```text
A cinematic 15-second viral-style horror dance video. A stylish young woman wearing a fashionable short skirt stands alone in the foreground, smoking calmly with a cool fearless attitude. Behind her, in a dark smoky hall, a crowd of creepy skeletons stands in rows. At first they are still, then as the woman slowly walks backward into the group, the skeletons begin making eerie movements and creepy sounds. The woman joins them confidently. In the final moments, the woman and the skeleton crowd perform a synchronized viral dance together with sharp head movements, shoulder pops, and rhythmic body motions. Dark moody lighting, smoky atmosphere, dramatic backlight, stylish horror aesthetic, cinematic, high detail, smooth motion, visually striking.
```
...
### A 10-second cinematic summer countryside short film featuring a consistent young woman across six sequential shots.

Author：[@LiEvanna85716](https://x.com/LiEvanna85716) · [Source](https://x.com/LiEvanna85716/status/2100408772762226752)

Cinematic / Film Still · Character · Published

**Summary:** A 10-second cinematic summer countryside short film featuring a consistent young woman across six sequential shots.
...
```text
A cinematic 10-second summer short film featuring the same young woman throughout the entire video, set in a peaceful American countryside during golden hour. She has shoulder-length dark hair, natural makeup, and a soft youthful appearance.\n\nThe video opens with a close-up side profile of her standing in a wide green meadow under a dramatic blue sky with soft clouds. Gentle sunlight falls across her face as the wind moves her hair naturally.\n\nCut to a medium shot of her walking slowly through the field, turning her head back toward the camera with a calm, slightly nostalgic expression. Keep her facial identity, hairstyle, body proportions, and outfit consistent.\n\nTransition to an intimate overhead and side-angle shot of her lying in tall green grass, looking upward at the sky. The grass moves softly in the breeze, creating a relaxed summer atmosphere.\n\nThen move to a rustic countryside location with a classic red wooden barn and fence in the background. She casually leans against the fence, playing with her hair, with warm sunlight creating natural lens flare and soft rim light.\n\nFor the final scene, she sits alone on outdoor bleachers during sunset, wearing a white tank top and relaxed sporty shorts, holding a dark glass bottle near her face. Warm backlight shines through her hair as she closes her eyes and enjoys the moment.\n\nEnd with a dreamy soft-focus shot and subtle cinematic fade, evoking the feeling of a nostalgic summer memory.\n\nRealistic photography, cinematic natural lighting, golden hour sunlight, soft film grain, shallow depth of field, gentle handheld camera movement, natural body movement, realistic skin texture, subtle wind, warm nostalgic summer mood, consistent character identity, smooth scene transitions, emotional visual storytelling, indie coming-of-age film aesthetic, high-end music video cinematography, 9:16 vertical format.
```
...
### “\[object\] open as a miniature museum of \[theme\], integrated architecture, cinematic macro photography, warm light, extreme detail, editorial realism”

Author：[@hmontilla\_](https://x.com/hmontilla_) · [Source](https://x.com/hmontilla_/status/2100418400216388058)

Photography · Cinematic / Film Still · Architecture / Interior · Published

**Summary:** “\[object\] open as a miniature museum of \[theme\], integrated architecture, cinematic macro photography, warm light, extreme detail, editorial realism”
...
Author：[@HeyRu0by](https://x.com/HeyRu0by) · [Source](https://x.com/HeyRu0by/status/2098289889964183843)

Product Marketing · Photography · Cinematic / Film Still · Food / Drink · Published

**Summary:** Create a premium 15-second vertical 9:16 Sambal Ekstra Pedas commercial, featuring 8 cinematic scenes, ultra-photorealistic 8K quality, action-thriller energy × premium food TVC aesthetics, and high-speed macro food cinematography.
...
### 3-panel romantic manga strip prompt with a shy girl teasing a flustered, blushing boy.

Author：[@2\_\_han\_\_](https://x.com/2__han__) · [Source](https://x.com/2__han__/status/2101030346334908638)

Comic / Storyboard · Anime / Manga · Comic / Graphic Novel · Character · Published

**Summary:** 3-panel romantic manga strip prompt with a shy girl teasing a flustered, blushing boy.
...
```text
manga page, 3 panels, vertical strip layout, white background, comic, manga, vertical stack, vertical split, [PANEL 1]: top panel, 1boy 1girl, side view, medium shot, separation, 1boy arms crossed scowling looking away, 1girl behind 1boy looking at 1boy hesitant sweatdrop, tension, negative space, [PANEL 2]: middle panel, 1girl, looking at 1boy, eye contact, very blushing, shy smile, Placing a hand on one's chest, hands covering chest, text speech bubble, "가슴 만질래...?",, soft lines, emotional focus, [PANEL 3]: bottom panel, 1boy, closeup, face shot, facing viewer, intense blush, beet red face, wide-eyed, flustered, embarrassed, surprised, covers mouth with one hand, heart motif background, dramatic shading,
```
...
### Prompt for generating an anime-style illustration of a beautiful girl's tonsure ceremony.

Author：[@AUrbNUMjfxj85IS](https://x.com/AUrbNUMjfxj85IS) · [Source](https://x.com/AUrbNUMjfxj85IS/status/2100703296302588303)

Anime / Manga · Illustration · Character · Published

**Summary:** Prompt for generating an anime-style illustration of a beautiful girl's tonsure ceremony.
...
```text
Beautiful girl tonsure ceremony animation
```
...
### Generation prompt for beautiful girl head-shaving ceremony animation

Author：[@AUrbNUMjfxj85IS](https://x.com/AUrbNUMjfxj85IS) · [Source](https://x.com/AUrbNUMjfxj85IS/status/2100703688205770795)

Anime / Manga · Illustration · Character · Published

**Summary:** Generation prompt for beautiful girl head-shaving ceremony animation
...
```text
Beautiful girl head-shaving ceremony animation
```
...
### An anime-style prompt depicting a beautiful girl's head-shaving ceremony.

Author：[@AUrbNUMjfxj85IS](https://x.com/AUrbNUMjfxj85IS) · [Source](https://x.com/AUrbNUMjfxj85IS/status/2100703512049107223)

Anime / Manga · Character · Published

**Summary:** An anime-style prompt depicting a beautiful girl's head-shaving ceremony.
...
### High-definition anime upper body illustration prompt of a purple-haired, red-eyed female character stretching, featuring rich outfit and scene details.

Author：[@studio\_yebisu](https://x.com/studio_yebisu) · [Source](https://x.com/studio_yebisu/status/2100855355928621063)

Anime / Manga · Illustration · Character · Fashion Item · Published

**Summary:** High-definition anime upper body illustration prompt of a purple-haired, red-eyed female character stretching, featuring rich outfit and scene details.
...
```text
masterpiece, best quality, very aesthetic, detailed face, high contrast, smooth skin,
1girl, solo, adult woman,
very long hair, purple hair, gradient hair, straight hair, hair between eyes, sidelocks,
red eyes, blush, closed mouth, sulking, looking at viewer,
black headdress, frilled headwear, purple bow,
stretching, arms up, armpits, elbow gloves, black gloves, lace-trimmed gloves,
black dress, strapless dress, shiny clothes, latex, corset, cleavage, large breasts,
purple ascot, purple bow, waist bow,
indoors, bedroom, window, daylight, plant, blurry background, depth of field,
stuffed animal, stuffed rabbit,
upper body, anime style
```
...
### A romantic couple illustration prompt detailing the shared composition and the poses, clothing, and emotional expressions of two characters \(A, B\).

Author：[@leftbypeace](https://x.com/leftbypeace) · [Source](https://x.com/leftbypeace/status/2100438943573659802)

Anime / Manga · Illustration · Comic / Graphic Novel · Character · Group / Couple · Fashion Item · Published

**Summary:** A romantic couple illustration prompt detailing the shared composition and the poses, clothing, and emotional expressions of two characters \(A, B\).
...
### Prompt template for generating a 9:16 Chinese Moments screenshot where a designated character posts an update and triggers interactions from other characters based on their personalities and relationships.

Author：[@VoxcatAI](https://x.com/VoxcatAI) · [Source](https://x.com/VoxcatAI/status/2100437193340948981)

Social Media Post · Anime / Manga · Character · Published

Source：[@VoxcatAI](https://x.com/VoxcatAI) · [Source](https://x.com/VoxcatAI/status/2100414488860316088)

**Summary:** Prompt template for generating a 9:16 Chinese Moments screenshot where a designated character posts an update and triggers interactions from other characters based on their personalities and relationships.
...
```text
{Character A} posts their {content of the work} to Moments, and other characters interact in the comment section. A screenshot of a Chinese social media platform's Moments feed, containing the main post, accompanying images, body text, likes, and comment section, 9:16. All comments must strictly align with each character's personality, background, identity, speaking style, past events, as well as their actual relationship and power dynamics with Character A. Instead of simply speaking according to basic personality types, it must reflect who is in awe, who is fearful, who flatters, who is apprehensive, who is passive-aggressive, who dares to confront head-on, and who can only express themselves tactfully. Public comments do not have to match true attitudes, allowing for surface-level politeness, veiled subtext, self-censorship, taking sides, perfunctory chiming in, and threaded sub-comment bickering. The overall execution must look as if these characters would genuinely comment like this on Moments. Anime or game characters are uniformly converted into a live-action version of a social media platform screenshot.
```
...
### low-angle view from behind, focus starting from legs, looking backward between legs, head resting on the ground, feet on the ground, hands behind back, soldier boy, defined abs, military pants, boots, dog tag dangling, flushed face, small wound, bruises, soil floor background

Author：[@2\_\_han\_\_](https://x.com/2__han__) · [Source](https://x.com/2__han__/status/2101143973549195655)

Illustration · Character · Animal / Creature · Abstract / Background · Published

**Summary:** low-angle view from behind, focus starting from legs, looking backward between legs, head resting on the ground, feet on the ground, hands behind back, soldier boy, defined abs, military pants, boots, dog tag dangling, flushed face, small wound, bruises, soil floor background
...
```text
low-angle view from behind, focus starting from legs, looking backward between legs, head resting on the ground, feet on the ground, hands behind back, arms behind waist, soldier, boy, defined leg muscles, military pants, boots, a face that looks a bit strained, firm breasts, defined abs, jacket loose, jacket falling open, jacket slipping down, exposing chest, exposing abs, dog tag dangling, flushed face, dripping sweat, small wound, bruises, Distinct bruises and small wounds on the upper body and face., soil floor background
```
...
### Halloween-themed promotional video featuring a girl in a Taoist robe making a ghost-claw gesture in front of the Naihe Bridge archway, accompanied by cartoon ghost special effects and promotional text.

Author：[@cngshtng10](https://x.com/cngshtng10) · [Source](https://x.com/cngshtng10/status/2101116496424665240)

Photography · Illustration · Character · Fashion Item · Published

**Summary:** Halloween-themed promotional video featuring a girl in a Taoist robe making a ghost-claw gesture in front of the Naihe Bridge archway, accompanied by cartoon ghost special effects and promotional text.
...
```text
This is a Halloween promotional short video for the "Eighteen Levels of Hell Theme Park": a girl dressed in a Qing Dynasty zombie hunter / Taoist priest costume (black embroidered robe, blue mandarin collar, yellow talisman stuck to her forehead, skull necklace) stands in front of the "Naihe Bridge" archway hung with high lanterns, making a scary ghost-claw gesture towards the camera, accompanied by cute cartoon little ghost special effects, startled reactions, and coupon-style promotional text.
```
...
### A seductive digital mistress illustration with text overlay.

Author：[@shroudspeeders](https://x.com/shroudspeeders) · [Source](https://x.com/shroudspeeders/status/2101032572532736383)

Illustration · Published

**Summary:** A seductive digital mistress illustration with text overlay.
...
```text
Draw me a seductive picture of a digital mistress with the text ASSX
```
...
### A sleepy white rabbit curled in a patchwork quilt within a sunlit daisy meadow.

Author：[@RenRose321](https://x.com/RenRose321) · [Source](https://x.com/RenRose321/status/2100987458766750054)

Illustration · Published

**Summary:** A sleepy white rabbit curled in a patchwork quilt within a sunlit daisy meadow.
...
```text
A sleepy white rabbit curled into a patchwork quilt in a sunlit meadow of clover and daisies, soft pastel illustration with layered fabric-like textures, blush cream sage and butter-yellow palette, peaceful refreshing morning mood
```
...
### An orange tabby cat lounging on a mint-green car in a field of giant daisies in naive folk art style.

Author：[@RenRose321](https://x.com/RenRose321) · [Source](https://x.com/RenRose321/status/2100758326556471449)

Illustration · Animal / Creature · Vehicle · Published

**Summary:** An orange tabby cat lounging on a mint-green car in a field of giant daisies in naive folk art style.
...
```text
An orange tabby cat lounging on the hood of a tiny mint-green car parked in a field of giant daisies, naive folk art with flat shapes and decorative dots, coral sunflower and sky-blue palette, playful and sunny
```
...
### 2-panel comic prompt: daytime street date in panel 1, bedroom low-angle leg focus in panel 2.

Author：[@2\_\_han\_\_](https://x.com/2__han__) · [Source](https://x.com/2__han__/status/2100793684895965264)

Comic / Graphic Novel · Cityscape / Street · Published

**Summary:** 2-panel comic prompt: daytime street date in panel 1, bedroom low-angle leg focus in panel 2.
...
```text
2panels, comic, manga, vertical stack, vertical split, 2 vertically stacked panels, [panel 1] full body, 2people, walking together, linking arms, arm in arm, side-by-side, date, happy smile, walking on street, character A in oversized denim jacket, black turtleneck, trousers, character B in cream trench coat, pleated skirt, loafers, city street background, store front, daytime, soft lighting, [panel 2] low angle, feet focus, legs focus, character B bare legs, character B unclothed lower body, skin focus, character B legs lifted, feet off ground, floating feet, tiptoes, pointed toes, trembling legs, sweat drops on thighs, character B wearing white socks, socked feet, character A legs back view, character A legs facing away, character A legs from behind, character B feet between character A legs, discarded shoes on floor, discarded clothes on floor, dark room, bedroom, dim lighting, moody shadows, (small heart:1.2), floating heart, pink heart, pop-up heart, cinematic lighting, masterpiece, highly detailed
```
...
### Ancient Song Dynasty ink-wash landscape style, featuring a traditional Gongbi grey wolf in the lower right corner with a silly, innocent expression and a tilted-head smile, with calligraphy and a vermilion seal in the upper left.

Author：[@liluocheng13](https://x.com/liluocheng13) · [Source](https://x.com/liluocheng13/status/2100505656231096481)

Comic / Graphic Novel · Ink / Chinese Style · Animal / Creature · Landscape / Nature · Published

**Summary:** Ancient Song Dynasty ink-wash landscape style, featuring a traditional Gongbi grey wolf in the lower right corner with a silly, innocent expression and a tilted-head smile, with calligraphy and a vermilion seal in the upper left.
...
```text
Vertical composition, 9:16 aspect ratio. An ancient ink-wash landscape painting that looks as though it was retrieved from an imperial archive of the Song Dynasty, with a rather solemn and grandiose atmosphere: distant peaks tower into the clouds, mist slowly drifts across the mountainsides, bizarre pines stand on cliffs, while withered branches and scattered rocks are dispersed across the foreground, accompanied by abundant negative space, as if heaven and earth were solemnly debating some monumental affair of the ages. However, in the lower right of the painting, there stands a distinctly un-serious grey wolf. Its body shape and fur are still meticulously depicted according to traditional fine-brush ink-wash techniques (Gongbi), with accurate limb anatomy, a naturally drooping tail, and perked-up ears; yet its head is tilted slightly, its eyes are wide and round, and a goofy, polite faint smile hangs at the corners of its mouth, wearing an expression as if it just stole a snack and is trying hard to act like: "It wasn't me, I'm just passing through." Innocent yet guilty, with a hint of inexplicable confidence, adorably earnest, and high-class goofy. The overall style combines Song Dynasty ink-wash landscapes with ancient animal paintings, featuring rich gradations of ink, combining wet-brush washes and dry-brush texture strokes (cun). The wolf's fur is delicate yet maintains hand-painted brushstrokes; the mountain rocks are heavy, and the clouds and mist are ethereal. Old Xuan paper backdrop, warm beige tones with faint tea-stain effects, showing natural mottling, creases, and traces of age. In the upper left, the inscription "子丹图画" is written vertically in archaic running script, accompanied by a small vermilion seal below. At first glance, the entire painting appears to be an ancient masterpiece; at second glance, the wolf seems off; at third glance, one cannot help but laugh out loud. The scene is humorous without being juvenile, cute without resembling a cartoon sticker; it preserves the subtlety, negative space, and refined aesthetic of traditional Oriental painting. No modern items, no exaggerated chibi heads, no anime style, no 3D rendering, no plastic texture, no fierce expressions, no gore, no extra limbs, no incorrect paws, no garbled text. Ultra-fine traditional hand-painted texture, museum-grade ancient painting reproduction effect, 9:16 aspect ratio.
```
...
### Product shot of a mossy stone tiki idol.

Author：[@nightandwknd](https://x.com/nightandwknd) · [Source](https://x.com/nightandwknd/status/2100767176168722867)

3D Render · Product · Published

**Summary:** Product shot of a mossy stone tiki idol.
...
```text
a mossy stone tiki idol, neutral grey background, full object centered, product shot
```
...
### Direct-flash retro party group photo of seven East Asian women wearing purple sequin bunny girl outfits inside a high-rise lounge.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2101127042800791571)

Photography · Retro / Vintage · Fashion Item · Published

**Summary:** Direct-flash retro party group photo of seven East Asian women wearing purple sequin bunny girl outfits inside a high-rise lounge.
...
```text
Hyper-realistic nighttime party group portrait photography, landscape format approximately 3:2, seven clearly adult East Asian women in their 20s, wearing uniform purple bunny girl stage outfits, huddled closely together for a group photo inside a high-rise hotel lounge / nighttime scenic restaurant. The photographer is at very close distance, using an equivalent 28–35mm lens + direct frontal flash, the subjects almost entirely filling the frame, creating a crowded composition with a strong authentic party candid snapshot feel.

All seven women wear deep purple sequined bunny girl bodysuits; the fabric is covered in tiny sequins, showing violet-blue specular highlights under the flash; paired with black fine mesh fishnet tights, white stand collars, black bowties, white cuffs, purple sequined bunny ear headbands, and white fluffy bunny tails on the back of their waists. Outfits are uniform with slight individual differences in detail, maintaining full and proper coverage.

All subjects have natural slender to subtle hourglass figures, with slightly narrow shoulders, cinched waists, rounded hips, and authentic soft thigh volume, without athletic musculature or exaggerated proportions. Hairstyles primarily feature medium-to-long hair in black, dark brown, light brown, and golden brown, styled as loose hair, low ponytails, soft waves, and wispy bangs. Makeup leans toward Japanese nightclub party style: prominent eyeliner, eyelashes, light brown eyeshadow, and nude-pink or dusty-rose lips.

Composition focuses on the seven women packed closely together with staggered depth:
On the left, one woman stands in profile with her back turned, glancing back over her shoulder at the camera, her white bunny tail clearly visible; beside her, another woman faces forward at an angle holding a champagne flute; in the middle-rear, two to three women lean close together, one resting a hand on her bunny ears or hair; directly in the front center, one woman visibly leans forward with her torso facing the camera and her head turned back to look into the lens, serving as the foreground centerpiece; on the right, two women stand in semi-profile close to the table edge, with the rightmost woman having light golden-brown hair and holding a slender champagne flute. Everyone looks directly or semi-directly into the lens, displaying cool, smiling, or slightly party-ready expressions, avoiding identical facial looks.

On the tabletop and in front of the figures, champagne flutes, clear glassware, liquor bottles, an ice bucket, and warm candlelight reflections are visible. The background is a dark brown wood high-rise lounge; outside the floor-to-ceiling windows is a sea of nighttime city lights and skyscraper illumination, with the glass reflecting indoor warm light, keeping the overall background quite dark.

Lighting utilizes a strong direct camera flash + dim warm ambient lighting: subjects' faces, shoulders, sequined outfits, and tights are directly illuminated by the flash, rendering skin tones in warm fair tones; purple sequins produce numerous fine specular glints; the background falls off quickly into deep shadows, with the city nightscape forming sparse bokeh. Allows a small amount of high-ISO noise, subtle motion blur, and soft edges.

Overall aesthetic features a 2000s–2010s Japanese nightclub / high-rise lounge party CCD digital camera snapshot texture: high contrast, direct flash, high-saturation purple, deep shadows, subtle grain, limited dynamic range, realistic skin texture, avoiding any commercial studio feel.

Key focus: seven adult East Asian women + purple sequin bunny girl outfits + purple bunny ears + white bunny tails + black fine fishnet tights + white collars and cuffs + tightly packed group cluster + central figure leaning forward looking back + multiple people holding champagne flutes + high-rise night view lounge + floor-to-ceiling windows with city lights + direct frontal flash + 2000s digital party snapshot.

Avoid: fewer than seven people, single person overly dominating, white or black bunny girl outfits, ordinary formal dresses, mismatched hosiery or footwear colors, daytime, outdoors, photo studio, subjects spread out standing in a single row, excessive skin smoothing, anime faces, CG feel, extra people, extra limbs, watermarks, and garbled text.
```
...
### Prompt for a vintage CCD direct-flash portrait photoshoot of a Korean woman in a hotel bedroom.

Author：[@FuguiChen1314](https://x.com/FuguiChen1314) · [Source](https://x.com/FuguiChen1314/status/2101033660468314265)

Photography · Retro / Vintage · Portrait / Selfie · Character · Architecture / Interior · Published

**Summary:** Prompt for a vintage CCD direct-flash portrait photoshoot of a Korean woman in a hotel bedroom.
...
```text
9:16 portrait composition, hyper-realistic live-action photography, Korean Instagram baddie / Korean bad girl private portrait, set in a boutique hotel bedroom at night. iPhone snapshot + vintage CCD direct-flash aesthetic, like a casual photo pulled straight from a private camera roll. An unmistakably adult Korean woman, age 23–27, with a delicate, small oval face and natural cool-toned fair skin, retaining realistic fine skin texture, visible pores, and subtle variations in skin tone. Long black hair falls loosely and slightly disheveled, with wisps of fine hair naturally draping along the sides of her face. Elongated cat-like eyes with slightly upturned outer corners, cool pink nude makeup, subtle blush, and glossy nude-pink lips. Her overall demeanor is languid, aloof, slightly rebellious, carrying a Korean bad girl edge. She consistently wears thin-framed oval black glasses, slipping slightly down the bridge of her nose. She raises her eyes, looking over the top rim of the lenses directly into the lens, with a cool, sleepy, nonchalant gaze, her lips naturally relaxed and slightly parted. She wears a fitted black spaghetti-strap camisole paired with dark charcoal-black low-waist denim shorts, complemented by a delicate silver necklace. The outfit is minimalist and form-fitting, exposing her slender neck and shoulders, naturally prominent collarbones, a visible waistline, and long, well-proportioned legs. Her body proportions are mature, healthy, natural, and realistic. She sits on the edge of an unmade white hotel bed, her legs naturally parted and extending toward the foreground. Her upper body leans noticeably forward toward the camera, shoulders slightly rounded inward, arms hanging down naturally with hands resting in the space near her knees. Her head tilts slightly, looking up at the camera to create an intimate candid perspective, as if the photographer is standing right in front of her, casually shooting from a slightly elevated angle. Close-up high-angle shot, 35mm equivalent perspective. Her knees and legs dominate the foreground, while her face remains the visual center of the frame. Natural perspective distortion is used, with closer elements appearing larger and distant elements smaller to create realistic depth. Avoid polished studio poses; retain slight asymmetry, a relaxed posture, and believable body weight and tension. The background is a slightly messy white hotel bed with naturally scattered white pillows and rumpled sheets, dark gray walls, and a dark wood headboard. The room is dimly lit, with no other people present. Vintage CCD point-and-shoot direct flash. Harsh direct frontal on-camera flash illuminates her face, shoulders, and legs, producing realistic flash reflections on her cool-toned fair skin and slightly blown-out highlights, while the background is noticeably underexposed. Cool gray, desaturated tones, subtle digital noise, fine grain, soft focus, slight misfocus, and faint handheld motion blur, preserving the imperfect texture of a cheap vintage digital camera. Korean Instagram baddie, Y2K digital camera, private bedroom photo set, candid snapshot, intimate camera-roll aesthetic, cold desaturated tones, direct flash, authentic skin texture, messy black hair, oval thin-framed glasses, high-angle close-up, leaning forward on bed, photorealistic style, imperfect handheld framing, subtle film grain, authentic early 2000s digital camera feel. No text, no watermarks, no UI elements, no extra people, no duplicate limbs, no extra fingers, no deformed hands, no warped anatomy, no exaggerated body proportions, no plastic skin, no anime, no illustration.
```
...
### Turn a travel photo into a postcard design featuring the original image in the upper half, torn-paper white space, a screen-printed illustration, and a vintage postmark in the lower half.

Author：[@TodayKan](https://x.com/TodayKan) · [Source](https://x.com/TodayKan/status/2100100687946203533)

Illustration · Retro / Vintage · Text / Typography · Published

**Summary:** Turn a travel photo into a postcard design featuring the original image in the upper half, torn-paper white space, a screen-printed illustration, and a vintage postmark in the lower half.
...
```text
Turn the reference photo into a vertical 3:4 artistic postcard. The upper part fully preserves the original photo, highlighting the main subject's features and the on-site atmosphere, occupying approximately 55% of the frame height. The bottom of the photo features a natural, irregular torn-paper edge with visible paper fibers. Below the torn paper edge, keep an ivory-white blank space, completely separating the original photo from the illustration below. In this blank space, use a small vintage typewriter font: the name of the identified subject. In the lower section, draw a small, borderless illustration based on the photo's main subject, retaining recognizable silhouettes with moderately simplified details, presenting a screen-printing texture, slight noise, and a lo-fi print aesthetic; the color palette is extracted from the photo and limited to 2-4 restrained, desaturated colors. The illustration occupies half the height of the lower section, leaving plenty of blank space around it. On the right side along the torn paper edge, add an understated, weathered blue-black circular postmark, stamped precisely across the boundary between the top and bottom sections. At the very bottom, label in a generic format: 地点 · PLACE 日期 · DATE. The overall visual presents a warm vintage paper texture, generous white space, and a restrained, sophisticated magazine editorial style. Do not add postage stamps, coordinates, outer frames, 3D mockups, heavy drop shadows, curled corners, extra stamps, duplicated text, or watermarks.
```
...
### A sun-dappled, candid 35mm film photograph of a joyful Asian woman playfully riding a vintage bicycle in a garden.

Author：[@afrinxai](https://x.com/afrinxai) · [Source](https://x.com/afrinxai/status/2100124265752449144)

Photography · Retro / Vintage · Portrait / Selfie · Character · Published

**Summary:** A sun-dappled, candid 35mm film photograph of a joyful Asian woman playfully riding a vintage bicycle in a garden.
...
```text
A sun-dappled, candid 35mm film photograph of a joyful Asian woman with a dark bob haircut. She is playfully balanced on a vintage bicycle in a lush green garden, with both legs kicked out wide to the sides. She is wearing a layered outfit: a bright coral-red long-sleeved shirt underneath a muted pink floral overall dress (pinafore style). She has white ankle socks paired with classic black leather oxford shoes. The vintage bike has a woven wicker basket on the handlebars. In the background, there is a charming, weathered off-white wooden shed with multiple glass panes and a dark green-roofed shed partially visible among the trees. The image has a nostalgic, soft grain and natural summer lighting.Use the uploaded photo as the facial identity reference for an adult woman. Preserve his recognizable facial features, natural skin tone, facial proportions, and overall appearance. make the aspect ratio 3:4
```
...
### Fashion street photography prompt featuring an East Asian woman in a vintage industrial corridor, detailing clothing, pose, and lighting.

Author：[@oneviske](https://x.com/oneviske) · [Source](https://x.com/oneviske/status/2097886466710085695)

Photography · Retro / Vintage · Portrait / Selfie · Character · Fashion Item · Cityscape / Street · Published

**Summary:** Fashion street photography prompt featuring an East Asian woman in a vintage industrial corridor, detailing clothing, pose, and lighting.
...
```text
Ultra-realistic vintage fashion street photography, vertical orientation approximately 16:9, a young adult East Asian woman seated on a gray metal bench in a semi-outdoor industrial building corridor, with a large expanse of off-white aged brick wall, exposed concrete structural beams, and gray drainage pipes in the background. The overall aesthetic presents a 90s–2000s Japanese magazine fashion editorial style combined with a modern minimalist industrial space and a candid snapshot feel—quiet, restrained, with a touch of retro urban sensibility.

The photographer is positioned directly in front of the subject, slightly to the left, approximately 2–2.5 meters away, using an equivalent 35–50mm focal length lens, with the camera placed slightly below chest level and tilted gently upward. The subject is located in the center-right of the frame, occupying approximately 75–80% of the frame height, captured completely from the crown of her head to both feet; the left side retains a spacious, open corridor, pillars, and floor, while the right side retains the bench and her personal belongings. Avoid tight cropping, avoid excessive background blur, and ensure the industrial environment is clearly defined.

The subject is a young adult East Asian woman with a small-to-medium bone structure, slightly narrow shoulders, a naturally slender upper body, a short and distinctly nipped waist, naturally wider pelvis and hips, long thighs with soft, realistic volume, and calves that taper down smoothly. The overall silhouette is a natural, elegant, mild hourglass figure; do not generate an exaggerated voluptuous physique, athletic muscular legs, or paper-thin proportions.

The subject sits sideways on the bench, her body angled roughly 30–40° toward the front-left of the frame, hips resting on the right side of the bench, her torso leaning distinctly toward the front-left, with one shoulder higher than the other to form a gentle diagonal line. Her head tilts along with her body toward her left side, face turned toward the camera, eyes gazing directly at the photographer with a calm, slightly languid, and aloof expression, lips naturally parted slightly without showing teeth in a smile.

Her left hand extends downward on her left side, fingers holding a folded English/financial newspaper that drapes naturally toward the ground; the layout shows black-and-white text, grayscale images, and bold headlines, but the text remains blurred and illegible. Her left wrist wears a bracelet made of small deep-red beads.

Her right hand hangs naturally along the right side of her body, holding a red translucent/glossy low-heeled shoe by the heel or counter, letting it dangle in front of the bench. On her right wrist, she wears a vintage watch with a gold case and a green rectangular dial, and a few silver/gold rings on her fingers.

The legs are the focal point of the composition: she is wearing sheer black pantyhose / black lace stockings that cover completely from thighs to toes; the color is distinctly noticeable yet allows natural skin tone to show through. The material has a lightweight nylon/hosiery texture, approximately 15–25D, with a smooth surface and subtle sheen, avoiding a thick cotton tight appearance.

One leg extends boldly forward and down toward the lower-left from the bench, knee slightly bent, the stocking-clad foot stretched forward and slightly pointed downward, positioned closest to the lens to produce a natural perspective foreshortening; the other leg is bent and tucked close beneath the bench, with the foot resting on or lightly hovering above the floor. Neither foot is wearing shoes, only black stockings.

On the floor in the lower part of the frame rests a black low-heeled ballet flat / kitten heel pump matching the one in her hand. The shoe features a round or soft squarish-round toe, a translucent or mesh upper with thin red piping and a small bow, and a very low, delicate heel around 3–4 cm. Her right hand holds the other shoe of the same pair, creating a clear relationship of "one on the ground, one held in hand."

On top, she wears a cream-white / ivory fitted long-sleeved knit top made of thin, soft fabric that is slightly sheer while maintaining complete coverage. The neckline is a wide, shallow U-neck / boat neck, revealing the collarbone and neck lines. The bodice fits snugly around the waist, forming natural fabric creases.

The sleeves are long with a slightly translucent quality, finished near the wrists with delicate white ruffled/lace trim, adding a touch of vintage feminine detail. Do not generate a generic white T-shirt or thick sweater.

On the bottom, she wears a high-saturation true red / deep red micro-mini knit skirt that fits cleanly over her hips, ending just below the upper thighs, featuring a fine vertical knit texture or subtle ribbing. The waistband sits near her natural waistline; no pleats, no plaid, no leather.

She wears a short white pearl necklace with medium-to-small pearls resting close to the base of her neck, enhancing the vintage elegance. Jewelry is minimal and refined; do not add exaggerated earrings or large statement necklaces.

Her hair is deep black-brown, ultra-long with loose waves, reaching down to near her waist, naturally thick and voluminous. It is softly side-parted at the crown without heavy straight bangs, featuring long loose strands framing her face. The hair falls past both shoulders, forming prominent large S-waves across her chest and left side, with soft, naturally airy ends. Avoid short hair, high ponytails, or overly styled perms.

Her face is delicate and softly oval, with a gentle jawline and fair, warm-toned skin. Naturally fine brows, deep brown almond-shaped eyes with subtle double eyelids, extremely thin eyeliner, a small straight nose, and low-saturation dusty rose lips. The makeup is clean, resembling vintage Japanese fashion magazines, preserving real skin texture without influencer-style beauty airbrushing.

The setting is a semi-outdoor industrial building corridor / parking garage / museum back-of-house passageway. On the right background is an expansive off-white painted brick wall, with brick contours, mortar joints, wear, and uneven coating clearly visible, showing subtle aged texture.

At the upper left, exposed concrete ceiling beams, rectangular structural beams, gray drainage pipes, and connecting elbows are visible. Toward the left rear stands a massive light-gray cylindrical load-bearing pillar running from floor to ceiling. A small electrical junction box or sensor may be on the wall, but without prominent text.

The subject is seated on a minimalist gray metal bench composed of multiple horizontal metal slats supported by slender gray metal legs, giving an industrial design feel. On the right side of the bench sits a high-gloss red small square handbag / vanity bag made of patent leather or shiny PVC.

Resting atop the red bag is a soft pale-yellow / cream-yellow beret or plush cap, slightly slouchy and softly colored. Beside it, an open newspaper/magazine lies naturally spread across the bench surface.

The floor is coarse-grained gray concrete / cement with fine pebbles, scuffs, and several light water stains / damp patches. The subject's extended red stocking-clad foot creates a striking color contrast against the gray floor.

Lighting is soft natural daylight streaming from the open area on the left, characterized by overcast or large-window diffused illumination. The left side of the subject's face, chest, white top, and forward leg are softly illuminated; the right side of her body, the brick wall, and the bench recede into deeper gray shadows, forming natural tonal depth.

No harsh flash, no studio softboxes. The white brick wall appears warm gray and ivory gray rather than pure white; the red skirt, stockings, shoes, and handbag serve as the primary color focal points of the entire scene.
```
...
### Realistic portrait prompt of an adult East Asian woman in a minimalist black staircase and white wall space, emphasizing the cut-out bodysuit, glossy pantyhose, and seated composition.

Author：[@DDJCXX](https://x.com/DDJCXX) · [Source](https://x.com/DDJCXX/status/2101150526729830895)

Photography · Minimalism · Portrait / Selfie · Character · Architecture / Interior · Published

**Summary:** Realistic portrait prompt of an adult East Asian woman in a minimalist black staircase and white wall space, emphasizing the cut-out bodysuit, glossy pantyhose, and seated composition.
...
```text
Ultra-realistic indoor staircase portrait photography, vertical 9:16 aspect ratio, a clearly adult East Asian female in her 20s, sitting on the black steps of a modern minimalist staircase. Shot with an equivalent 35–50mm lens, the camera is positioned slightly to the left directly in front of the subject at approximately waist height, fully capturing the head, upper body, crossed legs, and bare feet, while preserving a large area of the black staircase extending toward the upper left and the white wall on the right; the subject is located in the lower-right area of the frame, leaving noticeable environmental negative space.

The subject has a small-to-medium frame with a natural, slender hourglass figure—narrower shoulders, cinched waist, naturally rounded hips, thighs with realistic soft volume, and elongated slender calves. She sits on a lower step with her back lightly leaning against the white wall on the right, one leg crossed high over the other with the knee raised, while the other leg extends a long distance diagonally downward to the left along the stairs, creating a distinct diagonal leg line. Both feet are barefoot, wearing no shoes.

The subject has jet-black ultra-long straight hair with thick, blunt-cut straight bangs; hair length reaches below the waist, thick, dense, and sleek, with long locks hanging over the chest and down both sides of the body. Her head is tilted slightly to the right, looking directly into the camera lens with a calm, aloof expression. Her left arm is bent and raised near her ear/nape, while her right hand is raised near the shoulder lightly touching her hair, in a natural and restrained pose.

She wears a solid black, form-fitting long-sleeved bodysuit that hugs the body tightly throughout. The chest features a highly prominent oval cut-out accented by a black criss-cross strappy cage structure: multiple sets of thin X-shaped straps extend from below the collarbone toward the bust, adorned with a few metal rings and small gold charms; at the neckline sits a black structured choker collar / capelet-style neckline piece. The outfit is made of matte stretch fabric with slim sleeves, avoiding large areas of lace decoration.

Her legs are clad in smoke-black ultra-thin high-gloss pantyhose, approximately 10–15 denier, highly sheer, clearly revealing natural skin tone beneath. The pantyhose have an intense lustrous/oily sheen, forming continuous silver-gray highlight streaks especially along the knees, shins, and outer thighs; the feet are also fully encased, but sheer at the toes so that the contours of the toes are clearly visible. No fishnets, no thick opaque black tights, no matte stockings.

The scene is a minimalist modern stairwell: all stairs are made of black or dark charcoal-gray concrete/wood treads with slight traces of wear and uneven reflections; to the right is a large expanse of pure white or pale off-white wall, virtually unadorned. The staircase ascends toward the upper left of the frame, with a small black-framed window at the top admitting a small amount of cool-white natural light. The overall space is high-ceilinged, quiet, and cool-toned.

Lighting consists of a soft frontal fill light / weak direct flash combined with natural light from the top window. The subject's face and skin are bright with a cool-white cast, details in the black clothing are well-preserved, and the pantyhose highlights are very pronounced; the stairs are deep black, while the white wall establishes a stark black-and-white contrast. No intense cinematic colored lighting, no neon colors.

Overall visual aesthetic resembles a high-quality smartphone/mirrorless camera indoor fashion portrait: natural sharpness, slight cool tone, limited depth of field yet the environment remains discernible, realistic skin texture without plastic-smooth airbrushing.

Key anchors: adult East Asian woman + ultra-long straight black hair with thick blunt bangs + black long-sleeved cut-out strappy bodysuit + smoke-black ultra-thin high-gloss pantyhose + barefoot + sitting pose on stairs + one leg crossed high, one leg extended forward along the steps + hands positioned near ear and shoulder respectively + black staircase + pure white wall + subject positioned in lower-right of frame + cool-white minimalist interior.

Avoid: short hair, curly hair, bare legs, fishnets, thick opaque black tights, shoes, high heels, standing pose, legs pressed together, ordinary black dress, colorful clothing, complex interior decor, warm yellow luxury hotel, heavy background bokeh blur, anime face, CG look, extra limbs, watermarks, and garbled text.
```
...
### Minimalist big-type typographic poster prompt featuring an extremely enlarged bold Chinese character as the focal point, paired with precise grid guide lines and a minimalist color palette.

Author：[@xiaoxiaodong01](https://x.com/xiaoxiaodong01) · [Source](https://x.com/xiaoxiaodong01/status/2100526246707024323)

Poster / Flyer · Minimalism · Published

**Summary:** Minimalist big-type typographic poster prompt featuring an extremely enlarged bold Chinese character as the focal point, paired with precise grid guide lines and a minimalist color palette.
...
```text
Translate any futuristic theme into an extremely enlarged textual or symbolic subject using its core concept, short-phrase information, and minimal auxiliary descriptions: at first glance, it must be an ultra-heavy sans-serif glyph almost bursting out of the canvas, pressing horizontally into the layout, its body occupying the center like a structural beam, partially cropped or overflowing the borders, so that reading first becomes a powerful spatial, sculptural event before the subtitle is noticed along its perimeter. The background maintains extensive cool-white negative space, overlaid with ultra-fine, pale-warm compositional lines, baselines, and vertical column divisions that resemble the unhidden structural skeleton of a design blueprint rather than decoration. The primary visual weight is carried exclusively by a single high-saturation orange-red hue, with gray reserved for short explanatory text blocks, avoiding multicolor schemes and gradients. Information modules are sparsely anchored at grid intersections and margins: small icons are composed of simple geometric angles, dots, and short dashes; headlines are concise and bold; body text is set in narrow columns of light gray—conveying an overall precise, restrained, and experimental editorial typography masterclass feel. Glyph construction requires low contrast, thick strokes, large open counters, flat squared terminals, and tight tracking, with punctuation and auxiliary symbols strictly obeying the grid rhythm; if adapted to other writing systems, maintain the equivalent blocky mass, internal-external spatial balance, cropping tension, and horizontal reading momentum. Illustrated backgrounds, shadows, paper textures, centered card layouts, rounded cute styling, commercial poster lighting effects, and cluttered information overfill are strictly prohibited.

——————
Theme: 乐
Aspect Ratio: 9:16
Note: Appropriate Mid-Autumn Festival elements
Font Color: Gucci Ancora Red
```
...
### A video scene of a birthday card on a music box with spoken birthday wishes

Author：[@Z8YxUEUzCCdCEI1](https://x.com/Z8YxUEUzCCdCEI1) · [Source](https://x.com/Z8YxUEUzCCdCEI1/status/2101048359973007552)

Other · Published

**Summary:** A video scene of a birthday card on a music box with spoken birthday wishes
...
```text
A video-style scene wishing a happy birthday to an indigenous man, featuring a handmade card filled with wishes of love, trust, dreams, and hope placed on top of a music box, as someone speaks the words 'happy birthday' out loud in celebration.
```
...
### A video-style scene of an Indigenous man speaking words of blessing with a birthday card on top of a music box.

Author：[@Z8YxUEUzCCdCEI1](https://x.com/Z8YxUEUzCCdCEI1) · [Source](https://x.com/Z8YxUEUzCCdCEI1/status/2101047785563066843)

Character · Published

**Summary:** A video-style scene of an Indigenous man speaking words of blessing with a birthday card on top of a music box.
...
```text
A video-style scene celebrating while speaking "happy birthday" out loud, with a happy birthday card for an Indigenous boyfriend, a card crafted with wishes of love, trust, dreams, and hope, placed on top of a music box
```
...
### Piano concerto performance at Notre-Dame square.

Author：[@AndalaLabs](https://x.com/AndalaLabs) · [Source](https://x.com/AndalaLabs/status/2100930502383517757)

Product · Published

**Summary:** Piano concerto performance at Notre-Dame square.
...
```text
Piano concerto taking place in parvis de Notre-Dame
```
...
### Prompt template to generate animals composed entirely of materials or natural phenomena.

Author：[@hmontilla\_](https://x.com/hmontilla_) · [Source](https://x.com/hmontilla_/status/2101033686162427912)

Animal / Creature · Published

**Summary:** Prompt template to generate animals composed entirely of materials or natural phenomena.
...
```text
[animal] formed completely of [material or natural phenomenon], realistic anatomy, detailed textures, cinematic lighting, atmospheric background, editorial surrealist photography, extreme detail
```
...
### Commercial animation where a mascot interacts with a static product by trying to move it and then climbing onto it.

Author：[@Anaiappai](https://x.com/Anaiappai) · [Source](https://x.com/Anaiappai/status/2100668730359394678)

Product · Published

**Summary:** Commercial animation where a mascot interacts with a static product by trying to move it and then climbing onto it.
...
```text
The mascot begins by happily walking toward reference image with a natural, playful, and adorable movement. When it arrives, it stops, looks up, and places both hands against one of its sides. It tries to push it with all its might, leaning its entire body forward and straining with its feet, but it is too heavy and does not move at all.

The mascot stops, takes a few steps back, and observes reference image for a moment, as if thinking. Suddenly, an idea comes to mind, and it shows a small reaction of excitement. Then it jumps toward the top of reference image, grabs the upper edge with both hands, and hangs playfully. The mascot reaches the opening and, happily, takes a sip directly from reference image.

It ends with the mascot looking happy and satisfied as it continues interacting with the product.

Maintain the mascot's exact original appearance throughout the animation: the same round head, white body, dark brown outline, pink cheeks, facial features, and cute illustration style.

Keep reference image completely intact and static. Preserve all branding elements and text present in reference image. Do not deform the mascot or the product. Do not add extra characters, arms, legs, or objects.

Keep the background and camera completely static. No camera movements, no zooms, and no cuts.

Use smooth, playful commercial animation, with clear, expressive body language and believable physics.
```
...
### Instruct the character to flex muscles, bray, and transform on all fours

Author：[@mikeb5222094828](https://x.com/mikeb5222094828) · [Source](https://x.com/mikeb5222094828/status/2100557439556849968)

Character · Published

**Summary:** Instruct the character to flex muscles, bray, and transform on all fours
...
### Master prompt for generating a character sheet showing a photo-referenced motorcycle logically transforming into a humanoid hero robot across progressive stages.

Author：[@er1029iu](https://x.com/er1029iu) · [Source](https://x.com/er1029iu/status/2100716874048971156)

Character · Vehicle · Published

**Summary:** Master prompt for generating a character sheet showing a photo-referenced motorcycle logically transforming into a humanoid hero robot across progressive stages.
...
```text
UNIVERSAL MOTORCYCLE → HERO ROBOT
TRANSFORMATION CHARACTER SHEET MASTER PROMPT

Analyze the provided motorcycle photograph carefully and use the motorcycle itself as the absolute visual reference.

Do not assume a motorcycle model, color palette, body style, or mechanical configuration in advance.

FIRST, visually analyze the actual motorcycle shown in the uploaded photograph.

Automatically identify and preserve its most recognizable visual characteristics, including:

motorcycle type and overall silhouette,
body proportions,
...
exhaust system,
frame,
fuel tank or central body structure,
...
cargo box or luggage equipment if present,
windscreen if present,
footboard or foot pegs,
exposed cables,
mechanical joints,
decals and graphic placement,
surface scratches,
paint wear,
 dust,
aged materials,
and other distinctive physical details visible in the reference.

The final robot must clearly retain the visual DNA of THIS EXACT MOTORCYCLE.

A viewer should immediately think:

"That robot was transformed from that motorcycle."

==================================================
CHARACTER SHEET CONCEPT
==================================================

Create a cinematic transformation character sheet showing ONE motorcycle gradually transforming into ONE humanoid heroic robot.

Show the transformation as a clear physical progression:

STAGE 1:
Original motorcycle.

The motorcycle remains almost completely unchanged and clearly recognizable.

STAGE 2:
Early mechanical activation.

Small body panels separate slightly.

Mechanical locks release.

Suspension components shift.

Internal mechanical structures become visible.

The motorcycle must still remain approximately 80–90% recognizable.

STAGE 3:
Intermediate transformation.

The wheels reposition naturally.

The chassis begins extending.

Existing motorcycle components rotate, unfold, slide and reconnect.

The beginnings of humanoid legs, torso and arms become visible.

The motorcycle remains approximately 50–70% recognizable.

STAGE 4:
Advanced transformation.

The original motorcycle body panels become armor.

Wheels integrate naturally into the robot anatomy.

The exhaust becomes a recognizable mechanical armor component.

Handlebars, mirrors, lights, suspension, frame, seat, cargo equipment and other visible motorcycle components are redistributed logically across the robot.

The humanoid silhouette becomes dominant.

STAGE 5:
COMPLETE HERO ROBOT.

A magnificent full-body mechanical hero created entirely from the visual identity of the original motorcycle.

==================================================
TRANSFORMATION PHYSICS
==================================================

The transformation must look mechanically believable.

Every major motorcycle component should have a logical destination on the final robot.

Parts rotate around realistic hinges.

Panels slide along mechanical rails.

Frames extend through telescoping structures.

Suspension components become functional mechanical joints.

Existing motorcycle components become armor rather than disappearing.

Wheels remain physically recognizable.

The exhaust remains recognizable.

The original painted panels remain recognizable.

Distinctive motorcycle accessories remain recognizable whenever physically possible.

NO instant morphing.

NO liquid-metal transformation.

NO magical replacement.

NO random teleporting parts.

NO unexplained disappearance of major motorcycle components.

NO generic robot replacing the motorcycle.

The transformation should feel slow, heavy, deliberate and physically connected.
```
...
### Prompt for a female teacher's daily contrast image in the form of an iPhone photo album grid screenshot

Author：[@boniusex](https://x.com/boniusex) · [Source](https://x.com/boniusex/status/2100509464021664158)

Other · Published

Source：[@boniusex](https://x.com/boniusex) · [Source](https://x.com/boniusex/status/2100213110791389581)

**Summary:** Prompt for a female teacher's daily contrast image in the form of an iPhone photo album grid screenshot
...
```text
iPhone photo album screenshot × a teacher's well-behaved exterior × sections that are already out of control × the teacher's ID badge never taken off
```
...
### 3×3 grid layout of funny/failed candid photos playing in the sea

Author：[@MrGafish](https://x.com/MrGafish) · [Source](https://x.com/MrGafish/status/2100824363100672251)

Other · Published

**Summary:** 3×3 grid layout of funny/failed candid photos playing in the sea
...
```text
Various failed photos taken while playing in the water at the seaside, 3×3 grid layout, 9:16 vertical composition
```
...
### 1999 Toyota Corolla commercial

Author：[@freedom7\_4\_1776](https://x.com/freedom7_4_1776) · [Source](https://x.com/freedom7_4_1776/status/2100794107845070903)

Product Marketing · Published

**Summary:** 1999 Toyota Corolla commercial
...
### 10s vertical Coca-Cola commercial detailing ice scenes, cap opening, splashes, and a final hero composition.

Author：[@FuturoemTeste](https://x.com/FuturoemTeste) · [Source](https://x.com/FuturoemTeste/status/2100721468363719074)

Product Marketing · Published

**Summary:** 10s vertical Coca-Cola commercial detailing ice scenes, cap opening, splashes, and a final hero composition.
...
```text
Create a premium 10-second Coca-Cola commercial in vertical format (9:16), with photorealistic 8K quality, ultra-detailed high-speed beverage cinematography, dramatic red cinematic lighting, and a refreshing atmosphere of ice and splashes.

CONCEPT: ICE → SPLASH → BOTTLE REVEAL → LIQUID IMPACT → HEROIC COMPOSITION WITH MULTIPLE BOTTLES

01 | 0–1.2s — ICE IMPACT
Extreme close-up of crystal-clear ice cubes shattering in a signature Coca-Cola glowing red environment. Ice water droplets and tiny ice particles fly toward the camera in dramatic slow motion. Strong backlighting creates sparkling highlights.

02 | 1.2–2.4s — BOTTLE REVEAL
An ice-cold Coca-Cola glass bottle emerges through water and ice, rotating naturally in mid-air. The iconic contour bottle shape, red label, white wordmark logo, silver metallic cap, and realistic condensation remain sharp and perfectly accurate.

03 | 2.4–3.6s — REFRESHING SPLASH
A powerful wave of Coca-Cola liquid crashes around the bottle. Close-up droplets surround the product as the camera moves quickly forward through the splash.

04 | 3.6–4.8s — OPENING & FIZZ
Extreme close-up of the glass bottle neck and the metallic cap. The cap pops off with a realistic release of gas, creating fine bubbles and a refreshing mist.

05 | 4.8–6.0s — LIQUID MOTION
The dark Coca-Cola liquid forms an elegant, fluid wave wrapping around the bottle, creating a dynamic, sculptural splash. Ice cubes and droplets move naturally across the frame.

06 | 6.0–7.2s — BOTTLE SEQUENCE
Multiple Coca-Cola bottles appear at various depths, floating and rotating within the red environment. Water trails and ice particles accompany the movement, creating an energetic, premium advertising visual.

07 | 7.2–8.6s — HERO FORMATION
Three Coca-Cola bottles converge smoothly into a striking product composition. One bottle stands prominently in the foreground while the others are positioned behind. Heavy condensation, realistic reflections, and water droplets emphasize ice-cold refreshment.

08 | 8.6–10s — FINAL HERO SHOT
Clean, cinematic hero product shot: ice-cold Coca-Cola bottles surrounded by suspended water droplets and a subtle splash of Coca-Cola liquid. Deep, vibrant red background, glossy studio reflections, dramatic rim lighting. The camera performs a smooth push-in.

PRODUCT STANDARD: Preserve the exact Coca-Cola Contour bottle proportions, red label design, white Coca-Cola script logo, typography, silver-white metal cap, and overall packaging identity. No redesign, no distorted logo, no spelling errors, no duplicated labels, no deformed bottles.

VISUAL STYLE: Photorealistic, ultra-premium beverage commercial, 8K detail, high-speed macro cinematography, realistic liquid physics, sharp condensation, glistening ice, cinematic depth of field, dramatic studio lighting, realistic reflections, rich red color atmosphere, smooth camera movement.

NEGATIVE PROMPT: Blurry logo, distorted bottle, deformed typography, incorrect branding, extra logos, warped products, unrealistic liquid physics, duplicated bottles merging, low resolution, cartoon look, plastic-looking liquid, watermark, text artifacts.
```
...
### A scene of young people wearing Meiji-era style formal attire and medals gathering in a spacious entrance or gymnasium.

Author：[@RainSeekerRemi](https://x.com/RainSeekerRemi) · [Source](https://x.com/RainSeekerRemi/status/2100716570540720516)

Other · Published

**Summary:** A scene of young people wearing Meiji-era style formal attire and medals gathering in a spacious entrance or gymnasium.
...
Inside a spacious airport entrance or a large school gymnasium.
Young people in formal attire reminiscent of the Meiji era.

It feels like an upcoming event or party is about to take place.
I think it is probably a celebration.

The space was five times wider than in the image.

There are medals on their chests.
```
...
### Extend a 2:3 vertical video horizontally to a 16:9 widescreen format using outpainting instructions, while strictly preserving the original female subject, movements, and background composition.

Author：[@EndFolding79421](https://x.com/EndFolding79421) · [Source](https://x.com/EndFolding79421/status/2100710897039880504)

Abstract / Background · Published

**Summary:** Extend a 2:3 vertical video horizontally to a 16:9 widescreen format using outpainting instructions, while strictly preserving the original female subject, movements, and background composition.
...
### A 20-second riso-style animation showing a request's lifecycle inside a GPU server with a seed dot anchor.

Author：[@SandeshRajx](https://x.com/SandeshRajx) · [Source](https://x.com/SandeshRajx/status/2100424342123458593)

Other · Published

**Summary:** A 20-second riso-style animation showing a request's lifecycle inside a GPU server with a seed dot anchor.
...
```text
make a film using js, 20 seconds, the life of a request inside a GPU server, riso look, a seed dot as the anchor.
```
...
### A young woman working late at night at her desk, wearing a trench coat, covered in and surrounded by colorful sticky notes, holding a hot drink.

Author：[@afrinxai](https://x.com/afrinxai) · [Source](https://x.com/afrinxai/status/2100088288304664844)

Portrait / Selfie · Character · Food / Drink · Published

**Summary:** A young woman working late at night at her desk, wearing a trench coat, covered in and surrounded by colorful sticky notes, holding a hot drink.
...
```text
A stressed, overworked young woman sitting at a cluttered wooden desk working late on a laptop. She has light brown hair tied into a high, messy topknot bun, wearing thin black wire-rimmed round eyeglasses, drinking from a white ceramic mug with visible swirling hot steam rising from it. She is wearing an oversized beige trench coat covered in colorful sticky notes (pastel yellow, baby blue, soft pink). More handwritten post-it notes are stuck to her face, forehead, hair, and the back of her laptop screen. A desk lamp casts warm, dramatic side lighting; the background is a softly blurred, moody home office with bookshelves and potted plants. Cinematic, 35mm photograph, hyper-detailed, shallow depth of field, candid portrait, cozy yet chaotic aesthetic.Use the uploaded photo as the facial identity reference for an adult woman. Preserve his recognizable facial features, natural skin tone, facial proportions, and overall appearance. make the aspect ratio 3:4
```
...
### Short concept prompt depicting psychological repetition and distress.

Author：[@losslandscape](https://x.com/losslandscape) · [Source](https://x.com/losslandscape/status/2099222326097375613)

Other · Published

**Summary:** Short concept prompt depicting psychological repetition and distress.
...
### A timecoded video prompt featuring a hand-drawn character dancing joyfully alongside text and doodles against a sketchbook-style background.

Author：[@su\_nagomi](https://x.com/su_nagomi) · [Source](https://x.com/su_nagomi/status/2097520388326510672)

Character · Text / Typography · Abstract / Background · Published

**Summary:** A timecoded video prompt featuring a hand-drawn character dancing joyfully alongside text and doodles against a sketchbook-style background.
...
```text
CUT01 | 00:00–00:02.5 | Visuals: White sketchbook-like background. In the center of the screen stands a hand-drawn, rounded, minimalist main character. Round head, simple limbs, an approachable design with just tiny eyes and a mouth. Initially a slightly absentminded expression. Small handwritten words like "ふー" (phew), "ぼんやり" (spacing out), and "まだかな" (not yet?) drift around. In the background are faint dots, doodle circles, and short lines. | Camera: 50mm equivalent, front medium shot, slowly and gently pushing in. | Motion: The protagonist stands quietly, only slightly swaying their body. Not dancing yet. Line of sight shifts slightly left and right. | Lighting: Bright high-key. Soft light revealing a faint paper texture. | VFX: Rough wobble of hand-drawn lines, slight bleeding of ink, faint halftones. | BGM: Bright pop-electro begins. 150–160 BPM. Quietly starts with just light clicks, mallets, and a soft kick at the beginning. | SFX: "Whoosh" of a pen, subtle "poof". | Emotion: Still quiet, empty space of the beginning. | Transition: A small pink "とん" (tap) appears at the protagonist's feet, leading to the next CUT. CUT02 | 00:02.5–00:05.0 | Visuals: Colorful handwritten words "とん" (tap), "るん" (hum/skip), and "ぱっ" (pop) appear one after another at the protagonist's feet. Colors are pink, cyan, yellow, orange, lime, and purple. Hand-drawn stars, musical notes, and arrows begin to multiply in the surroundings. Background dots also become slightly darker. | Camera: 35mm equivalent, slightly pulled back framing showing full body. Light slide left and right. | Motion: The protagonist first taps with one foot ("とん"), then bounces their shoulders with "るん", and finally opens their arms slightly with "ぱっ". Still restrained, but clearly starting to dance. | Lighting: Bright and lighthearted. | VFX: Animation of text being written out as it appears, light afterimages, colorful sparks. | BGM: Hi-hats and claps are added. The beat comes forward, triggering the dance. | SFX: "とん" (tap), "るん" (hum), "ぱっ" (pop). | Emotion: A bit fun, mood starting to lift. | Transition: The "るん" at the feet bounces upward, circling around the protagonist toward the next CUT. CUT03 | 00:05.0–00:08.0 | Visuals: Handwritten words "わく" (excited), "にこっ" (smile), "くるっ" (twirl), "きらっ" (sparkle), "いいね" (nice) appear rhythmically around the protagonist. In the background, hand-drawn musical notes, lightning bolts, circled shapes, speech bubbles, and radial lines appear. The entire scene bursts into a colorful pop-art style all at once. | Camera: 28mm equivalent, lightly orbiting while tracking the full body. | Motion: Protagonist starts dancing in earnest. Stepping, swaying shoulders, swinging arms left and right, and finally spinning around with "くるっ". The surrounding text spins along with the rotation. | Lighting: Brightness where colors pop most vibrantly as the mid-section buildup. | VFX: Orbiting paths of rotating text, expanding/shrinking dots, comic-style sparks, energetic marker strokes. | BGM: Bass and rhythmic synth chops enter, raising tension by one level. The rhythm bounces, creating a visually satisfying groove for the dance. | SFX: "たんっ" (tap), "くるっ" (twirl), "きらっ" (sparkle), "にこっ" (smile). | Emotion: Fully becoming fun and lively. | Transition: A circle of colorful text forms around the spun protagonist, and that circle expands across the entire screen into the next CUT. CUT04 | 00:08.0–00:11.0 | Visuals: In sync with the protagonist's dance, the background itself begins to dance. Handwritten "るん♪", "わくわく" (thrilling), "ぱっ", "たんっ", "GO!" scatter across the entire screen; doodle arrows, musical notes, and stars bounce to the rhythm. The whole world looks as if "Today is dancing." | Camera: 24mm equivalent, slightly wide to show the whole picture, gently pushing in and out to the beat. | Motion: Protagonist takes two steps left and right, jumps, lands, and raises both arms. Background text and doodles simultaneously bounce up, down, left, and right, dancing along with the protagonist. | Lighting: High-key and pop, open and exhilarating brightness with a climactic feel. | VFX: Elastic deformation of hand-drawn lines, confetti-like text fragments, switching halftone dots, flashing radial burst lines. | BGM: Maximum peak excitement here. Synths open up, claps increase, and the beat bounces at its peak. | SFX: "ぽん！" (pop!), "たんっ！" (tap!), "しゃらん！" (shimmer!), "るん♪". | Emotion: Peak of heart-fluttering joy. | Transition: The dancing text gathers all at once around the protagonist, getting sucked into the center. CUT05 | 00:11.0–00:13.2 | Visuals: The colorful handwritten text that was dancing swirls into a vortex, momentarily assembling fragments of "もしも、" (what if), "今日が" (today), "踊ったら？" (danced?) in the center. The background doodles become somewhat organized, and the message begins to emerge. Protagonist in the center foreground enters the final wrap-up of the dance. | Camera: 40mm equivalent, center framing showing protagonist and text vortex, slowly pushing in. | Motion: Protagonist makes a small turn, moving right up to the moment of entering the final pose with one hand raised and one leg stepped forward. The text neatly and satisfyingly aligns while swirling. | Lighting: Grounded brightness, clean atmosphere toward the finale. | VFX: Hand-drawn text vortex, redrawn lines, soft glow, pop splatters. | BGM: Instruments briefly drop out here to create a break. A momentary "pause/anticipation" before the final message. | SFX: "Shurururu", "su-", "kyun". | Emotion: Anticipation, right before the finale pose. | Transition: The final stroke of text is drawn, leading to completion. CUT06 | 00:13.2–00:15.0 | Visuals: Large, colorful handwritten text "もしも、今日が踊ったら？" appears fully formed in the center of the screen. The text uses multicolor marker-style rendering with a thick black outline for solid legibility. Below it in small lettering: "るん♪". The protagonist strikes a fun final dance pose beside or in front of it with one leg lifted. Musical notes, stars, circles, and arrows float gently in the surroundings. | Camera: 50mm equivalent, static shot to present clearly. | Motion: Protagonist does one final subtle bounce, winks or smiles brightly. "るん♪" also bounces slightly alongside. | Lighting: Refreshing high-key, emphasizing lingering resonance. | VFX: Extremely subtle lingering particles, afterimages of hand-drawn lines, faint dot background. | BGM: A bright chord hits at the exact moment the message completes, landing cleanly with a pop, satisfying finish. | No dialogue | SFX: "ぽん♪" (pop♪). | Emotion: An uplifting, positive, and happy afterglow the moment viewing finishes. | Transition: Fade out leaving white space. Overall Direction Rules | Visuals: The protagonist is a "hand-drawn, rounded minimalist character," keeping a simple shape to ensure dance movements are easy to follow. Text serves as visual direction to express the protagonist's emotions and rhythm, structured so the world itself gradually starts dancing. | Color: A colorful pop-art palette based on vivid pink, cyan, yellow, orange, lime, and purple. The more positive the text, the more vibrant its color. | Motion: The protagonist's dance is small at first, light on its feet midway through, and firmly shown all the way to the final pose. Text details shift rapidly in 0.2 to 0.6-second units: bouncing, spinning, being drawn, scattering, and converging. | Typography: Prioritize a hand-drawn feel while displaying Japanese text accurately without corruption. Readability of the final copy "もしも、今日が踊ったら？" is top priority. | BGM: Bright, fast-paced pop-electro. Around 150–160 BPM. Quiet intro → mid-song acceleration → max climax → brief suspenseful pause near the end → clean, pleasant landing at the finish. | SFX: Writing sounds, pops, jumps, and bell-like sparkles inserted at key moments, cleanly synced with dance movements.
```
